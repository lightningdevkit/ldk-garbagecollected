 ...
 */
public class ClosingSig : CommonBase {
	internal ClosingSig(object _dummy, long ptr) : base(ptr) { }
	~ClosingSig() {
	...
	public byte[] get_closer_scriptpubkey() {
		long ret = bindings.ClosingSig_get_closer_scriptpubkey(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public void set_closer_scriptpubkey(byte[] val) {
		bindings.ClosingSig_set_closer_scriptpubkey(this.ptr, InternalUtils.encodeUint8Array(val));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public byte[] get_closee_scriptpubkey() {
		long ret = bindings.ClosingSig_get_closee_scriptpubkey(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.decodeUint8Array(ret);
		return ret_conv;
	...
	public void set_closee_scriptpubkey(byte[] val) {
		bindings.ClosingSig_set_closee_scriptpubkey(this.ptr, InternalUtils.encodeUint8Array(val));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	 ...
	 */
	public static org.ldk.structs.ClosingSig of(org.ldk.structs.ChannelId channel_id_arg, byte[] closer_scriptpubkey_arg, byte[] closee_scriptpubkey_arg, long fee_satoshis_arg, int locktime_arg, org.ldk.structs.Option_ECDSASignatureZ closer_output_only_arg, org.ldk.structs.Option_ECDSASignatureZ closee_output_only_arg, org.ldk.structs.Option_ECDSASignatureZ closer_and_closee_outputs_arg) {
		long ret = bindings.ClosingSig_new(channel_id_arg.ptr, InternalUtils.encodeUint8Array(closer_scriptpubkey_arg), InternalUtils.encodeUint8Array(closee_scriptpubkey_arg), fee_satoshis_arg, locktime_arg, closer_output_only_arg.ptr, closee_output_only_arg.ptr, closer_and_closee_outputs_arg.ptr);
	 ...
	 */
	public org.ldk.structs.ClosingSig clone() {
	 ...
	 */
	public bool eq(org.ldk.structs.ClosingSig b) {
		bool ret = bindings.ClosingSig_eq(this.ptr, b.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(b);
		return ret;
	}
	...
	public override bool Equals(object o) {
		if (!(o is ClosingSig)) return false;
	 ...
	 */
	public byte[] write() {
		long ret = bindings.ClosingSig_write(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.decodeUint8Array(ret);
		return ret_conv;
	 ...
	 */
	public static org.ldk.structs.Result_ClosingSigDecodeErrorZ read(byte[] ser) {
		long ret = bindings.ClosingSig_read(InternalUtils.encodeUint8Array(ser));
		GC.KeepAlive(ser);
		if (ret >= 0 && ret <= 4096) { return null; }

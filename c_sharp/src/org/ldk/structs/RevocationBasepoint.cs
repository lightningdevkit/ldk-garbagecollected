...
public class RevocationBasepoint : CommonBase {
	 ...
	 */
	public static org.ldk.structs.RevocationBasepoint of(byte[] a_arg) {
	 ...
	 */
	public org.ldk.structs.RevocationBasepoint clone() {
	 ...
	 */
	public static org.ldk.structs.Result_RevocationBasepointDecodeErrorZ read(byte[] ser) {

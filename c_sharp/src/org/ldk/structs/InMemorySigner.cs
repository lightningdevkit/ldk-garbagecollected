...
public class InMemorySigner : CommonBase {
	...
	public byte[] funding_key(org.ldk.structs.Option_ThirtyTwoBytesZ splice_parent_funding_txid) {
		long ret = bindings.InMemorySigner_funding_key(this.ptr, splice_parent_funding_txid.ptr);
		GC.KeepAlive(this);
	 ...
	 */
	public org.ldk.structs.BaseEcdsaChannelSigner as_BaseEcdsaChannelSigner() {

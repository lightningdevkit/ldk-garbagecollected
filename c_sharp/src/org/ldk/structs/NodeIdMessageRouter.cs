 ...
 */
public class NodeIdMessageRouter : CommonBase {
	internal NodeIdMessageRouter(object _dummy, long ptr) : base(ptr) { }
	~NodeIdMessageRouter() {
	 ...
	 */
	public static org.ldk.structs.NodeIdMessageRouter of(org.ldk.structs.NetworkGraph network_graph, org.ldk.structs.EntropySource entropy_source) {

 ...
 */
public class StaticInvoice : CommonBase {
	internal StaticInvoice(object _dummy, long ptr) : base(ptr) { }
	~StaticInvoice() {
	 ...
	 */
	public org.ldk.structs.StaticInvoice clone() {
	...
	public bool is_expired() {
		bool ret = bindings.StaticInvoice_is_expired(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public bool is_expired_no_std(long duration_since_epoch) {
		bool ret = bindings.StaticInvoice_is_expired_no_std(this.ptr, duration_since_epoch);
		GC.KeepAlive(this);
	...
	public byte[] signing_pubkey() {
		long ret = bindings.StaticInvoice_signing_pubkey(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
	 ...
	 */
	public byte[] chain() {
		long ret = bindings.StaticInvoice_chain(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.decodeUint8Array(ret);
		return ret_conv;
	...
	public byte[] issuer_signing_pubkey() {
		long ret = bindings.StaticInvoice_issuer_signing_pubkey(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.decodeUint8Array(ret);
		return ret_conv;
	...
	public byte[] signature() {
		long ret = bindings.StaticInvoice_signature(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.decodeUint8Array(ret);
		return ret_conv;
	 ...
	 */
	public bool is_offer_expired() {
		bool ret = bindings.StaticInvoice_is_offer_expired(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	 ...
	 */
	public bool is_offer_expired_no_std(long duration_since_epoch) {
		bool ret = bindings.StaticInvoice_is_offer_expired_no_std(this.ptr, duration_since_epoch);
		GC.KeepAlive(this);
		GC.KeepAlive(duration_since_epoch);
		return ret;
	}
	 ...
	 */
	public byte[] write() {
		long ret = bindings.StaticInvoice_write(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.decodeUint8Array(ret);
		return ret_conv;
	 ...
	 */
	public static org.ldk.structs.Result_StaticInvoiceDecodeErrorZ read(byte[] ser) {
		long ret = bindings.StaticInvoice_read(InternalUtils.encodeUint8Array(ser));
		GC.KeepAlive(ser);
		if (ret >= 0 && ret <= 4096) { return null; }

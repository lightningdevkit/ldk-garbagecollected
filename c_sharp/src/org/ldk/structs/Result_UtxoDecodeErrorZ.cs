...
public class Result_UtxoDecodeErrorZ : CommonBase {
	Result_UtxoDecodeErrorZ(object _dummy, long ptr) : base(ptr) { }
	~Result_UtxoDecodeErrorZ() {
		if (ptr != 0) { bindings.CResult_UtxoDecodeErrorZ_free(ptr); }
	}

	internal static Result_UtxoDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public class Result_UtxoDecodeErrorZ_OK : Result_UtxoDecodeErrorZ {
		public readonly Utxo res;
		internal Result_UtxoDecodeErrorZ_OK(object _dummy, long ptr) : base(_dummy, ptr) {
	...
	public class Result_UtxoDecodeErrorZ_Err : Result_UtxoDecodeErrorZ {
		public readonly DecodeError err;
		internal Result_UtxoDecodeErrorZ_Err(object _dummy, long ptr) : base(_dummy, ptr) {
	 ...
	 */
	public static org.ldk.structs.Result_UtxoDecodeErrorZ ok(org.ldk.structs.Utxo o) {
	 ...
	 */
	public static org.ldk.structs.Result_UtxoDecodeErrorZ err(org.ldk.structs.DecodeError e) {
	 ...
	 */
	public bool is_ok() {
		bool ret = bindings.CResult_UtxoDecodeErrorZ_is_ok(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	 ...
	 */
	public org.ldk.structs.Result_UtxoDecodeErrorZ clone() {

...
public class Result_ClosingCompleteDecodeErrorZ : CommonBase {
	Result_ClosingCompleteDecodeErrorZ(object _dummy, long ptr) : base(ptr) { }
	~Result_ClosingCompleteDecodeErrorZ() {
		if (ptr != 0) { bindings.CResult_ClosingCompleteDecodeErrorZ_free(ptr); }
	}

	internal static Result_ClosingCompleteDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public class Result_ClosingCompleteDecodeErrorZ_OK : Result_ClosingCompleteDecodeErrorZ {
		public readonly ClosingComplete res;
		internal Result_ClosingCompleteDecodeErrorZ_OK(object _dummy, long ptr) : base(_dummy, ptr) {
	...
	public class Result_ClosingCompleteDecodeErrorZ_Err : Result_ClosingCompleteDecodeErrorZ {
		public readonly DecodeError err;
		internal Result_ClosingCompleteDecodeErrorZ_Err(object _dummy, long ptr) : base(_dummy, ptr) {
	 ...
	 */
	public static org.ldk.structs.Result_ClosingCompleteDecodeErrorZ ok(org.ldk.structs.ClosingComplete o) {
	 ...
	 */
	public static org.ldk.structs.Result_ClosingCompleteDecodeErrorZ err(org.ldk.structs.DecodeError e) {
	 ...
	 */
	public bool is_ok() {
		bool ret = bindings.CResult_ClosingCompleteDecodeErrorZ_is_ok(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	 ...
	 */
	public org.ldk.structs.Result_ClosingCompleteDecodeErrorZ clone() {

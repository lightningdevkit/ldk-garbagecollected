...
public class Result_ServeStaticInvoiceDecodeErrorZ : CommonBase {
	Result_ServeStaticInvoiceDecodeErrorZ(object _dummy, long ptr) : base(ptr) { }
	~Result_ServeStaticInvoiceDecodeErrorZ() {
		if (ptr != 0) { bindings.CResult_ServeStaticInvoiceDecodeErrorZ_free(ptr); }
	}

	internal static Result_ServeStaticInvoiceDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public class Result_ServeStaticInvoiceDecodeErrorZ_OK : Result_ServeStaticInvoiceDecodeErrorZ {
		public readonly ServeStaticInvoice res;
		internal Result_ServeStaticInvoiceDecodeErrorZ_OK(object _dummy, long ptr) : base(_dummy, ptr) {
	...
	public class Result_ServeStaticInvoiceDecodeErrorZ_Err : Result_ServeStaticInvoiceDecodeErrorZ {
		public readonly DecodeError err;
		internal Result_ServeStaticInvoiceDecodeErrorZ_Err(object _dummy, long ptr) : base(_dummy, ptr) {
	 ...
	 */
	public static org.ldk.structs.Result_ServeStaticInvoiceDecodeErrorZ ok(org.ldk.structs.ServeStaticInvoice o) {
	 ...
	 */
	public static org.ldk.structs.Result_ServeStaticInvoiceDecodeErrorZ err(org.ldk.structs.DecodeError e) {
	 ...
	 */
	public bool is_ok() {
		bool ret = bindings.CResult_ServeStaticInvoiceDecodeErrorZ_is_ok(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	 ...
	 */
	public org.ldk.structs.Result_ServeStaticInvoiceDecodeErrorZ clone() {

...
public class HtlcBasepoint : CommonBase {
	 ...
	 */
	public static org.ldk.structs.HtlcBasepoint of(byte[] a_arg) {
	 ...
	 */
	public org.ldk.structs.HtlcBasepoint clone() {
	 ...
	 */
	public static org.ldk.structs.HtlcBasepoint from_PublicKey(byte[] f) {
		long ret = bindings.HtlcBasepoint_from_PublicKey(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(f, 33)));
		GC.KeepAlive(f);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.HtlcBasepoint ret_hu_conv = null; if (ret < 0 || ret > 4096) { ret_hu_conv = new org.ldk.structs.HtlcBasepoint(null, ret); }
		if (ret_hu_conv != null) { ret_hu_conv.ptrs_to.AddLast(ret_hu_conv); };
	 ...
	 */
	public static org.ldk.structs.Result_HtlcBasepointDecodeErrorZ read(byte[] ser) {

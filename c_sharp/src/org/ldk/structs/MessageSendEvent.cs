...
public class MessageSendEvent : CommonBase {
	...
	public class MessageSendEvent_UpdateHTLCs : MessageSendEvent {
		...
		internal MessageSendEvent_UpdateHTLCs(long ptr) : base(null, ptr) {
			...
			byte[] node_id_conv = InternalUtils.decodeUint8Array(node_id);
			this.node_id = node_id_conv;
			long channel_id = bindings.LDKMessageSendEvent_UpdateHTLCs_get_channel_id(ptr);
	...
	public class MessageSendEvent_SendClosingComplete : MessageSendEvent {
		/**
		 * The node_id of the node which should receive this message
		 */
		public byte[] node_id;
		 ...
		 * The message which should be sent.
		 */
		public org.ldk.structs.ClosingComplete msg;
		internal MessageSendEvent_SendClosingComplete(long ptr) : base(null, ptr) {
			long node_id = bindings.LDKMessageSendEvent_SendClosingComplete_get_node_id(ptr);
			byte[] node_id_conv = InternalUtils.decodeUint8Array(node_id);
			this.node_id = node_id_conv;
			long msg = bindings.LDKMessageSendEvent_SendClosingComplete_get_msg(ptr);
			org.ldk.structs.ClosingComplete msg_hu_conv = null; if (msg < 0 || msg > 4096) { msg_hu_conv = new org.ldk.structs.ClosingComplete(null, msg); }
			if (msg_hu_conv != null) { msg_hu_conv.ptrs_to.AddLast(this); };
			this.msg = msg_hu_conv;
		}
	}
	/** A MessageSendEvent of type SendClosingSig */
	public class MessageSendEvent_SendClosingSig : MessageSendEvent {
		/**
		 * The node_id of the node which should receive this message
		 */
		public byte[] node_id;
		 ...
		 * The message which should be sent.
		 */
		public org.ldk.structs.ClosingSig msg;
		internal MessageSendEvent_SendClosingSig(long ptr) : base(null, ptr) {
			long node_id = bindings.LDKMessageSendEvent_SendClosingSig_get_node_id(ptr);
			byte[] node_id_conv = InternalUtils.decodeUint8Array(node_id);
			this.node_id = node_id_conv;
			long msg = bindings.LDKMessageSendEvent_SendClosingSig_get_msg(ptr);
			org.ldk.structs.ClosingSig msg_hu_conv = null; if (msg < 0 || msg > 4096) { msg_hu_conv = new org.ldk.structs.ClosingSig(null, msg); }
			if (msg_hu_conv != null) { msg_hu_conv.ptrs_to.AddLast(this); };
			this.msg = msg_hu_conv;
		}
	}
	...
	public class MessageSendEvent_SendPeerStorage : MessageSendEvent {
		/**
		 * The node_id of this message recipient
		 */
		public byte[] node_id;
		 ...
		 */
		public org.ldk.structs.PeerStorage msg;
		internal MessageSendEvent_SendPeerStorage(long ptr) : base(null, ptr) {
			long node_id = bindings.LDKMessageSendEvent_SendPeerStorage_get_node_id(ptr);
			byte[] node_id_conv = InternalUtils.decodeUint8Array(node_id);
			this.node_id = node_id_conv;
			long msg = bindings.LDKMessageSendEvent_SendPeerStorage_get_msg(ptr);
	...
	public class MessageSendEvent_SendPeerStorageRetrieval : MessageSendEvent {
		/**
		 * The node_id of this message recipient
		 */
		public byte[] node_id;
		 ...
		 */
		public org.ldk.structs.PeerStorageRetrieval msg;
		internal MessageSendEvent_SendPeerStorageRetrieval(long ptr) : base(null, ptr) {
			long node_id = bindings.LDKMessageSendEvent_SendPeerStorageRetrieval_get_node_id(ptr);
			byte[] node_id_conv = InternalUtils.decodeUint8Array(node_id);
			this.node_id = node_id_conv;
			long msg = bindings.LDKMessageSendEvent_SendPeerStorageRetrieval_get_msg(ptr);
	 ...
	 */
	public static org.ldk.structs.MessageSendEvent update_htlcs(byte[] node_id, org.ldk.structs.ChannelId channel_id, org.ldk.structs.CommitmentUpdate updates) {
		long ret = bindings.MessageSendEvent_update_htlcs(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(node_id, 33)), channel_id.ptr, updates.ptr);
		GC.KeepAlive(node_id);
	 ...
	 */
	public static org.ldk.structs.MessageSendEvent send_closing_complete(byte[] node_id, org.ldk.structs.ClosingComplete msg) {
		long ret = bindings.MessageSendEvent_send_closing_complete(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(node_id, 33)), msg.ptr);
		GC.KeepAlive(node_id);
		GC.KeepAlive(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.MessageSendEvent ret_hu_conv = org.ldk.structs.MessageSendEvent.constr_from_ptr(ret);
	 ...
	 */
	public static org.ldk.structs.MessageSendEvent send_closing_sig(byte[] node_id, org.ldk.structs.ClosingSig msg) {
		long ret = bindings.MessageSendEvent_send_closing_sig(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(node_id, 33)), msg.ptr);
		GC.KeepAlive(node_id);
		GC.KeepAlive(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.MessageSendEvent ret_hu_conv = org.ldk.structs.MessageSendEvent.constr_from_ptr(ret);
	 ...
	 */
	public static org.ldk.structs.MessageSendEvent send_peer_storage(byte[] node_id, org.ldk.structs.PeerStorage msg) {
		long ret = bindings.MessageSendEvent_send_peer_storage(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(node_id, 33)), msg.ptr);
		GC.KeepAlive(node_id);
		GC.KeepAlive(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.MessageSendEvent ret_hu_conv = org.ldk.structs.MessageSendEvent.constr_from_ptr(ret);
	 ...
	 */
	public static org.ldk.structs.MessageSendEvent send_peer_storage_retrieval(byte[] node_id, org.ldk.structs.PeerStorageRetrieval msg) {
		long ret = bindings.MessageSendEvent_send_peer_storage_retrieval(InternalUtils.encodeUint8Array(InternalUtils.check_arr_len(node_id, 33)), msg.ptr);
		GC.KeepAlive(node_id);
		GC.KeepAlive(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.MessageSendEvent ret_hu_conv = org.ldk.structs.MessageSendEvent.constr_from_ptr(ret);

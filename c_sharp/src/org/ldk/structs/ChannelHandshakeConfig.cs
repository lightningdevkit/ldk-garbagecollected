...
public class ChannelHandshakeConfig : CommonBase {
	 ...
	 * [`DecodeError::InvalidValue`]: crate::ln::msgs::DecodeError::InvalidValue
	 */
	public bool get_negotiate_anchor_zero_fee_commitments() {
		bool ret = bindings.ChannelHandshakeConfig_get_negotiate_anchor_zero_fee_commitments(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	 ...
	 * [`DecodeError::InvalidValue`]: crate::ln::msgs::DecodeError::InvalidValue
	 */
	public void set_negotiate_anchor_zero_fee_commitments(bool val) {
	...
	public static org.ldk.structs.ChannelHandshakeConfig of(int minimum_depth_arg, short our_to_self_delay_arg, long our_htlc_minimum_msat_arg, byte max_inbound_htlc_value_in_flight_percent_of_channel_arg, bool negotiate_scid_privacy_arg, bool announce_for_forwarding_arg, bool commit_upfront_shutdown_pubkey_arg, int their_channel_reserve_proportional_millionths_arg, bool negotiate_anchors_zero_fee_htlc_tx_arg, bool negotiate_anchor_zero_fee_commitments_arg, short our_max_accepted_htlcs_arg) {
		...
		GC.KeepAlive(negotiate_anchor_zero_fee_commitments_arg);

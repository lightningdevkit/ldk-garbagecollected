...
public class Result_TrampolineOnionPacketDecodeErrorZ : CommonBase {
	Result_TrampolineOnionPacketDecodeErrorZ(object _dummy, long ptr) : base(ptr) { }
	~Result_TrampolineOnionPacketDecodeErrorZ() {
		if (ptr != 0) { bindings.CResult_TrampolineOnionPacketDecodeErrorZ_free(ptr); }
	}

	internal static Result_TrampolineOnionPacketDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public class Result_TrampolineOnionPacketDecodeErrorZ_OK : Result_TrampolineOnionPacketDecodeErrorZ {
		public readonly TrampolineOnionPacket res;
		internal Result_TrampolineOnionPacketDecodeErrorZ_OK(object _dummy, long ptr) : base(_dummy, ptr) {
	...
	public class Result_TrampolineOnionPacketDecodeErrorZ_Err : Result_TrampolineOnionPacketDecodeErrorZ {
		public readonly DecodeError err;
		internal Result_TrampolineOnionPacketDecodeErrorZ_Err(object _dummy, long ptr) : base(_dummy, ptr) {
	 ...
	 */
	public static org.ldk.structs.Result_TrampolineOnionPacketDecodeErrorZ ok(org.ldk.structs.TrampolineOnionPacket o) {
	 ...
	 */
	public static org.ldk.structs.Result_TrampolineOnionPacketDecodeErrorZ err(org.ldk.structs.DecodeError e) {
	 ...
	 */
	public bool is_ok() {
		bool ret = bindings.CResult_TrampolineOnionPacketDecodeErrorZ_is_ok(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	 ...
	 */
	public org.ldk.structs.Result_TrampolineOnionPacketDecodeErrorZ clone() {

...
public class TwoTuple_ChannelIdu64Z extends CommonBase {
	TwoTuple_ChannelIdu64Z(Object _dummy, long ptr) { super(ptr); }
	 ...
	 */
	public TwoTuple_ChannelIdu64Z clone() {
	 ...
	 */
	public static TwoTuple_ChannelIdu64Z of(org.ldk.structs.ChannelId a, long b) {

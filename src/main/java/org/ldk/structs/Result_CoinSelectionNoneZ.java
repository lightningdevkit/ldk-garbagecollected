...
public class Result_CoinSelectionNoneZ extends CommonBase {
	private Result_CoinSelectionNoneZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_CoinSelectionNoneZ_OK extends Result_CoinSelectionNoneZ {
		...
		private Result_CoinSelectionNoneZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_CoinSelectionNoneZ_Err extends Result_CoinSelectionNoneZ {
		private Result_CoinSelectionNoneZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
		}
	}
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_CoinSelectionNoneZ_is_ok(this.ptr);

...
public class TwoTuple_CVec_u8Zu16Z extends CommonBase {
	TwoTuple_CVec_u8Zu16Z(Object _dummy, long ptr) { super(ptr); }
	 ...
	 */
	public byte[] get_a() {
		byte[] ret = bindings.C2Tuple_CVec_u8Zu16Z_get_a(this.ptr);
	 ...
	 */
	public TwoTuple_CVec_u8Zu16Z clone() {
	 ...
	 */
	public static TwoTuple_CVec_u8Zu16Z of(byte[] a, short b) {
		long ret = bindings.C2Tuple_CVec_u8Zu16Z_new(a, b);

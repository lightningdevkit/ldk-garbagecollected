...
public class Result_TxInitRbfDecodeErrorZ extends CommonBase {
	private Result_TxInitRbfDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_TxInitRbfDecodeErrorZ_OK extends Result_TxInitRbfDecodeErrorZ {
		public final TxInitRbf res;
		private Result_TxInitRbfDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_TxInitRbfDecodeErrorZ_Err extends Result_TxInitRbfDecodeErrorZ {
		public final DecodeError err;
		private Result_TxInitRbfDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_TxInitRbfDecodeErrorZ_is_ok(this.ptr);

...
public class Result_BigSizeDecodeErrorZ extends CommonBase {
	private Result_BigSizeDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_BigSizeDecodeErrorZ_OK extends Result_BigSizeDecodeErrorZ {
		public final BigSize res;
		private Result_BigSizeDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_BigSizeDecodeErrorZ_Err extends Result_BigSizeDecodeErrorZ {
		public final DecodeError err;
		private Result_BigSizeDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_BigSizeDecodeErrorZ_is_ok(this.ptr);

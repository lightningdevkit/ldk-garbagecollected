...
public class TwoTuple_CVec_u8Zu64Z extends CommonBase {
	TwoTuple_CVec_u8Zu64Z(Object _dummy, long ptr) { super(ptr); }
	 ...
	 */
	public byte[] get_a() {
		byte[] ret = bindings.C2Tuple_CVec_u8Zu64Z_get_a(this.ptr);
	...
	public static TwoTuple_CVec_u8Zu64Z of(byte[] a, long b) {
		long ret = bindings.C2Tuple_CVec_u8Zu64Z_new(a, b);

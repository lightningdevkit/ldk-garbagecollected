...
public class UnsignedStaticInvoice extends CommonBase {
	UnsignedStaticInvoice(Object _dummy, long ptr) { super(ptr); }
	...
	public boolean is_expired() {
		boolean ret = bindings.UnsignedStaticInvoice_is_expired(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}
	...
	public boolean is_expired_no_std(long duration_since_epoch) {
		boolean ret = bindings.UnsignedStaticInvoice_is_expired_no_std(this.ptr, duration_since_epoch);
		Reference.reachabilityFence(this);
	...
	public byte[] signing_pubkey() {
		byte[] ret = bindings.UnsignedStaticInvoice_signing_pubkey(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}
	 ...
	 */
	public byte[] chain() {
		byte[] ret = bindings.UnsignedStaticInvoice_chain(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}
	...
	public byte[] issuer_signing_pubkey() {
		byte[] ret = bindings.UnsignedStaticInvoice_issuer_signing_pubkey(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}

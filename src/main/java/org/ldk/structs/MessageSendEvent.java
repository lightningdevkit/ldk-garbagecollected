...
public class MessageSendEvent extends CommonBase {
	...
	static MessageSendEvent constr_from_ptr(long ptr) {
		...
		if (raw_val.getClass() == bindings.LDKMessageSendEvent.SendClosingComplete.class) {
			return new SendClosingComplete(ptr, (bindings.LDKMessageSendEvent.SendClosingComplete)raw_val);
		}
		if (raw_val.getClass() == bindings.LDKMessageSendEvent.SendClosingSig.class) {
			return new SendClosingSig(ptr, (bindings.LDKMessageSendEvent.SendClosingSig)raw_val);
		}
		...
		if (raw_val.getClass() == bindings.LDKMessageSendEvent.SendPeerStorage.class) {
			return new SendPeerStorage(ptr, (bindings.LDKMessageSendEvent.SendPeerStorage)raw_val);
		}
		if (raw_val.getClass() == bindings.LDKMessageSendEvent.SendPeerStorageRetrieval.class) {
			return new SendPeerStorageRetrieval(ptr, (bindings.LDKMessageSendEvent.SendPeerStorageRetrieval)raw_val);
		}
	 ...
	 */
	public final static class SendClosingComplete extends MessageSendEvent {
		/**
		 * The node_id of the node which should receive this message
		*/
		public final byte[] node_id;
		 ...
		 * The message which should be sent.
		*/
		public final org.ldk.structs.ClosingComplete msg;
		private SendClosingComplete(long ptr, bindings.LDKMessageSendEvent.SendClosingComplete obj) {
			super(null, ptr);
			this.node_id = obj.node_id;
			long msg = obj.msg;
	 ...
	 */
	public final static class SendClosingSig extends MessageSendEvent {
		/**
		 * The node_id of the node which should receive this message
		*/
		public final byte[] node_id;
		 ...
		 * The message which should be sent.
		*/
		public final org.ldk.structs.ClosingSig msg;
		private SendClosingSig(long ptr, bindings.LDKMessageSendEvent.SendClosingSig obj) {
			super(null, ptr);
			this.node_id = obj.node_id;
			long msg = obj.msg;
	 ...
	 */
	public final static class SendPeerStorage extends MessageSendEvent {
		/**
		 * The node_id of this message recipient
		*/
		public final byte[] node_id;
		...
		*/
		public final org.ldk.structs.PeerStorage msg;
		private SendPeerStorage(long ptr, bindings.LDKMessageSendEvent.SendPeerStorage obj) {
			super(null, ptr);
			this.node_id = obj.node_id;
			long msg = obj.msg;
	 ...
	 * a [`PeerStorage`].
	 */
	public final static class SendPeerStorageRetrieval extends MessageSendEvent {
		/**
		 * The node_id of this message recipient
		*/
		public final byte[] node_id;
		...
		*/
		public final org.ldk.structs.PeerStorageRetrieval msg;
		private SendPeerStorageRetrieval(long ptr, bindings.LDKMessageSendEvent.SendPeerStorageRetrieval obj) {
			super(null, ptr);
			this.node_id = obj.node_id;
			long msg = obj.msg;
	 ...
	 */
	public static MessageSendEvent update_htlcs(byte[] node_id, org.ldk.structs.ChannelId channel_id, org.ldk.structs.CommitmentUpdate updates) {
		long ret = bindings.MessageSendEvent_update_htlcs(InternalUtils.check_arr_len(node_id, 33), channel_id.ptr, updates.ptr);
		Reference.reachabilityFence(node_id);
	 ...
	 */
	public static MessageSendEvent send_closing_complete(byte[] node_id, org.ldk.structs.ClosingComplete msg) {
		long ret = bindings.MessageSendEvent_send_closing_complete(InternalUtils.check_arr_len(node_id, 33), msg.ptr);
		Reference.reachabilityFence(node_id);
		Reference.reachabilityFence(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.MessageSendEvent ret_hu_conv = org.ldk.structs.MessageSendEvent.constr_from_ptr(ret);
	 ...
	 */
	public static MessageSendEvent send_closing_sig(byte[] node_id, org.ldk.structs.ClosingSig msg) {
		long ret = bindings.MessageSendEvent_send_closing_sig(InternalUtils.check_arr_len(node_id, 33), msg.ptr);
		Reference.reachabilityFence(node_id);
		Reference.reachabilityFence(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.MessageSendEvent ret_hu_conv = org.ldk.structs.MessageSendEvent.constr_from_ptr(ret);
	 ...
	 */
	public static MessageSendEvent send_peer_storage(byte[] node_id, org.ldk.structs.PeerStorage msg) {
		long ret = bindings.MessageSendEvent_send_peer_storage(InternalUtils.check_arr_len(node_id, 33), msg.ptr);
		Reference.reachabilityFence(node_id);
		Reference.reachabilityFence(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.MessageSendEvent ret_hu_conv = org.ldk.structs.MessageSendEvent.constr_from_ptr(ret);
	 ...
	 */
	public static MessageSendEvent send_peer_storage_retrieval(byte[] node_id, org.ldk.structs.PeerStorageRetrieval msg) {
		long ret = bindings.MessageSendEvent_send_peer_storage_retrieval(InternalUtils.check_arr_len(node_id, 33), msg.ptr);
		Reference.reachabilityFence(node_id);
		Reference.reachabilityFence(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.MessageSendEvent ret_hu_conv = org.ldk.structs.MessageSendEvent.constr_from_ptr(ret);

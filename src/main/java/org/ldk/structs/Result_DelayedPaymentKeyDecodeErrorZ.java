...
public class Result_DelayedPaymentKeyDecodeErrorZ extends CommonBase {
	private Result_DelayedPaymentKeyDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_DelayedPaymentKeyDecodeErrorZ_OK extends Result_DelayedPaymentKeyDecodeErrorZ {
		public final DelayedPaymentKey res;
		private Result_DelayedPaymentKeyDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_DelayedPaymentKeyDecodeErrorZ_Err extends Result_DelayedPaymentKeyDecodeErrorZ {
		public final DecodeError err;
		private Result_DelayedPaymentKeyDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_DelayedPaymentKeyDecodeErrorZ_is_ok(this.ptr);

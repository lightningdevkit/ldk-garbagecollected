...
public class PeerStorage extends CommonBase {
	PeerStorage(Object _dummy, long ptr) { super(ptr); }
	...
	public byte[] get_data() {
		byte[] ret = bindings.PeerStorage_get_data(this.ptr);
	...
	public void set_data(byte[] val) {
		bindings.PeerStorage_set_data(this.ptr, val);
		Reference.reachabilityFence(this);
	 ...
	 */
	public static PeerStorage of(byte[] data_arg) {
		long ret = bindings.PeerStorage_new(data_arg);
	 ...
	 */
	public boolean eq(org.ldk.structs.PeerStorage b) {
		boolean ret = bindings.PeerStorage_eq(this.ptr, b.ptr);
		Reference.reachabilityFence(this);
	...
	@Override public boolean equals(Object o) {
		if (!(o instanceof PeerStorage)) return false;
	 ...
	 */
	public byte[] write() {
		byte[] ret = bindings.PeerStorage_write(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}
	 ...
	 */
	public static Result_PeerStorageDecodeErrorZ read(byte[] ser) {
		long ret = bindings.PeerStorage_read(ser);

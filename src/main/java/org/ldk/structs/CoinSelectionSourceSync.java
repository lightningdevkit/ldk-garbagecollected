...
public class CoinSelectionSourceSync extends CommonBase {
	final bindings.LDKCoinSelectionSourceSync bindings_instance;
	CoinSelectionSourceSync(Object _dummy, long ptr) { super(ptr); bindings_instance = null; }
	private CoinSelectionSourceSync(bindings.LDKCoinSelectionSourceSync arg) {
		super(bindings.LDKCoinSelectionSourceSync_new(arg));
		this.ptrs_to.add(arg);
		this.bindings_instance = arg;
	}
	@Override @SuppressWarnings("deprecation")
	protected void finalize() throws Throwable {
		if (ptr != 0) { bindings.CoinSelectionSourceSync_free(ptr); } super.finalize();
	}
	/**
	...
	public static interface CoinSelectionSourceSyncInterface {
		/**
	...
	private static class LDKCoinSelectionSourceSyncHolder { CoinSelectionSourceSync held; }
	public static CoinSelectionSourceSync new_impl(CoinSelectionSourceSyncInterface arg) {
		final LDKCoinSelectionSourceSyncHolder impl_holder = new LDKCoinSelectionSourceSyncHolder();
		impl_holder.held = new CoinSelectionSourceSync(new bindings.LDKCoinSelectionSourceSync() {
			@Override public long select_confirmed_utxos(byte[] claim_id, long[] must_spend, long[] must_pay_to, int target_feerate_sat_per_1000_weight, long max_tx_weight) {
				...
				Result_CoinSelectionNoneZ ret = arg.select_confirmed_utxos(claim_id, must_spend_conv_7_arr, must_pay_to_conv_7_arr, target_feerate_sat_per_1000_weight, max_tx_weight);
	 ...
	 * [`ChannelMonitor::rebroadcast_pending_claims`]: crate::chain::channelmonitor::ChannelMonitor::rebroadcast_pending_claims
	 */
	public Result_CoinSelectionNoneZ select_confirmed_utxos(byte[] claim_id, Input[] must_spend, TxOut[] must_pay_to, int target_feerate_sat_per_1000_weight, long max_tx_weight) {
		long ret = bindings.CoinSelectionSourceSync_select_confirmed_utxos(this.ptr, InternalUtils.check_arr_len(claim_id, 32), must_spend != null ? Arrays.stream(must_spend).mapToLong(must_spend_conv_7 -> must_spend_conv_7.ptr).toArray() : null, must_pay_to != null ? Arrays.stream(must_pay_to).mapToLong(must_pay_to_conv_7 -> must_pay_to_conv_7.ptr).toArray() : null, target_feerate_sat_per_1000_weight, max_tx_weight);
		...
		Reference.reachabilityFence(max_tx_weight);
	...
	public Result_TransactionNoneZ sign_psbt(byte[] psbt) {
		long ret = bindings.CoinSelectionSourceSync_sign_psbt(this.ptr, psbt);
		Reference.reachabilityFence(this);

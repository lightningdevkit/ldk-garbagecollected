...
public class TwoTuple_OfferboolZ extends CommonBase {
	TwoTuple_OfferboolZ(Object _dummy, long ptr) { super(ptr); }
	...
	public boolean get_b() {
		boolean ret = bindings.C2Tuple_OfferboolZ_get_b(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}
	 ...
	 */
	public TwoTuple_OfferboolZ clone() {
	 ...
	 */
	public static TwoTuple_OfferboolZ of(org.ldk.structs.Offer a, boolean b) {

...
public class RouteParametersConfig extends CommonBase {
	RouteParametersConfig(Object _dummy, long ptr) { super(ptr); }
	 ...
	 */
	public static RouteParametersConfig of(org.ldk.structs.Option_u64Z max_total_routing_fee_msat_arg, int max_total_cltv_expiry_delta_arg, byte max_path_count_arg, byte max_channel_saturation_power_of_half_arg) {
	 ...
	 */
	public RouteParametersConfig clone() {
	 ...
	 */
	public byte[] write() {
		byte[] ret = bindings.RouteParametersConfig_write(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}
	 ...
	 */
	public static Result_RouteParametersConfigDecodeErrorZ read(byte[] ser) {
		long ret = bindings.RouteParametersConfig_read(ser);
	 ...
	 */
	public static RouteParametersConfig with_default() {

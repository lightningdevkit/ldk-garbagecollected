...
public class AsyncBolt12OfferContext extends CommonBase {
	AsyncBolt12OfferContext(Object _dummy, long ptr) { super(ptr); }
	 ...
	 */
	public static AsyncBolt12OfferContext of(org.ldk.structs.Nonce offer_nonce_arg) {
		long ret = bindings.AsyncBolt12OfferContext_new(offer_nonce_arg.ptr);
		Reference.reachabilityFence(offer_nonce_arg);
		if (ret >= 0 && ret <= 4096) { return null; }
	 ...
	 */
	public AsyncBolt12OfferContext clone() {
	 ...
	 */
	public boolean eq(org.ldk.structs.AsyncBolt12OfferContext b) {
		boolean ret = bindings.AsyncBolt12OfferContext_eq(this.ptr, b.ptr);
		Reference.reachabilityFence(this);
	...
	@Override public boolean equals(Object o) {
		if (!(o instanceof AsyncBolt12OfferContext)) return false;
	 ...
	 */
	public byte[] write() {
		byte[] ret = bindings.AsyncBolt12OfferContext_write(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}
	 ...
	 */
	public static Result_AsyncBolt12OfferContextDecodeErrorZ read(byte[] ser) {
		long ret = bindings.AsyncBolt12OfferContext_read(ser);

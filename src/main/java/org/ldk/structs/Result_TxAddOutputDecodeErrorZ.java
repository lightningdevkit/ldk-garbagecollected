...
public class Result_TxAddOutputDecodeErrorZ extends CommonBase {
	private Result_TxAddOutputDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_TxAddOutputDecodeErrorZ_OK extends Result_TxAddOutputDecodeErrorZ {
		public final TxAddOutput res;
		private Result_TxAddOutputDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_TxAddOutputDecodeErrorZ_Err extends Result_TxAddOutputDecodeErrorZ {
		public final DecodeError err;
		private Result_TxAddOutputDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_TxAddOutputDecodeErrorZ_is_ok(this.ptr);

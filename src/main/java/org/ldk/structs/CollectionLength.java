...
public class CollectionLength extends CommonBase {
	CollectionLength(Object _dummy, long ptr) { super(ptr); }
	 ...
	 */
	public static CollectionLength of(long a_arg) {
	 ...
	 */
	public byte[] write() {
		byte[] ret = bindings.CollectionLength_write(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}
	 ...
	 */
	public static Result_CollectionLengthDecodeErrorZ read(byte[] ser) {
		long ret = bindings.CollectionLength_read(ser);

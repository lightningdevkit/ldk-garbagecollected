...
public class Result_OnionPacketDecodeErrorZ extends CommonBase {
	private Result_OnionPacketDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_OnionPacketDecodeErrorZ_OK extends Result_OnionPacketDecodeErrorZ {
		public final OnionPacket res;
		private Result_OnionPacketDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_OnionPacketDecodeErrorZ_Err extends Result_OnionPacketDecodeErrorZ {
		public final DecodeError err;
		private Result_OnionPacketDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_OnionPacketDecodeErrorZ_is_ok(this.ptr);

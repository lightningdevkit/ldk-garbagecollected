...
public class Result_TxCompleteDecodeErrorZ extends CommonBase {
	private Result_TxCompleteDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_TxCompleteDecodeErrorZ_OK extends Result_TxCompleteDecodeErrorZ {
		public final TxComplete res;
		private Result_TxCompleteDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_TxCompleteDecodeErrorZ_Err extends Result_TxCompleteDecodeErrorZ {
		public final DecodeError err;
		private Result_TxCompleteDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_TxCompleteDecodeErrorZ_is_ok(this.ptr);

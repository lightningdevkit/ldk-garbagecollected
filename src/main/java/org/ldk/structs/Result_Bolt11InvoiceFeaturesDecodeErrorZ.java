...
public class Result_Bolt11InvoiceFeaturesDecodeErrorZ extends CommonBase {
	private Result_Bolt11InvoiceFeaturesDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_Bolt11InvoiceFeaturesDecodeErrorZ_OK extends Result_Bolt11InvoiceFeaturesDecodeErrorZ {
		...
		private Result_Bolt11InvoiceFeaturesDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_Bolt11InvoiceFeaturesDecodeErrorZ_Err extends Result_Bolt11InvoiceFeaturesDecodeErrorZ {
		...
		private Result_Bolt11InvoiceFeaturesDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_Bolt11InvoiceFeaturesDecodeErrorZ_is_ok(this.ptr);

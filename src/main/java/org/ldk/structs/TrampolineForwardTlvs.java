...
public class TrampolineForwardTlvs extends CommonBase {
	TrampolineForwardTlvs(Object _dummy, long ptr) { super(ptr); }
	...
	public byte[] get_next_trampoline() {
		byte[] ret = bindings.TrampolineForwardTlvs_get_next_trampoline(this.ptr);
	...
	public void set_next_trampoline(byte[] val) {
		bindings.TrampolineForwardTlvs_set_next_trampoline(this.ptr, InternalUtils.check_arr_len(val, 33));
		Reference.reachabilityFence(this);
	...
	public byte[] get_next_blinding_override() {
		byte[] ret = bindings.TrampolineForwardTlvs_get_next_blinding_override(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}
	...
	public void set_next_blinding_override(@Nullable byte[] val) {
		bindings.TrampolineForwardTlvs_set_next_blinding_override(this.ptr, InternalUtils.check_arr_len(val, 33));
		Reference.reachabilityFence(this);
		Reference.reachabilityFence(val);
	}
	 ...
	 */
	public static TrampolineForwardTlvs of(byte[] next_trampoline_arg, org.ldk.structs.PaymentRelay payment_relay_arg, org.ldk.structs.PaymentConstraints payment_constraints_arg, org.ldk.structs.BlindedHopFeatures features_arg, @Nullable byte[] next_blinding_override_arg) {
		long ret = bindings.TrampolineForwardTlvs_new(InternalUtils.check_arr_len(next_trampoline_arg, 33), payment_relay_arg.ptr, payment_constraints_arg.ptr, features_arg.ptr, InternalUtils.check_arr_len(next_blinding_override_arg, 33));
		Reference.reachabilityFence(next_trampoline_arg);
	 ...
	 */
	public TrampolineForwardTlvs clone() {
	 ...
	 */
	public byte[] write() {
		byte[] ret = bindings.TrampolineForwardTlvs_write(this.ptr);
		Reference.reachabilityFence(this);
		return ret;
	}

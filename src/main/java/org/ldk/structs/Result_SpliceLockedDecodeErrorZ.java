...
public class Result_SpliceLockedDecodeErrorZ extends CommonBase {
	private Result_SpliceLockedDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_SpliceLockedDecodeErrorZ_OK extends Result_SpliceLockedDecodeErrorZ {
		public final SpliceLocked res;
		private Result_SpliceLockedDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_SpliceLockedDecodeErrorZ_Err extends Result_SpliceLockedDecodeErrorZ {
		public final DecodeError err;
		private Result_SpliceLockedDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_SpliceLockedDecodeErrorZ_is_ok(this.ptr);

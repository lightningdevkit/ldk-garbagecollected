...
public class KVStoreSync extends CommonBase {
	final bindings.LDKKVStoreSync bindings_instance;
	KVStoreSync(Object _dummy, long ptr) { super(ptr); bindings_instance = null; }
	private KVStoreSync(bindings.LDKKVStoreSync arg) {
		super(bindings.LDKKVStoreSync_new(arg));
		this.ptrs_to.add(arg);
		this.bindings_instance = arg;
	}
	@Override @SuppressWarnings("deprecation")
	protected void finalize() throws Throwable {
		if (ptr != 0) { bindings.KVStoreSync_free(ptr); } super.finalize();
	}
	/**
	...
	public static interface KVStoreSyncInterface {
		/**
	...
	private static class LDKKVStoreSyncHolder { KVStoreSync held; }
	public static KVStoreSync new_impl(KVStoreSyncInterface arg) {
		final LDKKVStoreSyncHolder impl_holder = new LDKKVStoreSyncHolder();
		impl_holder.held = new KVStoreSync(new bindings.LDKKVStoreSync() {
	...
	public Result_CVec_u8ZIOErrorZ read(java.lang.String primary_namespace, java.lang.String secondary_namespace, java.lang.String key) {
		long ret = bindings.KVStoreSync_read(this.ptr, primary_namespace, secondary_namespace, key);
	...
	public Result_NoneIOErrorZ write(java.lang.String primary_namespace, java.lang.String secondary_namespace, java.lang.String key, byte[] buf) {
		long ret = bindings.KVStoreSync_write(this.ptr, primary_namespace, secondary_namespace, key, buf);
		Reference.reachabilityFence(this);
		Reference.reachabilityFence(primary_namespace);
		Reference.reachabilityFence(secondary_namespace);
		Reference.reachabilityFence(key);
	...
	public Result_NoneIOErrorZ remove(java.lang.String primary_namespace, java.lang.String secondary_namespace, java.lang.String key, boolean lazy) {
		long ret = bindings.KVStoreSync_remove(this.ptr, primary_namespace, secondary_namespace, key, lazy);
		Reference.reachabilityFence(this);
		Reference.reachabilityFence(primary_namespace);
		Reference.reachabilityFence(secondary_namespace);
		Reference.reachabilityFence(key);
	...
	public Result_CVec_StrZIOErrorZ list(java.lang.String primary_namespace, java.lang.String secondary_namespace) {
		long ret = bindings.KVStoreSync_list(this.ptr, primary_namespace, secondary_namespace);
		Reference.reachabilityFence(this);
		Reference.reachabilityFence(primary_namespace);
		Reference.reachabilityFence(secondary_namespace);
		if (ret >= 0 && ret <= 4096) { return null; }

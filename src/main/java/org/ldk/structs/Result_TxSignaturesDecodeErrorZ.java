...
public class Result_TxSignaturesDecodeErrorZ extends CommonBase {
	private Result_TxSignaturesDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_TxSignaturesDecodeErrorZ_OK extends Result_TxSignaturesDecodeErrorZ {
		public final TxSignatures res;
		private Result_TxSignaturesDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_TxSignaturesDecodeErrorZ_Err extends Result_TxSignaturesDecodeErrorZ {
		public final DecodeError err;
		private Result_TxSignaturesDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_TxSignaturesDecodeErrorZ_is_ok(this.ptr);

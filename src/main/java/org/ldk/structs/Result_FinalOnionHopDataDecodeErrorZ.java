...
public class Result_FinalOnionHopDataDecodeErrorZ extends CommonBase {
	private Result_FinalOnionHopDataDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_FinalOnionHopDataDecodeErrorZ_OK extends Result_FinalOnionHopDataDecodeErrorZ {
		public final FinalOnionHopData res;
		private Result_FinalOnionHopDataDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_FinalOnionHopDataDecodeErrorZ_Err extends Result_FinalOnionHopDataDecodeErrorZ {
		public final DecodeError err;
		private Result_FinalOnionHopDataDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_FinalOnionHopDataDecodeErrorZ_is_ok(this.ptr);

...
public class Result_Bolt11InvoiceParseOrSemanticErrorZ extends CommonBase {
	private Result_Bolt11InvoiceParseOrSemanticErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_Bolt11InvoiceParseOrSemanticErrorZ_OK extends Result_Bolt11InvoiceParseOrSemanticErrorZ {
		...
		private Result_Bolt11InvoiceParseOrSemanticErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_Bolt11InvoiceParseOrSemanticErrorZ_Err extends Result_Bolt11InvoiceParseOrSemanticErrorZ {
		...
		private Result_Bolt11InvoiceParseOrSemanticErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_Bolt11InvoiceParseOrSemanticErrorZ_is_ok(this.ptr);

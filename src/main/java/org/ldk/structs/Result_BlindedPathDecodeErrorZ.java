...
public class Result_BlindedPathDecodeErrorZ extends CommonBase {
	private Result_BlindedPathDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	...
	public static final class Result_BlindedPathDecodeErrorZ_OK extends Result_BlindedPathDecodeErrorZ {
		public final BlindedPath res;
		private Result_BlindedPathDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_BlindedPathDecodeErrorZ_Err extends Result_BlindedPathDecodeErrorZ {
		public final DecodeError err;
		private Result_BlindedPathDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_BlindedPathDecodeErrorZ_is_ok(this.ptr);

...
public class PeerManager extends CommonBase {
	...
	public static PeerManager of(ChannelMessageHandler message_handler_chan_handler_arg, RoutingMessageHandler message_handler_route_handler_arg, OnionMessageHandler message_handler_onion_message_handler_arg, CustomMessageHandler message_handler_custom_message_handler_arg, SendOnlyMessageHandler message_handler_send_only_message_handler_arg, int current_time, byte[] ephemeral_random_data, org.ldk.structs.Logger logger, org.ldk.structs.NodeSigner node_signer) {
		...
		Reference.reachabilityFence(message_handler_send_only_message_handler_arg);
		...
		if (ret_hu_conv != null) { ret_hu_conv.ptrs_to.add(message_handler_send_only_message_handler_arg); };
	 ...
	 */
	public Result_NonePeerHandleErrorZ read_event(org.ldk.structs.SocketDescriptor peer_descriptor, byte[] data) {

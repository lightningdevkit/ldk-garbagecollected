...
public class ChannelManagerConstructor {
    ...
    public interface MessageRouterWrapper {
         ...
         */
        Result_CVec_BlindedMessagePathZNoneZ create_blinded_paths(byte[] recipient, MessageContext context,
            byte[][] peers, DefaultMessageRouter default_message_router);
    }
        ...
        if (message_router_wrapper != null) {
            msg_router = MessageRouter.new_impl(new MessageRouter.MessageRouterInterface() {
                ...
                @Override public Result_CVec_BlindedMessagePathZNoneZ create_blinded_paths(byte[] recipient, MessageContext context, byte[][] peers) {
                    return message_router_wrapper.create_blinded_paths(recipient, context, peers, default_msg_router);
                }
            });
        } else {

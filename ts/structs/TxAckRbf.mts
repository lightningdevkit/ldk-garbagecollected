...
export class TxAckRbf extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.TxAckRbf_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.TxAckRbf_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, funding_output_contribution_arg: Option_i64Z): TxAckRbf {
		const ret: bigint = bindings.TxAckRbf_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), CommonBase.get_ptr_of(funding_output_contribution_arg));
	...
	public eq(b: TxAckRbf): boolean {
		const ret: boolean = bindings.TxAckRbf_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

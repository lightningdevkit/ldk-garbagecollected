...
export class ProbabilisticScoringFeeParameters extends CommonBase {
	...
	public add_banned_from_list(node_ids: NodeId[]): void {
		bindings.ProbabilisticScoringFeeParameters_add_banned_from_list(this.ptr, bindings.encodeUint64Array(node_ids != null ? node_ids.map(node_ids_conv_8 => node_ids_conv_8 == null ? 0n : CommonBase.get_ptr_of(node_ids_conv_8)) : null));

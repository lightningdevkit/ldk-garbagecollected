...
export class ProbabilisticScoringFeeParameters extends CommonBase {
	...
	public get_base_penalty_msat(): bigint {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_get_base_penalty_msat(this.ptr);
		return ret;
	}
	...
	public get_base_penalty_amount_multiplier_msat(): bigint {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_get_base_penalty_amount_multiplier_msat(this.ptr);
		return ret;
	}
	...
	public get_liquidity_penalty_multiplier_msat(): bigint {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_get_liquidity_penalty_multiplier_msat(this.ptr);
		return ret;
	}
	...
	public get_liquidity_penalty_amount_multiplier_msat(): bigint {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_get_liquidity_penalty_amount_multiplier_msat(this.ptr);
		return ret;
	}
	...
	public get_historical_liquidity_penalty_multiplier_msat(): bigint {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_get_historical_liquidity_penalty_multiplier_msat(this.ptr);
		return ret;
	}
	...
	public get_historical_liquidity_penalty_amount_multiplier_msat(): bigint {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_get_historical_liquidity_penalty_amount_multiplier_msat(this.ptr);
		return ret;
	}
	...
	public get_anti_probing_penalty_msat(): bigint {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_get_anti_probing_penalty_msat(this.ptr);
		return ret;
	}
	...
	public get_considered_impossible_penalty_msat(): bigint {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_get_considered_impossible_penalty_msat(this.ptr);
		return ret;
	}
	 ...
	 * Default value: false
	 */
	public get_linear_success_probability(): boolean {
		const ret: boolean = bindings.ProbabilisticScoringFeeParameters_get_linear_success_probability(this.ptr);
		return ret;
	}
	 ...
	 * Default value: false
	 */
	public set_linear_success_probability(val: boolean): void {
		bindings.ProbabilisticScoringFeeParameters_set_linear_success_probability(this.ptr, val);
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): ProbabilisticScoringFeeParameters {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_clone(this.ptr);
		const ret_hu_conv: ProbabilisticScoringFeeParameters = new ProbabilisticScoringFeeParameters(null, ret);
	 ...
	 */
	public static constructor_default(): ProbabilisticScoringFeeParameters {
		const ret: bigint = bindings.ProbabilisticScoringFeeParameters_default();
		const ret_hu_conv: ProbabilisticScoringFeeParameters = new ProbabilisticScoringFeeParameters(null, ret);
	...
	public add_banned(node_id: NodeId): void {
		bindings.ProbabilisticScoringFeeParameters_add_banned(this.ptr, node_id == null ? 0n : CommonBase.get_ptr_of(node_id));
	...
	public add_banned_from_list(node_ids: NodeId[]): void {
		bindings.ProbabilisticScoringFeeParameters_add_banned_from_list(this.ptr, bindings.encodeUint64Array(node_ids.map(node_ids_conv_8 => node_ids_conv_8 == null ? 0n : CommonBase.get_ptr_of(node_ids_conv_8))));
	...
	public remove_banned(node_id: NodeId): void {
		bindings.ProbabilisticScoringFeeParameters_remove_banned(this.ptr, node_id == null ? 0n : CommonBase.get_ptr_of(node_id));
		CommonBase.add_ref_from(this, node_id);
	}
	...
	public set_manual_penalty(node_id: NodeId, penalty: bigint): void {
		bindings.ProbabilisticScoringFeeParameters_set_manual_penalty(this.ptr, node_id == null ? 0n : CommonBase.get_ptr_of(node_id), penalty);
		CommonBase.add_ref_from(this, node_id);
	}
	...
	public remove_manual_penalty(node_id: NodeId): void {
		bindings.ProbabilisticScoringFeeParameters_remove_manual_penalty(this.ptr, node_id == null ? 0n : CommonBase.get_ptr_of(node_id));
		CommonBase.add_ref_from(this, node_id);
	}

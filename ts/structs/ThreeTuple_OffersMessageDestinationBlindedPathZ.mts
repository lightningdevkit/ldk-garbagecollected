 ...
 * A Tuple
 */
export class ThreeTuple_OffersMessageDestinationBlindedPathZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C3Tuple_OffersMessageDestinationBlindedPathZ_free);
	}
	...
	public get_a(): OffersMessage {
		const ret: bigint = bindings.C3Tuple_OffersMessageDestinationBlindedPathZ_get_a(this.ptr);
	...
	public get_b(): Destination {
		const ret: bigint = bindings.C3Tuple_OffersMessageDestinationBlindedPathZ_get_b(this.ptr);
	...
	public get_c(): BlindedPath {
		const ret: bigint = bindings.C3Tuple_OffersMessageDestinationBlindedPathZ_get_c(this.ptr);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.C3Tuple_OffersMessageDestinationBlindedPathZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): ThreeTuple_OffersMessageDestinationBlindedPathZ {
		const ret: bigint = bindings.C3Tuple_OffersMessageDestinationBlindedPathZ_clone(this.ptr);
		const ret_hu_conv: ThreeTuple_OffersMessageDestinationBlindedPathZ = new ThreeTuple_OffersMessageDestinationBlindedPathZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(a: OffersMessage, b: Destination, c: BlindedPath): ThreeTuple_OffersMessageDestinationBlindedPathZ {
		const ret: bigint = bindings.C3Tuple_OffersMessageDestinationBlindedPathZ_new(CommonBase.get_ptr_of(a), CommonBase.get_ptr_of(b), c == null ? 0n : CommonBase.get_ptr_of(c));
		const ret_hu_conv: ThreeTuple_OffersMessageDestinationBlindedPathZ = new ThreeTuple_OffersMessageDestinationBlindedPathZ(null, ret);

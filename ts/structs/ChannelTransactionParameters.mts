...
export class ChannelTransactionParameters extends CommonBase {
	...
	public set_channel_type_features(val: ChannelTypeFeatures): void {
		bindings.ChannelTransactionParameters_set_channel_type_features(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public static constructor_new(holder_pubkeys_arg: ChannelPublicKeys, holder_selected_contest_delay_arg: number, is_outbound_from_holder_arg: boolean, counterparty_parameters_arg: CounterpartyChannelTransactionParameters, funding_outpoint_arg: OutPoint, channel_type_features_arg: ChannelTypeFeatures): ChannelTransactionParameters {
		...
		CommonBase.add_ref_from(ret_hu_conv, channel_type_features_arg);
		return ret_hu_conv;
	}

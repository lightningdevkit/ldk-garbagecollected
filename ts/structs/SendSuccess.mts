...
export class SendSuccess extends CommonBase {
	...
	public static constructor_buffered_awaiting_connection(a: Uint8Array): SendSuccess {
		const ret: bigint = bindings.SendSuccess_buffered_awaiting_connection(bindings.encodeUint8Array(bindings.check_arr_len(a, 33)));
		const ret_hu_conv: SendSuccess = SendSuccess.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public eq(b: SendSuccess): boolean {
		const ret: boolean = bindings.SendSuccess_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}

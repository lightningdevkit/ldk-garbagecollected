...
export class DefaultRouter extends CommonBase {
	 ...
	 */
	public static constructor_new(network_graph: NetworkGraph, logger: Logger): DefaultRouter {
		const ret: number = bindings.DefaultRouter_new(network_graph == null ? 0 : CommonBase.get_ptr_of(network_graph) & ~1, logger == null ? 0 : CommonBase.get_ptr_of(logger));

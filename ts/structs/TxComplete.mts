...
export class TxComplete extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.TxComplete_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.TxComplete_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}

	/**
	 * Constructs a new TxComplete given each field
	 */
	public static constructor_new(channel_id_arg: Uint8Array): TxComplete {
		const ret: bigint = bindings.TxComplete_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)));
	...
	public eq(b: TxComplete): boolean {
		const ret: boolean = bindings.TxComplete_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

...
export class Utxo extends CommonBase {
	...
	public set_outpoint(val: OutPoint): void {
		bindings.Utxo_set_outpoint(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public static constructor_new(outpoint_arg: OutPoint, output_arg: TxOut, satisfaction_weight_arg: bigint): Utxo {
		const ret: bigint = bindings.Utxo_new(outpoint_arg == null ? 0n : CommonBase.get_ptr_of(outpoint_arg), CommonBase.get_ptr_of(output_arg), satisfaction_weight_arg);
	...
	public eq(b: Utxo): boolean {
		const ret: boolean = bindings.Utxo_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public static constructor_new_p2pkh(outpoint: OutPoint, value: bigint, pubkey_hash: Uint8Array): Utxo {
		const ret: bigint = bindings.Utxo_new_p2pkh(outpoint == null ? 0n : CommonBase.get_ptr_of(outpoint), value, bindings.encodeUint8Array(bindings.check_arr_len(pubkey_hash, 20)));
		const ret_hu_conv: Utxo = new Utxo(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);

 ...
 * A Tuple
 */
export class TwoTuple_BlindedPayInfoBlindedPathZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C2Tuple_BlindedPayInfoBlindedPathZ_free);
	}

	/**
	 * 
	 */
	public get_a(): BlindedPayInfo {
		const ret: bigint = bindings.C2Tuple_BlindedPayInfoBlindedPathZ_get_a(this.ptr);
	 ...
	 * 
	 */
	public get_b(): BlindedPath {
		const ret: bigint = bindings.C2Tuple_BlindedPayInfoBlindedPathZ_get_b(this.ptr);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.C2Tuple_BlindedPayInfoBlindedPathZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TwoTuple_BlindedPayInfoBlindedPathZ {
		const ret: bigint = bindings.C2Tuple_BlindedPayInfoBlindedPathZ_clone(this.ptr);
		const ret_hu_conv: TwoTuple_BlindedPayInfoBlindedPathZ = new TwoTuple_BlindedPayInfoBlindedPathZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(a: BlindedPayInfo, b: BlindedPath): TwoTuple_BlindedPayInfoBlindedPathZ {
		const ret: bigint = bindings.C2Tuple_BlindedPayInfoBlindedPathZ_new(a == null ? 0n : CommonBase.get_ptr_of(a), b == null ? 0n : CommonBase.get_ptr_of(b));
		const ret_hu_conv: TwoTuple_BlindedPayInfoBlindedPathZ = new TwoTuple_BlindedPayInfoBlindedPathZ(null, ret);

...
export class Result_COption_PathFailureZDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_COption_PathFailureZDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_COption_PathFailureZDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: Option_PathFailureZ): Result_COption_PathFailureZDecodeErrorZ {
		const ret: bigint = bindings.CResult_COption_PathFailureZDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_COption_PathFailureZDecodeErrorZ {
		const ret: bigint = bindings.CResult_COption_PathFailureZDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_COption_PathFailureZDecodeErrorZ = Result_COption_PathFailureZDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_COption_PathFailureZDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_COption_PathFailureZDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_COption_PathFailureZDecodeErrorZ {
		const ret: bigint = bindings.CResult_COption_PathFailureZDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_COption_PathFailureZDecodeErrorZ = Result_COption_PathFailureZDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_COption_PathFailureZDecodeErrorZ_OK extends Result_COption_PathFailureZDecodeErrorZ {
	public res: Option_PathFailureZ;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_COption_PathFailureZDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: Option_PathFailureZ = Option_PathFailureZ.constr_from_ptr(res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_COption_PathFailureZDecodeErrorZ_Err extends Result_COption_PathFailureZDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_COption_PathFailureZDecodeErrorZ_get_err(ptr);

 ...
 */
export class Hints extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.Hints_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Hints {
		const raw_ty: number = bindings.LDKHints_ty_from_ptr(ptr);
		switch (raw_ty) {
			case 0: return new Hints_Blinded(ptr);
			case 1: return new Hints_Clear(ptr);
			default:
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.Hints_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Hints {
		const ret: bigint = bindings.Hints_clone(this.ptr);
		const ret_hu_conv: Hints = Hints.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_blinded(a: TwoTuple_BlindedPayInfoBlindedPathZ[]): Hints {
		const ret: bigint = bindings.Hints_blinded(bindings.encodeUint64Array(a != null ? a.map(a_conv_37 => a_conv_37 != null ? CommonBase.get_ptr_of(a_conv_37) : 0n) : null));
		const ret_hu_conv: Hints = Hints.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_clear(a: RouteHint[]): Hints {
		const ret: bigint = bindings.Hints_clear(bindings.encodeUint64Array(a != null ? a.map(a_conv_11 => a_conv_11 == null ? 0n : CommonBase.get_ptr_of(a_conv_11)) : null));
		const ret_hu_conv: Hints = Hints.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		a.forEach((a_conv_11: RouteHint) => { CommonBase.add_ref_from(ret_hu_conv, a_conv_11); });
		return ret_hu_conv;
	}
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.Hints_hash(this.ptr);
		return ret;
	}
	 ...
	 */
	public eq(b: Hints): boolean {
		const ret: boolean = bindings.Hints_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}

}
/** A Hints of type Blinded */
export class Hints_Blinded extends Hints {
	public blinded: TwoTuple_BlindedPayInfoBlindedPathZ[];
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const blinded: number = bindings.LDKHints_Blinded_get_blinded(ptr);
		const blinded_conv_37_len: number = bindings.getArrayLength(blinded);
			const blinded_conv_37_arr: TwoTuple_BlindedPayInfoBlindedPathZ[] = new Array(blinded_conv_37_len).fill(null);
			for (var l = 0; l < blinded_conv_37_len; l++) {
				const blinded_conv_37: bigint = bindings.getU64ArrayElem(blinded, l);
				const blinded_conv_37_hu_conv: TwoTuple_BlindedPayInfoBlindedPathZ = new TwoTuple_BlindedPayInfoBlindedPathZ(null, blinded_conv_37);
				CommonBase.add_ref_from(blinded_conv_37_hu_conv, this);
				blinded_conv_37_arr[l] = blinded_conv_37_hu_conv;
			}
			bindings.freeWasmMemory(blinded)
		this.blinded = blinded_conv_37_arr;
	}
}
/** A Hints of type Clear */
export class Hints_Clear extends Hints {
	public clear: RouteHint[];
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const clear: number = bindings.LDKHints_Clear_get_clear(ptr);
		const clear_conv_11_len: number = bindings.getArrayLength(clear);
			const clear_conv_11_arr: RouteHint[] = new Array(clear_conv_11_len).fill(null);
			for (var l = 0; l < clear_conv_11_len; l++) {
				const clear_conv_11: bigint = bindings.getU64ArrayElem(clear, l);
				const clear_conv_11_hu_conv: RouteHint = new RouteHint(null, clear_conv_11);
				CommonBase.add_ref_from(clear_conv_11_hu_conv, this);
				clear_conv_11_arr[l] = clear_conv_11_hu_conv;
			}
			bindings.freeWasmMemory(clear)

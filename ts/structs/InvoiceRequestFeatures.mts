...
export class InvoiceRequestFeatures extends CommonBase {
	 ...
	 */
	public eq(b: InvoiceRequestFeatures): boolean {
		const ret: boolean = bindings.InvoiceRequestFeatures_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public write(): Uint8Array {
		const ret: number = bindings.InvoiceRequestFeatures_write(this.ptr);
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_InvoiceRequestFeaturesDecodeErrorZ {
		const ret: bigint = bindings.InvoiceRequestFeatures_read(bindings.encodeUint8Array(ser));

...
export class CommitmentUpdate extends CommonBase {
	...
	public set_update_add_htlcs(val: UpdateAddHTLC[]): void {
		bindings.CommitmentUpdate_set_update_add_htlcs(this.ptr, bindings.encodeUint64Array(val.map(val_conv_15 => val_conv_15 == null ? 0n : CommonBase.get_ptr_of(val_conv_15))));
	...
	public set_update_fulfill_htlcs(val: UpdateFulfillHTLC[]): void {
		bindings.CommitmentUpdate_set_update_fulfill_htlcs(this.ptr, bindings.encodeUint64Array(val.map(val_conv_19 => val_conv_19 == null ? 0n : CommonBase.get_ptr_of(val_conv_19))));
	...
	public set_update_fail_htlcs(val: UpdateFailHTLC[]): void {
		bindings.CommitmentUpdate_set_update_fail_htlcs(this.ptr, bindings.encodeUint64Array(val.map(val_conv_16 => val_conv_16 == null ? 0n : CommonBase.get_ptr_of(val_conv_16))));
	...
	public set_update_fail_malformed_htlcs(val: UpdateFailMalformedHTLC[]): void {
		bindings.CommitmentUpdate_set_update_fail_malformed_htlcs(this.ptr, bindings.encodeUint64Array(val.map(val_conv_25 => val_conv_25 == null ? 0n : CommonBase.get_ptr_of(val_conv_25))));
	...
	public eq(b: CommitmentUpdate): boolean {
		const ret: boolean = bindings.CommitmentUpdate_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

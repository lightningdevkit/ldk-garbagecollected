...
export class BlindedPayInfo extends CommonBase {
	...
	public set_features(val: BlindedHopFeatures): void {
		bindings.BlindedPayInfo_set_features(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public static constructor_new(fee_base_msat_arg: number, fee_proportional_millionths_arg: number, cltv_expiry_delta_arg: number, htlc_minimum_msat_arg: bigint, htlc_maximum_msat_arg: bigint, features_arg: BlindedHopFeatures): BlindedPayInfo {
		const ret: bigint = bindings.BlindedPayInfo_new(fee_base_msat_arg, fee_proportional_millionths_arg, cltv_expiry_delta_arg, htlc_minimum_msat_arg, htlc_maximum_msat_arg, features_arg == null ? 0n : CommonBase.get_ptr_of(features_arg));
	...
	public eq(b: BlindedPayInfo): boolean {
		const ret: boolean = bindings.BlindedPayInfo_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

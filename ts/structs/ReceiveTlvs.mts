...
export class ReceiveTlvs extends CommonBase {
	...
	public get_payment_secret(): Uint8Array {
		const ret: number = bindings.ReceiveTlvs_get_payment_secret(this.ptr);
	...
	public get_payment_constraints(): PaymentConstraints {
		const ret: bigint = bindings.ReceiveTlvs_get_payment_constraints(this.ptr);
	...
	public set_payment_constraints(val: PaymentConstraints): void {
		bindings.ReceiveTlvs_set_payment_constraints(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	 ...
	 */
	public static constructor_new(payment_secret_arg: Uint8Array, payment_constraints_arg: PaymentConstraints): ReceiveTlvs {
		const ret: bigint = bindings.ReceiveTlvs_new(bindings.encodeUint8Array(bindings.check_arr_len(payment_secret_arg, 32)), payment_constraints_arg == null ? 0n : CommonBase.get_ptr_of(payment_constraints_arg));
		const ret_hu_conv: ReceiveTlvs = new ReceiveTlvs(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, payment_constraints_arg);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_ReceiveTlvsDecodeErrorZ {
		const ret: bigint = bindings.ReceiveTlvs_read(bindings.encodeUint8Array(ser));
		const ret_hu_conv: Result_ReceiveTlvsDecodeErrorZ = Result_ReceiveTlvsDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

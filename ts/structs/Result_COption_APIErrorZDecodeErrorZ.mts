...
export class Result_COption_APIErrorZDecodeErrorZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_COption_APIErrorZDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: Option_APIErrorZ): Result_COption_APIErrorZDecodeErrorZ {
		const ret: bigint = bindings.CResult_COption_APIErrorZDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_COption_APIErrorZDecodeErrorZ {
		const ret: bigint = bindings.CResult_COption_APIErrorZDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_COption_APIErrorZDecodeErrorZ = Result_COption_APIErrorZDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_COption_APIErrorZDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_COption_APIErrorZDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_COption_APIErrorZDecodeErrorZ {
		const ret: bigint = bindings.CResult_COption_APIErrorZDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_COption_APIErrorZDecodeErrorZ = Result_COption_APIErrorZDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_COption_APIErrorZDecodeErrorZ_OK extends Result_COption_APIErrorZDecodeErrorZ {
	public res: Option_APIErrorZ;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_COption_APIErrorZDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: Option_APIErrorZ = Option_APIErrorZ.constr_from_ptr(res);
...
export class Result_COption_APIErrorZDecodeErrorZ_Err extends Result_COption_APIErrorZDecodeErrorZ {
	...
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_COption_APIErrorZDecodeErrorZ_get_err(ptr);

...
export class InboundHTLCErr extends CommonBase {
	 ...
	 * BOLT 4 error code.
	 */
	public get_err_code(): number {
		const ret: number = bindings.InboundHTLCErr_get_err_code(this.ptr);
		return ret;
	}
	 ...
	 * BOLT 4 error code.
	 */
	public set_err_code(val: number): void {
	 ...
	 */
	public static constructor_new(err_code_arg: number, err_data_arg: Uint8Array, msg_arg: string): InboundHTLCErr {
		const ret: bigint = bindings.InboundHTLCErr_new(err_code_arg, bindings.encodeUint8Array(err_data_arg), bindings.encodeString(msg_arg));

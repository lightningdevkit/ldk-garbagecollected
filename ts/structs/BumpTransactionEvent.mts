...
export class BumpTransactionEvent extends CommonBase {
	...
	public static constructor_htlcresolution(claim_id: Uint8Array, target_feerate_sat_per_1000_weight: number, htlc_descriptors: HTLCDescriptor[], tx_lock_time: number): BumpTransactionEvent {
		const ret: bigint = bindings.BumpTransactionEvent_htlcresolution(bindings.encodeUint8Array(bindings.check_arr_len(claim_id, 32)), target_feerate_sat_per_1000_weight, bindings.encodeUint64Array(htlc_descriptors.map(htlc_descriptors_conv_16 => htlc_descriptors_conv_16 == null ? 0n : CommonBase.get_ptr_of(htlc_descriptors_conv_16))), tx_lock_time);
		const ret_hu_conv: BumpTransactionEvent = BumpTransactionEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);

...
export class BumpTransactionEvent extends CommonBase {
	 ...
	 */
	public static constructor_channel_close(claim_id: Uint8Array, package_target_feerate_sat_per_1000_weight: number, commitment_tx: Uint8Array, commitment_tx_fee_satoshis: bigint, anchor_descriptor: AnchorDescriptor, pending_htlcs: HTLCOutputInCommitment[]): BumpTransactionEvent {
		const ret: bigint = bindings.BumpTransactionEvent_channel_close(bindings.encodeUint8Array(bindings.check_arr_len(claim_id, 32)), package_target_feerate_sat_per_1000_weight, bindings.encodeUint8Array(commitment_tx), commitment_tx_fee_satoshis, anchor_descriptor == null ? 0n : CommonBase.get_ptr_of(anchor_descriptor), bindings.encodeUint64Array(pending_htlcs != null ? pending_htlcs.map(pending_htlcs_conv_24 => pending_htlcs_conv_24 == null ? 0n : CommonBase.get_ptr_of(pending_htlcs_conv_24)) : null));
		const ret_hu_conv: BumpTransactionEvent = BumpTransactionEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, anchor_descriptor);
		pending_htlcs.forEach((pending_htlcs_conv_24: HTLCOutputInCommitment) => { CommonBase.add_ref_from(ret_hu_conv, pending_htlcs_conv_24); });
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_htlcresolution(claim_id: Uint8Array, target_feerate_sat_per_1000_weight: number, htlc_descriptors: HTLCDescriptor[], tx_lock_time: number): BumpTransactionEvent {
		const ret: bigint = bindings.BumpTransactionEvent_htlcresolution(bindings.encodeUint8Array(bindings.check_arr_len(claim_id, 32)), target_feerate_sat_per_1000_weight, bindings.encodeUint64Array(htlc_descriptors != null ? htlc_descriptors.map(htlc_descriptors_conv_16 => htlc_descriptors_conv_16 == null ? 0n : CommonBase.get_ptr_of(htlc_descriptors_conv_16)) : null), tx_lock_time);
		const ret_hu_conv: BumpTransactionEvent = BumpTransactionEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		htlc_descriptors.forEach((htlc_descriptors_conv_16: HTLCDescriptor) => { CommonBase.add_ref_from(ret_hu_conv, htlc_descriptors_conv_16); });
		return ret_hu_conv;
	}
	...
	public eq(b: BumpTransactionEvent): boolean {
		const ret: boolean = bindings.BumpTransactionEvent_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}

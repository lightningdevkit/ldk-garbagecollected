...
export class Result_BlindedPathNoneZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_BlindedPathNoneZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_BlindedPathNoneZ {
	 ...
	 */
	public static constructor_ok(o: BlindedPath): Result_BlindedPathNoneZ {
		const ret: bigint = bindings.CResult_BlindedPathNoneZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_err(): Result_BlindedPathNoneZ {
		const ret: bigint = bindings.CResult_BlindedPathNoneZ_err();
		const ret_hu_conv: Result_BlindedPathNoneZ = Result_BlindedPathNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_BlindedPathNoneZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_BlindedPathNoneZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_BlindedPathNoneZ {
		const ret: bigint = bindings.CResult_BlindedPathNoneZ_clone(this.ptr);
		const ret_hu_conv: Result_BlindedPathNoneZ = Result_BlindedPathNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_BlindedPathNoneZ_OK extends Result_BlindedPathNoneZ {
	public res: BlindedPath;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_BlindedPathNoneZ_get_ok(ptr);
		const res_hu_conv: BlindedPath = new BlindedPath(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_BlindedPathNoneZ_Err extends Result_BlindedPathNoneZ {

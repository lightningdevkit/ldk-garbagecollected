...
export class Result_SharedSecretNoneZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_SharedSecretNoneZ {
	 ...
	 */
	public static constructor_ok(o: Uint8Array): Result_SharedSecretNoneZ {
		const ret: bigint = bindings.CResult_SharedSecretNoneZ_ok(bindings.encodeUint8Array(bindings.check_arr_len(o, 32)));
	 ...
	 */
	public static constructor_err(): Result_SharedSecretNoneZ {
		const ret: bigint = bindings.CResult_SharedSecretNoneZ_err();
		const ret_hu_conv: Result_SharedSecretNoneZ = Result_SharedSecretNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_SharedSecretNoneZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_SharedSecretNoneZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_SharedSecretNoneZ {
		const ret: bigint = bindings.CResult_SharedSecretNoneZ_clone(this.ptr);
		const ret_hu_conv: Result_SharedSecretNoneZ = Result_SharedSecretNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_SharedSecretNoneZ_OK extends Result_SharedSecretNoneZ {
	...
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_SharedSecretNoneZ_get_ok(ptr);

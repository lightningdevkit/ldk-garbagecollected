...
export class Result_NodeAnnouncementInfoDecodeErrorZ extends CommonBase {
	...
	public static constructor_ok(o: NodeAnnouncementInfo): Result_NodeAnnouncementInfoDecodeErrorZ {
		const ret: bigint = bindings.CResult_NodeAnnouncementInfoDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
	...
	public static constructor_err(e: DecodeError): Result_NodeAnnouncementInfoDecodeErrorZ {
		const ret: bigint = bindings.CResult_NodeAnnouncementInfoDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_NodeAnnouncementInfoDecodeErrorZ = Result_NodeAnnouncementInfoDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_NodeAnnouncementInfoDecodeErrorZ_OK extends Result_NodeAnnouncementInfoDecodeErrorZ {
	...
	public constructor(_dummy: null, ptr: bigint) {
		...
		const res_hu_conv: NodeAnnouncementInfo = NodeAnnouncementInfo.constr_from_ptr(res);

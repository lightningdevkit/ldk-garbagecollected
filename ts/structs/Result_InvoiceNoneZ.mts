...
export class Result_InvoiceNoneZ extends CommonBase {
	protected constructor(_dummy: object, ptr: number) {
		super(ptr, bindings.CResult_InvoiceNoneZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: number): Result_InvoiceNoneZ {
	 ...
	 */
	public static constructor_ok(o: Invoice): Result_InvoiceNoneZ {
		const ret: number = bindings.CResult_InvoiceNoneZ_ok(o == null ? 0 : CommonBase.get_ptr_of(o) & ~1);
		const ret_hu_conv: Result_InvoiceNoneZ = Result_InvoiceNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_err(): Result_InvoiceNoneZ {
		const ret: number = bindings.CResult_InvoiceNoneZ_err();
		const ret_hu_conv: Result_InvoiceNoneZ = Result_InvoiceNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_InvoiceNoneZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): number {
		const ret: number = bindings.CResult_InvoiceNoneZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_InvoiceNoneZ {
		const ret: number = bindings.CResult_InvoiceNoneZ_clone(this.ptr);
		const ret_hu_conv: Result_InvoiceNoneZ = Result_InvoiceNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_InvoiceNoneZ_OK extends Result_InvoiceNoneZ {
	public res: Invoice;

	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_InvoiceNoneZ_get_ok(ptr);
		const res_hu_conv: Invoice = new Invoice(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_InvoiceNoneZ_Err extends Result_InvoiceNoneZ {

...
export class OnionMessage extends CommonBase {
	...
	public set_onion_routing_packet(val: Packet): void {
		bindings.OnionMessage_set_onion_routing_packet(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public static constructor_new(blinding_point_arg: Uint8Array, onion_routing_packet_arg: Packet): OnionMessage {
		const ret: bigint = bindings.OnionMessage_new(bindings.encodeUint8Array(bindings.check_arr_len(blinding_point_arg, 33)), onion_routing_packet_arg == null ? 0n : CommonBase.get_ptr_of(onion_routing_packet_arg));
	...
	public eq(b: OnionMessage): boolean {
		const ret: boolean = bindings.OnionMessage_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

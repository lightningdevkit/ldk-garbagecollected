...
export class ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ extends CommonBase {
	...
	public get_a(): Uint8Array {
		const ret: number = bindings.C3Tuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ_get_a(this.ptr);
	 ...
	 * 
	 */
	public get_b(): RecipientOnionFields {
		const ret: bigint = bindings.C3Tuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ_get_b(this.ptr);
	 ...
	 * 
	 */
	public get_c(): RouteParameters {
		const ret: bigint = bindings.C3Tuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ_get_c(this.ptr);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.C3Tuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ {
		const ret: bigint = bindings.C3Tuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ_clone(this.ptr);
		const ret_hu_conv: ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ = new ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(a: Uint8Array, b: RecipientOnionFields, c: RouteParameters): ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ {
		const ret: bigint = bindings.C3Tuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ_new(bindings.encodeUint8Array(bindings.check_arr_len(a, 32)), b == null ? 0n : CommonBase.get_ptr_of(b), c == null ? 0n : CommonBase.get_ptr_of(c));
		const ret_hu_conv: ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ = new ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ(null, ret);

 ...
 * A Tuple
 */
export class TwoTuple_TxidCOption_BlockHashZZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C2Tuple_TxidCOption_BlockHashZZ_free);
	}
	...
	public get_a(): Uint8Array {
		const ret: number = bindings.C2Tuple_TxidCOption_BlockHashZZ_get_a(this.ptr);
	 ...
	 * 
	 */
	public get_b(): Option_BlockHashZ {
		const ret: bigint = bindings.C2Tuple_TxidCOption_BlockHashZZ_get_b(this.ptr);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.C2Tuple_TxidCOption_BlockHashZZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TwoTuple_TxidCOption_BlockHashZZ {
		const ret: bigint = bindings.C2Tuple_TxidCOption_BlockHashZZ_clone(this.ptr);
		const ret_hu_conv: TwoTuple_TxidCOption_BlockHashZZ = new TwoTuple_TxidCOption_BlockHashZZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(a: Uint8Array, b: Option_BlockHashZ): TwoTuple_TxidCOption_BlockHashZZ {
		const ret: bigint = bindings.C2Tuple_TxidCOption_BlockHashZZ_new(bindings.encodeUint8Array(bindings.check_arr_len(a, 32)), CommonBase.get_ptr_of(b));
		const ret_hu_conv: TwoTuple_TxidCOption_BlockHashZZ = new TwoTuple_TxidCOption_BlockHashZZ(null, ret);

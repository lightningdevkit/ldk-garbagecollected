...
export class Result_PrivateRouteCreationErrorZ extends CommonBase {
	...
	public static constructor_ok(o: PrivateRoute): Result_PrivateRouteCreationErrorZ {
		const ret: bigint = bindings.CResult_PrivateRouteCreationErrorZ_ok(CommonBase.get_ptr_of(o));
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_PrivateRouteCreationErrorZ_is_ok(this.ptr);
		return ret;
	}

...
export class RouteHint extends CommonBase {
	...
	public set_a(val: RouteHintHop[]): void {
		bindings.RouteHint_set_a(this.ptr, bindings.encodeUint64Array(val.map(val_conv_14 => val_conv_14 == null ? 0n : CommonBase.get_ptr_of(val_conv_14))));
	...
	public static constructor_new(a_arg: RouteHintHop[]): RouteHint {
		const ret: bigint = bindings.RouteHint_new(bindings.encodeUint64Array(a_arg.map(a_arg_conv_14 => a_arg_conv_14 == null ? 0n : CommonBase.get_ptr_of(a_arg_conv_14))));

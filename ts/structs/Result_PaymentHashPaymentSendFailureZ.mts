...
export class Result_PaymentHashPaymentSendFailureZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_PaymentHashPaymentSendFailureZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_PaymentHashPaymentSendFailureZ {
	 ...
	 */
	public static constructor_ok(o: Uint8Array): Result_PaymentHashPaymentSendFailureZ {
		const ret: bigint = bindings.CResult_PaymentHashPaymentSendFailureZ_ok(bindings.encodeUint8Array(bindings.check_arr_len(o, 32)));
	 ...
	 */
	public static constructor_err(e: PaymentSendFailure): Result_PaymentHashPaymentSendFailureZ {
		const ret: bigint = bindings.CResult_PaymentHashPaymentSendFailureZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_PaymentHashPaymentSendFailureZ = Result_PaymentHashPaymentSendFailureZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_PaymentHashPaymentSendFailureZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_PaymentHashPaymentSendFailureZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_PaymentHashPaymentSendFailureZ {
		const ret: bigint = bindings.CResult_PaymentHashPaymentSendFailureZ_clone(this.ptr);
		const ret_hu_conv: Result_PaymentHashPaymentSendFailureZ = Result_PaymentHashPaymentSendFailureZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_PaymentHashPaymentSendFailureZ_OK extends Result_PaymentHashPaymentSendFailureZ {
	public res: Uint8Array;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_PaymentHashPaymentSendFailureZ_get_ok(ptr);
		const res_conv: Uint8Array = bindings.decodeUint8Array(res);
		this.res = res_conv;
	}
}
export class Result_PaymentHashPaymentSendFailureZ_Err extends Result_PaymentHashPaymentSendFailureZ {
	public err: PaymentSendFailure;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_PaymentHashPaymentSendFailureZ_get_err(ptr);

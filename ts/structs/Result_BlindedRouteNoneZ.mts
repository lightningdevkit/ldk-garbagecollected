...
export class Result_BlindedRouteNoneZ extends CommonBase {
	protected constructor(_dummy: object, ptr: bigint) {
		super(ptr, bindings.CResult_BlindedRouteNoneZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_BlindedRouteNoneZ {
	 ...
	 */
	public static constructor_ok(o: BlindedRoute): Result_BlindedRouteNoneZ {
		const ret: bigint = bindings.CResult_BlindedRouteNoneZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
		const ret_hu_conv: Result_BlindedRouteNoneZ = Result_BlindedRouteNoneZ.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_err(): Result_BlindedRouteNoneZ {
		const ret: bigint = bindings.CResult_BlindedRouteNoneZ_err();
		const ret_hu_conv: Result_BlindedRouteNoneZ = Result_BlindedRouteNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_BlindedRouteNoneZ_is_ok(this.ptr);
		return ret;
	}

}
export class Result_BlindedRouteNoneZ_OK extends Result_BlindedRouteNoneZ {
	public res: BlindedRoute;

	/* @internal */
	public constructor(_dummy: object, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_BlindedRouteNoneZ_get_ok(ptr);
		const res_hu_conv: BlindedRoute = new BlindedRoute(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_BlindedRouteNoneZ_Err extends Result_BlindedRouteNoneZ {

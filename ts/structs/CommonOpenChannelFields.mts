...
export class CommonOpenChannelFields extends CommonBase {
	...
	public get_chain_hash(): Uint8Array {
		const ret: number = bindings.CommonOpenChannelFields_get_chain_hash(this.ptr);
	...
	public set_chain_hash(val: Uint8Array): void {
		bindings.CommonOpenChannelFields_set_chain_hash(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public get_temporary_channel_id(): ChannelId {
		const ret: bigint = bindings.CommonOpenChannelFields_get_temporary_channel_id(this.ptr);
	...
	public get_funding_satoshis(): bigint {
		const ret: bigint = bindings.CommonOpenChannelFields_get_funding_satoshis(this.ptr);
		return ret;
	}
	...
	public get_dust_limit_satoshis(): bigint {
		const ret: bigint = bindings.CommonOpenChannelFields_get_dust_limit_satoshis(this.ptr);
		return ret;
	}
	...
	public get_max_htlc_value_in_flight_msat(): bigint {
		const ret: bigint = bindings.CommonOpenChannelFields_get_max_htlc_value_in_flight_msat(this.ptr);
		return ret;
	}
	...
	public get_htlc_minimum_msat(): bigint {
		const ret: bigint = bindings.CommonOpenChannelFields_get_htlc_minimum_msat(this.ptr);
		return ret;
	}
	...
	public get_commitment_feerate_sat_per_1000_weight(): number {
		const ret: number = bindings.CommonOpenChannelFields_get_commitment_feerate_sat_per_1000_weight(this.ptr);
		return ret;
	}
	...
	public get_to_self_delay(): number {
		const ret: number = bindings.CommonOpenChannelFields_get_to_self_delay(this.ptr);
		return ret;
	}
	...
	public get_max_accepted_htlcs(): number {
		const ret: number = bindings.CommonOpenChannelFields_get_max_accepted_htlcs(this.ptr);
		return ret;
	}
	...
	public get_funding_pubkey(): Uint8Array {
		const ret: number = bindings.CommonOpenChannelFields_get_funding_pubkey(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public set_funding_pubkey(val: Uint8Array): void {
		bindings.CommonOpenChannelFields_set_funding_pubkey(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public get_revocation_basepoint(): Uint8Array {
		const ret: number = bindings.CommonOpenChannelFields_get_revocation_basepoint(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public set_revocation_basepoint(val: Uint8Array): void {
		bindings.CommonOpenChannelFields_set_revocation_basepoint(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public get_payment_basepoint(): Uint8Array {
		const ret: number = bindings.CommonOpenChannelFields_get_payment_basepoint(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public set_payment_basepoint(val: Uint8Array): void {
		bindings.CommonOpenChannelFields_set_payment_basepoint(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public get_delayed_payment_basepoint(): Uint8Array {
		const ret: number = bindings.CommonOpenChannelFields_get_delayed_payment_basepoint(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public set_delayed_payment_basepoint(val: Uint8Array): void {
		bindings.CommonOpenChannelFields_set_delayed_payment_basepoint(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public get_htlc_basepoint(): Uint8Array {
		const ret: number = bindings.CommonOpenChannelFields_get_htlc_basepoint(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public set_htlc_basepoint(val: Uint8Array): void {
		bindings.CommonOpenChannelFields_set_htlc_basepoint(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public get_first_per_commitment_point(): Uint8Array {
		const ret: number = bindings.CommonOpenChannelFields_get_first_per_commitment_point(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public set_first_per_commitment_point(val: Uint8Array): void {
		bindings.CommonOpenChannelFields_set_first_per_commitment_point(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public get_channel_flags(): number {
		const ret: number = bindings.CommonOpenChannelFields_get_channel_flags(this.ptr);
		return ret;
	}
	...
	public get_shutdown_scriptpubkey(): Option_CVec_u8ZZ {
		const ret: bigint = bindings.CommonOpenChannelFields_get_shutdown_scriptpubkey(this.ptr);
	...
	public get_channel_type(): ChannelTypeFeatures {
		const ret: bigint = bindings.CommonOpenChannelFields_get_channel_type(this.ptr);
	...
	public static constructor_new(chain_hash_arg: Uint8Array, temporary_channel_id_arg: ChannelId, funding_satoshis_arg: bigint, dust_limit_satoshis_arg: bigint, max_htlc_value_in_flight_msat_arg: bigint, htlc_minimum_msat_arg: bigint, commitment_feerate_sat_per_1000_weight_arg: number, to_self_delay_arg: number, max_accepted_htlcs_arg: number, funding_pubkey_arg: Uint8Array, revocation_basepoint_arg: Uint8Array, payment_basepoint_arg: Uint8Array, delayed_payment_basepoint_arg: Uint8Array, htlc_basepoint_arg: Uint8Array, first_per_commitment_point_arg: Uint8Array, channel_flags_arg: number, shutdown_scriptpubkey_arg: Option_CVec_u8ZZ, channel_type_arg: ChannelTypeFeatures|null): CommonOpenChannelFields {
		const ret: bigint = bindings.CommonOpenChannelFields_new(bindings.encodeUint8Array(chain_hash_arg), CommonBase.get_ptr_of(temporary_channel_id_arg), funding_satoshis_arg, dust_limit_satoshis_arg, max_htlc_value_in_flight_msat_arg, htlc_minimum_msat_arg, commitment_feerate_sat_per_1000_weight_arg, to_self_delay_arg, max_accepted_htlcs_arg, bindings.encodeUint8Array(funding_pubkey_arg), bindings.encodeUint8Array(revocation_basepoint_arg), bindings.encodeUint8Array(payment_basepoint_arg), bindings.encodeUint8Array(delayed_payment_basepoint_arg), bindings.encodeUint8Array(htlc_basepoint_arg), bindings.encodeUint8Array(first_per_commitment_point_arg), channel_flags_arg, CommonBase.get_ptr_of(shutdown_scriptpubkey_arg), channel_type_arg == null ? 0n : CommonBase.get_ptr_of(channel_type_arg));
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.CommonOpenChannelFields_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): CommonOpenChannelFields {
		const ret: bigint = bindings.CommonOpenChannelFields_clone(this.ptr);
		const ret_hu_conv: CommonOpenChannelFields = new CommonOpenChannelFields(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.CommonOpenChannelFields_hash(this.ptr);
		return ret;
	}
	 ...
	 */
	public eq(b: CommonOpenChannelFields): boolean {
		const ret: boolean = bindings.CommonOpenChannelFields_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}
	 ...
	 */
	public channel_parameters(): ChannelParameters {
		const ret: bigint = bindings.CommonOpenChannelFields_channel_parameters(this.ptr);

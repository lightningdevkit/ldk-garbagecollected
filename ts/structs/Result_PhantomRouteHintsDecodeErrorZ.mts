...
export class Result_PhantomRouteHintsDecodeErrorZ extends CommonBase {
	...
	public static constructor_ok(o: PhantomRouteHints): Result_PhantomRouteHintsDecodeErrorZ {
		const ret: bigint = bindings.CResult_PhantomRouteHintsDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
	...
	public static constructor_err(e: DecodeError): Result_PhantomRouteHintsDecodeErrorZ {
		const ret: bigint = bindings.CResult_PhantomRouteHintsDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_PhantomRouteHintsDecodeErrorZ = Result_PhantomRouteHintsDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_PhantomRouteHintsDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}
...
export class Result_PhantomRouteHintsDecodeErrorZ_OK extends Result_PhantomRouteHintsDecodeErrorZ {
...
export class Result_PhantomRouteHintsDecodeErrorZ_Err extends Result_PhantomRouteHintsDecodeErrorZ {

...
export class Result_BlindedPayInfoDecodeErrorZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_BlindedPayInfoDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: BlindedPayInfo): Result_BlindedPayInfoDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedPayInfoDecodeErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_BlindedPayInfoDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedPayInfoDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_BlindedPayInfoDecodeErrorZ = Result_BlindedPayInfoDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_BlindedPayInfoDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_BlindedPayInfoDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_BlindedPayInfoDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedPayInfoDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_BlindedPayInfoDecodeErrorZ = Result_BlindedPayInfoDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_BlindedPayInfoDecodeErrorZ_OK extends Result_BlindedPayInfoDecodeErrorZ {
	public res: BlindedPayInfo;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_BlindedPayInfoDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: BlindedPayInfo = new BlindedPayInfo(null, res);
...
export class Result_BlindedPayInfoDecodeErrorZ_Err extends Result_BlindedPayInfoDecodeErrorZ {
	...
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_BlindedPayInfoDecodeErrorZ_get_err(ptr);

...
export class BlindedHop extends CommonBase {
	...
	public static constructor_new(blinded_node_id_arg: Uint8Array, encrypted_payload_arg: Uint8Array): BlindedHop {
		const ret: bigint = bindings.BlindedHop_new(bindings.encodeUint8Array(bindings.check_arr_len(blinded_node_id_arg, 33)), bindings.encodeUint8Array(encrypted_payload_arg));
	...
	public eq(b: BlindedHop): boolean {
		const ret: boolean = bindings.BlindedHop_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

...
export class KVStore extends CommonBase {
	/* @internal */
	public bindings_instance: bindings.LDKKVStore|null;
	...
	public static new_impl(arg: KVStoreInterface): KVStore {
		const impl_holder: LDKKVStoreHolder = new LDKKVStoreHolder();
		...
		} as bindings.LDKKVStore;
		const ptr_idx: [bigint, number] = bindings.LDKKVStore_new(structImplementation);
	...
	public read(primary_namespace: string, secondary_namespace: string, key: string): Result_CVec_u8ZIOErrorZ {
		const ret: bigint = bindings.KVStore_read(this.ptr, bindings.encodeString(primary_namespace), bindings.encodeString(secondary_namespace), bindings.encodeString(key));
	...
	public write(primary_namespace: string, secondary_namespace: string, key: string, buf: Uint8Array): Result_NoneIOErrorZ {
		const ret: bigint = bindings.KVStore_write(this.ptr, bindings.encodeString(primary_namespace), bindings.encodeString(secondary_namespace), bindings.encodeString(key), bindings.encodeUint8Array(buf));
	...
	public remove(primary_namespace: string, secondary_namespace: string, key: string, lazy: boolean): Result_NoneIOErrorZ {
		const ret: bigint = bindings.KVStore_remove(this.ptr, bindings.encodeString(primary_namespace), bindings.encodeString(secondary_namespace), bindings.encodeString(key), lazy);
		const ret_hu_conv: Result_NoneIOErrorZ = Result_NoneIOErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public list(primary_namespace: string, secondary_namespace: string): Result_CVec_StrZIOErrorZ {
		const ret: bigint = bindings.KVStore_list(this.ptr, bindings.encodeString(primary_namespace), bindings.encodeString(secondary_namespace));

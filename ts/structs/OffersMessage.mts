...
export class OffersMessage extends CommonBase {
	...
	public static constructor_invoice_request(a: InvoiceRequest): OffersMessage {
		const ret: bigint = bindings.OffersMessage_invoice_request(a == null ? 0n : CommonBase.get_ptr_of(a));
		const ret_hu_conv: OffersMessage = OffersMessage.constr_from_ptr(ret);
	...
	public static constructor_invoice(a: Bolt12Invoice): OffersMessage {
		const ret: bigint = bindings.OffersMessage_invoice(a == null ? 0n : CommonBase.get_ptr_of(a));
		const ret_hu_conv: OffersMessage = OffersMessage.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, a);
		return ret_hu_conv;
	...
	public static constructor_invoice_error(a: InvoiceError): OffersMessage {
		const ret: bigint = bindings.OffersMessage_invoice_error(a == null ? 0n : CommonBase.get_ptr_of(a));
		const ret_hu_conv: OffersMessage = OffersMessage.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, a);
		return ret_hu_conv;
	...
	public tlv_type(): bigint {
		const ret: bigint = bindings.OffersMessage_tlv_type(this.ptr);
		return ret;
	}

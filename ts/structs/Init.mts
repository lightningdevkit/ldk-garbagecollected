...
export class Init extends CommonBase {
	 ...
	 */
	public get_networks(): Option_CVec_ChainHashZZ {
		const ret: bigint = bindings.Init_get_networks(this.ptr);
		const ret_hu_conv: Option_CVec_ChainHashZZ = Option_CVec_ChainHashZZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 * If there are no common chains, the connection will be closed.
	 */
	public set_networks(val: Option_CVec_ChainHashZZ): void {
	 ...
	 */
	public static constructor_new(features_arg: InitFeatures, networks_arg: Option_CVec_ChainHashZZ, remote_network_address_arg: Option_NetAddressZ): Init {
		const ret: bigint = bindings.Init_new(features_arg == null ? 0n : CommonBase.get_ptr_of(features_arg), CommonBase.get_ptr_of(networks_arg), CommonBase.get_ptr_of(remote_network_address_arg));
		const ret_hu_conv: Init = new Init(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, features_arg);
		CommonBase.add_ref_from(ret_hu_conv, networks_arg);
		CommonBase.add_ref_from(ret_hu_conv, remote_network_address_arg);
		return ret_hu_conv;
	}
	...
	public eq(b: Init): boolean {
		const ret: boolean = bindings.Init_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

...
export class DelayedPaymentBasepoint extends CommonBase {
	...
	public static constructor_new(a_arg: Uint8Array): DelayedPaymentBasepoint {
		const ret: bigint = bindings.DelayedPaymentBasepoint_new(bindings.encodeUint8Array(bindings.check_arr_len(a_arg, 33)));
	...
	public eq(b: DelayedPaymentBasepoint): boolean {
		const ret: boolean = bindings.DelayedPaymentBasepoint_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

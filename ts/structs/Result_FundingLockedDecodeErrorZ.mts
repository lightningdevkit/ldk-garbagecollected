...
export class Result_FundingLockedDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_FundingLockedDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_FundingLockedDecodeErrorZ {
	...
	public static constructor_ok(o: FundingLocked): Result_FundingLockedDecodeErrorZ {
		const ret: bigint = bindings.CResult_FundingLockedDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
	...
	public static constructor_err(e: DecodeError): Result_FundingLockedDecodeErrorZ {
		const ret: bigint = bindings.CResult_FundingLockedDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_FundingLockedDecodeErrorZ = Result_FundingLockedDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_FundingLockedDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	...
	public clone(): Result_FundingLockedDecodeErrorZ {
		const ret: bigint = bindings.CResult_FundingLockedDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_FundingLockedDecodeErrorZ = Result_FundingLockedDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_FundingLockedDecodeErrorZ_OK extends Result_FundingLockedDecodeErrorZ {
	public res: FundingLocked;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_FundingLockedDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: FundingLocked = new FundingLocked(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_FundingLockedDecodeErrorZ_Err extends Result_FundingLockedDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_FundingLockedDecodeErrorZ_get_err(ptr);

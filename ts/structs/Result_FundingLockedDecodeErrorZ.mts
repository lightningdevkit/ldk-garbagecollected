...
export class Result_FundingLockedDecodeErrorZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: number): Result_FundingLockedDecodeErrorZ {
	...
	public clone_ptr(): number {
		const ret: number = bindings.CResult_FundingLockedDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
...
export class Result_FundingLockedDecodeErrorZ_OK extends Result_FundingLockedDecodeErrorZ {
	...
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_FundingLockedDecodeErrorZ_get_ok(ptr);
...
export class Result_FundingLockedDecodeErrorZ_Err extends Result_FundingLockedDecodeErrorZ {
	...
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const err: number = bindings.CResult_FundingLockedDecodeErrorZ_get_err(ptr);

...
export class ChannelConfigUpdate extends CommonBase {
	 ...
	 */
	public static constructor_new(forwarding_fee_proportional_millionths_arg: Option_u32Z, forwarding_fee_base_msat_arg: Option_u32Z, cltv_expiry_delta_arg: Option_u16Z, max_dust_htlc_exposure_msat_arg: Option_MaxDustHTLCExposureZ, force_close_avoidance_max_fee_satoshis_arg: Option_u64Z): ChannelConfigUpdate {
		...
		CommonBase.add_ref_from(ret_hu_conv, forwarding_fee_proportional_millionths_arg);
		CommonBase.add_ref_from(ret_hu_conv, forwarding_fee_base_msat_arg);
		CommonBase.add_ref_from(ret_hu_conv, cltv_expiry_delta_arg);
		CommonBase.add_ref_from(ret_hu_conv, max_dust_htlc_exposure_msat_arg);
		CommonBase.add_ref_from(ret_hu_conv, force_close_avoidance_max_fee_satoshis_arg);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_default(): ChannelConfigUpdate {
		const ret: bigint = bindings.ChannelConfigUpdate_default();
		const ret_hu_conv: ChannelConfigUpdate = new ChannelConfigUpdate(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

...
export class TxRemoveOutput extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.TxRemoveOutput_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.TxRemoveOutput_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, serial_id_arg: bigint): TxRemoveOutput {
		const ret: bigint = bindings.TxRemoveOutput_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), serial_id_arg);
	...
	public eq(b: TxRemoveOutput): boolean {
		const ret: boolean = bindings.TxRemoveOutput_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

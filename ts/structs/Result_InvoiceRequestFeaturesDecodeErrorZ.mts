...
export class Result_InvoiceRequestFeaturesDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_InvoiceRequestFeaturesDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_InvoiceRequestFeaturesDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: InvoiceRequestFeatures): Result_InvoiceRequestFeaturesDecodeErrorZ {
		const ret: bigint = bindings.CResult_InvoiceRequestFeaturesDecodeErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
		const ret_hu_conv: Result_InvoiceRequestFeaturesDecodeErrorZ = Result_InvoiceRequestFeaturesDecodeErrorZ.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_InvoiceRequestFeaturesDecodeErrorZ {
		const ret: bigint = bindings.CResult_InvoiceRequestFeaturesDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_InvoiceRequestFeaturesDecodeErrorZ = Result_InvoiceRequestFeaturesDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_InvoiceRequestFeaturesDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_InvoiceRequestFeaturesDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_InvoiceRequestFeaturesDecodeErrorZ {
		const ret: bigint = bindings.CResult_InvoiceRequestFeaturesDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_InvoiceRequestFeaturesDecodeErrorZ = Result_InvoiceRequestFeaturesDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_InvoiceRequestFeaturesDecodeErrorZ_OK extends Result_InvoiceRequestFeaturesDecodeErrorZ {
	public res: InvoiceRequestFeatures;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_InvoiceRequestFeaturesDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: InvoiceRequestFeatures = new InvoiceRequestFeatures(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_InvoiceRequestFeaturesDecodeErrorZ_Err extends Result_InvoiceRequestFeaturesDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_InvoiceRequestFeaturesDecodeErrorZ_get_err(ptr);

...
export class SpliceLocked extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.SpliceLocked_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.SpliceLocked_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}

	/**
	 * Constructs a new SpliceLocked given each field
	 */
	public static constructor_new(channel_id_arg: Uint8Array): SpliceLocked {
		const ret: bigint = bindings.SpliceLocked_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)));
	...
	public eq(b: SpliceLocked): boolean {
		const ret: boolean = bindings.SpliceLocked_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

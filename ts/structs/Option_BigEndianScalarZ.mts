...
export class Option_BigEndianScalarZ extends CommonBase {
	 ...
	 */
	public static constructor_some(o_big_endian_bytes: Uint8Array): Option_BigEndianScalarZ {
		const ret: bigint = bindings.COption_BigEndianScalarZ_some(bindings.BigEndianScalar_new(bindings.encodeUint8Array(bindings.check_arr_len(o_big_endian_bytes, 32))));

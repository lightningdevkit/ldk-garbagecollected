...
export class Sign extends CommonBase {
	/* @internal */
	public bindings_instance: bindings.LDKSign|null;
	...
	public static new_impl(arg: SignInterface, baseSign_impl: BaseSignInterface, pubkeys: ChannelPublicKeys): Sign {
		...
		const ptr_idx: [bigint, number] = bindings.LDKSign_new(structImplementation, baseSign.instance_idx!, pubkeys == null ? 0n : pubkeys.clone_ptr());

...
export class InMemorySigner extends CommonBase {
	 ...
	 */
	public static constructor_new(funding_key: Uint8Array, revocation_base_key: Uint8Array, payment_key: Uint8Array, delayed_payment_base_key: Uint8Array, htlc_base_key: Uint8Array, commitment_seed: Uint8Array, channel_value_satoshis: bigint, channel_keys_id: Uint8Array, rand_bytes_unique_start: Uint8Array): InMemorySigner {
		const ret: bigint = bindings.InMemorySigner_new(bindings.encodeUint8Array(bindings.check_arr_len(funding_key, 32)), bindings.encodeUint8Array(bindings.check_arr_len(revocation_base_key, 32)), bindings.encodeUint8Array(bindings.check_arr_len(payment_key, 32)), bindings.encodeUint8Array(bindings.check_arr_len(delayed_payment_base_key, 32)), bindings.encodeUint8Array(bindings.check_arr_len(htlc_base_key, 32)), bindings.encodeUint8Array(bindings.check_arr_len(commitment_seed, 32)), channel_value_satoshis, bindings.encodeUint8Array(bindings.check_arr_len(channel_keys_id, 32)), bindings.encodeUint8Array(bindings.check_arr_len(rand_bytes_unique_start, 32)));
		const ret_hu_conv: InMemorySigner = new InMemorySigner(null, ret);
	 ...
	 * In general, this is safe to `unwrap` only in [`ChannelSigner`] implementation.
	 */
	public counterparty_selected_contest_delay(): Option_u16Z {
		const ret: bigint = bindings.InMemorySigner_counterparty_selected_contest_delay(this.ptr);
	 ...
	 * In general, this is safe to `unwrap` only in [`ChannelSigner`] implementation.
	 */
	public holder_selected_contest_delay(): Option_u16Z {
		const ret: bigint = bindings.InMemorySigner_holder_selected_contest_delay(this.ptr);
		const ret_hu_conv: Option_u16Z = Option_u16Z.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 * In general, this is safe to `unwrap` only in [`ChannelSigner`] implementation.
	 */
	public is_outbound(): Option_boolZ {
		const ret: bigint = bindings.InMemorySigner_is_outbound(this.ptr);
	...
	public channel_type_features(): ChannelTypeFeatures {
		const ret: bigint = bindings.InMemorySigner_channel_type_features(this.ptr);
	 ...
	 */
	public as_WriteableEcdsaChannelSigner(): WriteableEcdsaChannelSigner {
		const ret: bigint = bindings.InMemorySigner_as_WriteableEcdsaChannelSigner(this.ptr);

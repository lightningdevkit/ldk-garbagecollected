...
export class OpenChannel extends CommonBase {
	...
	public get_shutdown_scriptpubkey(): Option_CVec_u8ZZ {
		const ret: bigint = bindings.OpenChannel_get_shutdown_scriptpubkey(this.ptr);
	...
	public set_shutdown_scriptpubkey(val: Option_CVec_u8ZZ): void {
		bindings.OpenChannel_set_shutdown_scriptpubkey(this.ptr, CommonBase.get_ptr_of(val));
	...
	public eq(b: OpenChannel): boolean {
		const ret: boolean = bindings.OpenChannel_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

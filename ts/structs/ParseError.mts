...
export class ParseError extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.ParseError_free); }
	/* @internal */
	 ...
	 */
	public eq(b: ParseError): boolean {
		const ret: boolean = bindings.ParseError_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}

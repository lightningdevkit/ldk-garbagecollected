...
export class HtlcKey extends CommonBase {
	...
	public set_a(val: Uint8Array): void {
		bindings.HtlcKey_set_a(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 33)));
	}
	...
	public static constructor_new(a_arg: Uint8Array): HtlcKey {
		const ret: bigint = bindings.HtlcKey_new(bindings.encodeUint8Array(bindings.check_arr_len(a_arg, 33)));
	...
	public eq(b: HtlcKey): boolean {
		const ret: boolean = bindings.HtlcKey_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public static constructor_from_basepoint(countersignatory_basepoint: HtlcBasepoint, per_commitment_point: Uint8Array): HtlcKey {
		const ret: bigint = bindings.HtlcKey_from_basepoint(countersignatory_basepoint == null ? 0n : CommonBase.get_ptr_of(countersignatory_basepoint), bindings.encodeUint8Array(bindings.check_arr_len(per_commitment_point, 33)));
		const ret_hu_conv: HtlcKey = new HtlcKey(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
	...
	public static constructor_from_secret_key(sk: Uint8Array): HtlcKey {
		const ret: bigint = bindings.HtlcKey_from_secret_key(bindings.encodeUint8Array(bindings.check_arr_len(sk, 32)));
		const ret_hu_conv: HtlcKey = new HtlcKey(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

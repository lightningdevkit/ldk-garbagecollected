...
export class ChannelDerivationParameters extends CommonBase {
	...
	public set_transaction_parameters(val: ChannelTransactionParameters): void {
		bindings.ChannelDerivationParameters_set_transaction_parameters(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public static constructor_new(value_satoshis_arg: bigint, keys_id_arg: Uint8Array, transaction_parameters_arg: ChannelTransactionParameters): ChannelDerivationParameters {
		const ret: bigint = bindings.ChannelDerivationParameters_new(value_satoshis_arg, bindings.encodeUint8Array(bindings.check_arr_len(keys_id_arg, 32)), transaction_parameters_arg == null ? 0n : CommonBase.get_ptr_of(transaction_parameters_arg));
		const ret_hu_conv: ChannelDerivationParameters = new ChannelDerivationParameters(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, transaction_parameters_arg);
		return ret_hu_conv;
	}
	...
	public eq(b: ChannelDerivationParameters): boolean {
		const ret: boolean = bindings.ChannelDerivationParameters_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

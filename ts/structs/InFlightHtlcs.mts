...
export class InFlightHtlcs extends CommonBase {
	...
	public process_path(path: Path, payer_node_id: Uint8Array): void {
		bindings.InFlightHtlcs_process_path(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path), bindings.encodeUint8Array(bindings.check_arr_len(payer_node_id, 33)));
	...
	public add_inflight_htlc(source: NodeId, target: NodeId, channel_scid: bigint, used_msat: bigint): void {
		bindings.InFlightHtlcs_add_inflight_htlc(this.ptr, source == null ? 0n : CommonBase.get_ptr_of(source), target == null ? 0n : CommonBase.get_ptr_of(target), channel_scid, used_msat);
	...
	public used_liquidity_msat(source: NodeId, target: NodeId, channel_scid: bigint): Option_u64Z {
		const ret: bigint = bindings.InFlightHtlcs_used_liquidity_msat(this.ptr, source == null ? 0n : CommonBase.get_ptr_of(source), target == null ? 0n : CommonBase.get_ptr_of(target), channel_scid);

...
export interface ScoreInterface {
	 ...
	 */
	channel_penalty_msat(short_channel_id: bigint, send_amt_msat: bigint, capacity_msat: bigint, source: NodeId, target: NodeId): bigint;
...
export class Score extends CommonBase {
	...
	public static new_impl(arg: ScoreInterface): Score {
		...
		let structImplementation = {
			channel_penalty_msat (short_channel_id: bigint, send_amt_msat: bigint, capacity_msat: bigint, source: number, target: number): bigint {
				...
				const ret: bigint = arg.channel_penalty_msat(short_channel_id, send_amt_msat, capacity_msat, source_hu_conv, target_hu_conv);
				return ret;
			},
	 ...
	 * Thus, implementations should be overflow-safe.
	 */
	public channel_penalty_msat(short_channel_id: bigint, send_amt_msat: bigint, capacity_msat: bigint, source: NodeId, target: NodeId): bigint {
		const ret: bigint = bindings.Score_channel_penalty_msat(this.ptr, short_channel_id, send_amt_msat, capacity_msat, source == null ? 0 : CommonBase.get_ptr_of(source) & ~1, target == null ? 0 : CommonBase.get_ptr_of(target) & ~1);

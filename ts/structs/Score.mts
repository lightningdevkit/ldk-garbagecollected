...
export interface ScoreInterface {
	 ...
	 */
	channel_penalty_msat(short_channel_id: bigint, source: NodeId, target: NodeId, usage: ChannelUsage, score_params: ProbabilisticScoringFeeParameters): bigint;
	/**Handles updating channel penalties after failing to route through a channel.
	 */
	payment_path_failed(path: Path, short_channel_id: bigint): void;
	/**Handles updating channel penalties after successfully routing along a path.
	 */
	payment_path_successful(path: Path): void;
	/**Handles updating channel penalties after a probe over the given path failed.
	 */
	probe_failed(path: Path, short_channel_id: bigint): void;
	/**Handles updating channel penalties after a probe over the given path succeeded.
	 */
	probe_successful(path: Path): void;
...
export class Score extends CommonBase {
	...
	public static new_impl(arg: ScoreInterface): Score {
		...
		let structImplementation = {
			channel_penalty_msat (short_channel_id: bigint, source: bigint, target: bigint, usage: bigint, score_params: bigint): bigint {
				...
				const ret: bigint = arg.channel_penalty_msat(short_channel_id, source_hu_conv, target_hu_conv, usage_hu_conv, score_params_hu_conv);
				return ret;
			},
		...
		const ptr_idx: [bigint, number] = bindings.LDKScore_new(structImplementation);
	 ...
	 * Thus, implementations should be overflow-safe.
	 */
	public channel_penalty_msat(short_channel_id: bigint, source: NodeId, target: NodeId, usage: ChannelUsage, score_params: ProbabilisticScoringFeeParameters): bigint {
		const ret: bigint = bindings.Score_channel_penalty_msat(this.ptr, short_channel_id, source == null ? 0n : CommonBase.get_ptr_of(source), target == null ? 0n : CommonBase.get_ptr_of(target), usage == null ? 0n : CommonBase.get_ptr_of(usage), score_params == null ? 0n : CommonBase.get_ptr_of(score_params));
	 ...
	 * Handles updating channel penalties after failing to route through a channel.
	 */
	public payment_path_failed(path: Path, short_channel_id: bigint): void {
		bindings.Score_payment_path_failed(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path), short_channel_id);
	 ...
	 * Handles updating channel penalties after successfully routing along a path.
	 */
	public payment_path_successful(path: Path): void {
		bindings.Score_payment_path_successful(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path));
		CommonBase.add_ref_from(this, path);
	}
	 ...
	 * Handles updating channel penalties after a probe over the given path failed.
	 */
	public probe_failed(path: Path, short_channel_id: bigint): void {
		bindings.Score_probe_failed(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path), short_channel_id);
		CommonBase.add_ref_from(this, path);
	}
	 ...
	 * Handles updating channel penalties after a probe over the given path succeeded.
	 */
	public probe_successful(path: Path): void {
		bindings.Score_probe_successful(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path));
		CommonBase.add_ref_from(this, path);
	}

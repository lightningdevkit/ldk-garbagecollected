...
export class SpliceAck extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.SpliceAck_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.SpliceAck_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	...
	public get_chain_hash(): Uint8Array {
		const ret: number = bindings.SpliceAck_get_chain_hash(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public set_chain_hash(val: Uint8Array): void {
		bindings.SpliceAck_set_chain_hash(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	...
	public get_relative_satoshis(): bigint {
		const ret: bigint = bindings.SpliceAck_get_relative_satoshis(this.ptr);
		return ret;
	}
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, chain_hash_arg: Uint8Array, relative_satoshis_arg: bigint, funding_pubkey_arg: Uint8Array): SpliceAck {
		const ret: bigint = bindings.SpliceAck_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), bindings.encodeUint8Array(bindings.check_arr_len(chain_hash_arg, 32)), relative_satoshis_arg, bindings.encodeUint8Array(bindings.check_arr_len(funding_pubkey_arg, 33)));
	...
	public eq(b: SpliceAck): boolean {
		const ret: boolean = bindings.SpliceAck_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

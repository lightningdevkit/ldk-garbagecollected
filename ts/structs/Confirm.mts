...
export interface ConfirmInterface {
	 ...
	 */
	get_relevant_txids(): TwoTuple_TxidCOption_BlockHashZZ[];
}
	...
	public static new_impl(arg: ConfirmInterface): Confirm {
		...
		let structImplementation = {
			...
			get_relevant_txids (): number {
				const ret: TwoTuple_TxidCOption_BlockHashZZ[] = arg.get_relevant_txids();
				const result: number = bindings.encodeUint64Array(ret != null ? ret.map(ret_conv_34 => ret_conv_34 == null ? 0n : ret_conv_34.clone_ptr()) : null);
				return result;
			},

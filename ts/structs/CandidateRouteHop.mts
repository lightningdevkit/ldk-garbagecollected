...
export class CandidateRouteHop extends CommonBase {
	...
	public static constructor_first_hop(a: FirstHopCandidate): CandidateRouteHop {
		const ret: bigint = bindings.CandidateRouteHop_first_hop(a == null ? 0n : CommonBase.get_ptr_of(a));
		const ret_hu_conv: CandidateRouteHop = CandidateRouteHop.constr_from_ptr(ret);
	...
	public static constructor_public_hop(a: PublicHopCandidate): CandidateRouteHop {
		const ret: bigint = bindings.CandidateRouteHop_public_hop(a == null ? 0n : CommonBase.get_ptr_of(a));
		const ret_hu_conv: CandidateRouteHop = CandidateRouteHop.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, a);
		return ret_hu_conv;
	...
	public static constructor_private_hop(a: PrivateHopCandidate): CandidateRouteHop {
		const ret: bigint = bindings.CandidateRouteHop_private_hop(a == null ? 0n : CommonBase.get_ptr_of(a));
		const ret_hu_conv: CandidateRouteHop = CandidateRouteHop.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, a);
		return ret_hu_conv;
	...
	public static constructor_blinded(a: BlindedPathCandidate): CandidateRouteHop {
		const ret: bigint = bindings.CandidateRouteHop_blinded(a == null ? 0n : CommonBase.get_ptr_of(a));
		const ret_hu_conv: CandidateRouteHop = CandidateRouteHop.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, a);
		return ret_hu_conv;
	...
	public static constructor_one_hop_blinded(a: OneHopBlindedPathCandidate): CandidateRouteHop {
		const ret: bigint = bindings.CandidateRouteHop_one_hop_blinded(a == null ? 0n : CommonBase.get_ptr_of(a));
		const ret_hu_conv: CandidateRouteHop = CandidateRouteHop.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, a);
		return ret_hu_conv;

...
export class InvoiceFeatures extends CommonBase {
	...
	public supports_variable_length_onion(): boolean {
		const ret: boolean = bindings.InvoiceFeatures_supports_variable_length_onion(this.ptr);
		return ret;
	}
	...
	public requires_variable_length_onion(): boolean {
		const ret: boolean = bindings.InvoiceFeatures_requires_variable_length_onion(this.ptr);
		return ret;
	}
	...
	public supports_payment_secret(): boolean {
		const ret: boolean = bindings.InvoiceFeatures_supports_payment_secret(this.ptr);
		return ret;
	}
	...
	public requires_payment_secret(): boolean {
		const ret: boolean = bindings.InvoiceFeatures_requires_payment_secret(this.ptr);
		return ret;
	}
	...
	public supports_basic_mpp(): boolean {
		const ret: boolean = bindings.InvoiceFeatures_supports_basic_mpp(this.ptr);
		return ret;
	}
	...
	public requires_basic_mpp(): boolean {
		const ret: boolean = bindings.InvoiceFeatures_requires_basic_mpp(this.ptr);
		return ret;
	}
	...
	public supports_payment_metadata(): boolean {
		const ret: boolean = bindings.InvoiceFeatures_supports_payment_metadata(this.ptr);
		return ret;
	}
	...
	public requires_payment_metadata(): boolean {
		const ret: boolean = bindings.InvoiceFeatures_requires_payment_metadata(this.ptr);
		return ret;
	}

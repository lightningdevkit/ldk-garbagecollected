 ...
 */
export class Option_ScriptZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_ScriptZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_ScriptZ {
		const raw_ty: number = bindings.LDKCOption_ScriptZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: Uint8Array): Option_ScriptZ {
		const ret: bigint = bindings.COption_ScriptZ_some(bindings.encodeUint8Array(o));
	 ...
	 */
	public static constructor_none(): Option_ScriptZ {
		const ret: bigint = bindings.COption_ScriptZ_none();
		const ret_hu_conv: Option_ScriptZ = Option_ScriptZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_ScriptZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_ScriptZ {
		const ret: bigint = bindings.COption_ScriptZ_clone(this.ptr);
		const ret_hu_conv: Option_ScriptZ = Option_ScriptZ.constr_from_ptr(ret);
...
export class Option_ScriptZ_Some extends Option_ScriptZ {
	public some: Uint8Array;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const some: number = bindings.LDKCOption_ScriptZ_Some_get_some(ptr);
		const some_conv: Uint8Array = bindings.decodeUint8Array(some);
		this.some = some_conv;
	}
}
/** A Option_ScriptZ of type None */
export class Option_ScriptZ_None extends Option_ScriptZ {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}

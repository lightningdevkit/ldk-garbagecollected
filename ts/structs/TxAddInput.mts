...
export class TxAddInput extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.TxAddInput_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.TxAddInput_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	 ...
	 * malleable.
	 */
	public get_prevtx(): TransactionU16LenLimited {
		const ret: bigint = bindings.TxAddInput_get_prevtx(this.ptr);
		const ret_hu_conv: TransactionU16LenLimited = new TransactionU16LenLimited(null, ret);
	 ...
	 * malleable.
	 */
	public set_prevtx(val: TransactionU16LenLimited): void {
		bindings.TxAddInput_set_prevtx(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, serial_id_arg: bigint, prevtx_arg: TransactionU16LenLimited, prevtx_out_arg: number, sequence_arg: number): TxAddInput {
		const ret: bigint = bindings.TxAddInput_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), serial_id_arg, prevtx_arg == null ? 0n : CommonBase.get_ptr_of(prevtx_arg), prevtx_out_arg, sequence_arg);
		const ret_hu_conv: TxAddInput = new TxAddInput(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, prevtx_arg);
		return ret_hu_conv;
	}
	...
	public eq(b: TxAddInput): boolean {
		const ret: boolean = bindings.TxAddInput_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

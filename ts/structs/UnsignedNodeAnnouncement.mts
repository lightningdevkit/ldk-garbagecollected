...
export class UnsignedNodeAnnouncement extends CommonBase {
	...
	public set_node_id(val: NodeId): void {
		bindings.UnsignedNodeAnnouncement_set_node_id(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public set_alias(val: NodeAlias): void {
		bindings.UnsignedNodeAnnouncement_set_alias(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public set_addresses(val: SocketAddress[]): void {
		...
		val.forEach((val_conv_15: SocketAddress) => { CommonBase.add_ref_from(this, val_conv_15); });
	}
	...
	public eq(b: UnsignedNodeAnnouncement): boolean {
		const ret: boolean = bindings.UnsignedNodeAnnouncement_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

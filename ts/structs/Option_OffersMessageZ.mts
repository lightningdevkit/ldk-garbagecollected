 ...
 */
export class Option_OffersMessageZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_OffersMessageZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_OffersMessageZ {
		const raw_ty: number = bindings.LDKCOption_OffersMessageZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: OffersMessage): Option_OffersMessageZ {
		const ret: bigint = bindings.COption_OffersMessageZ_some(CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_none(): Option_OffersMessageZ {
		const ret: bigint = bindings.COption_OffersMessageZ_none();
		const ret_hu_conv: Option_OffersMessageZ = Option_OffersMessageZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_OffersMessageZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_OffersMessageZ {
		const ret: bigint = bindings.COption_OffersMessageZ_clone(this.ptr);
		const ret_hu_conv: Option_OffersMessageZ = Option_OffersMessageZ.constr_from_ptr(ret);
...
export class Option_OffersMessageZ_Some extends Option_OffersMessageZ {
	public some: OffersMessage;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const some: bigint = bindings.LDKCOption_OffersMessageZ_Some_get_some(ptr);
		const some_hu_conv: OffersMessage = OffersMessage.constr_from_ptr(some);
			CommonBase.add_ref_from(some_hu_conv, this);
		this.some = some_hu_conv;
	}
}
/** A Option_OffersMessageZ of type None */
export class Option_OffersMessageZ_None extends Option_OffersMessageZ {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}

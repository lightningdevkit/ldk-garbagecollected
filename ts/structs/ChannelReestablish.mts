...
export class ChannelReestablish extends CommonBase {
	 ...
	 */
	public get_next_funding_txid(): Option_ThirtyTwoBytesZ {
	 ...
	 * The next funding transaction ID
	 */
	public set_next_funding_txid(val: Option_ThirtyTwoBytesZ): void {
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, next_local_commitment_number_arg: bigint, next_remote_commitment_number_arg: bigint, your_last_per_commitment_secret_arg: Uint8Array, my_current_per_commitment_point_arg: Uint8Array, next_funding_txid_arg: Option_ThirtyTwoBytesZ): ChannelReestablish {
	...
	public eq(b: ChannelReestablish): boolean {
		const ret: boolean = bindings.ChannelReestablish_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

 ...
 * A Tuple
 */
export class TwoTuple_TxidBlockHashZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C2Tuple_TxidBlockHashZ_free);
	}
	...
	public get_a(): Uint8Array {
		const ret: number = bindings.C2Tuple_TxidBlockHashZ_get_a(this.ptr);
	...
	public get_b(): Uint8Array {
		const ret: number = bindings.C2Tuple_TxidBlockHashZ_get_b(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.C2Tuple_TxidBlockHashZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TwoTuple_TxidBlockHashZ {
		const ret: bigint = bindings.C2Tuple_TxidBlockHashZ_clone(this.ptr);
		const ret_hu_conv: TwoTuple_TxidBlockHashZ = new TwoTuple_TxidBlockHashZ(null, ret);
	 ...
	 */
	public static constructor_new(a: Uint8Array, b: Uint8Array): TwoTuple_TxidBlockHashZ {
		const ret: bigint = bindings.C2Tuple_TxidBlockHashZ_new(bindings.encodeUint8Array(bindings.check_arr_len(a, 32)), bindings.encodeUint8Array(bindings.check_arr_len(b, 32)));
		const ret_hu_conv: TwoTuple_TxidBlockHashZ = new TwoTuple_TxidBlockHashZ(null, ret);

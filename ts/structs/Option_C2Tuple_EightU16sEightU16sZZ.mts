 ...
 */
export class Option_C2Tuple_EightU16sEightU16sZZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_C2Tuple_EightU16sEightU16sZZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_C2Tuple_EightU16sEightU16sZZ {
		const raw_ty: number = bindings.LDKCOption_C2Tuple_EightU16sEightU16sZZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: TwoTuple__u168_u168Z): Option_C2Tuple_EightU16sEightU16sZZ {
		const ret: bigint = bindings.COption_C2Tuple_EightU16sEightU16sZZ_some(o != null ? CommonBase.get_ptr_of(o) : 0n);
	 ...
	 */
	public static constructor_none(): Option_C2Tuple_EightU16sEightU16sZZ {
		const ret: bigint = bindings.COption_C2Tuple_EightU16sEightU16sZZ_none();
		const ret_hu_conv: Option_C2Tuple_EightU16sEightU16sZZ = Option_C2Tuple_EightU16sEightU16sZZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_C2Tuple_EightU16sEightU16sZZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_C2Tuple_EightU16sEightU16sZZ {
		const ret: bigint = bindings.COption_C2Tuple_EightU16sEightU16sZZ_clone(this.ptr);
		const ret_hu_conv: Option_C2Tuple_EightU16sEightU16sZZ = Option_C2Tuple_EightU16sEightU16sZZ.constr_from_ptr(ret);
...
export class Option_C2Tuple_EightU16sEightU16sZZ_Some extends Option_C2Tuple_EightU16sEightU16sZZ {
	public some: TwoTuple__u168_u168Z;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const some: bigint = bindings.LDKCOption_C2Tuple_EightU16sEightU16sZZ_Some_get_some(ptr);
		const some_hu_conv: TwoTuple__u168_u168Z = new TwoTuple__u168_u168Z(null, some);
			CommonBase.add_ref_from(some_hu_conv, this);
		this.some = some_hu_conv;
	}
}
/** A Option_C2Tuple_EightU16sEightU16sZZ of type None */
export class Option_C2Tuple_EightU16sEightU16sZZ_None extends Option_C2Tuple_EightU16sEightU16sZZ {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}

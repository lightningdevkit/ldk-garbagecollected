...
export class RecipientOnionFields extends CommonBase {
	...
	public get_payment_secret(): Uint8Array {
		const ret: number = bindings.RecipientOnionFields_get_payment_secret(this.ptr);
	 ...
	 */
	public set_payment_secret(val: Uint8Array|null): void {
		bindings.RecipientOnionFields_set_payment_secret(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	 ...
	 */
	public static constructor_new(payment_secret_arg: Uint8Array, payment_metadata_arg: Option_CVec_u8ZZ): RecipientOnionFields {
		const ret: bigint = bindings.RecipientOnionFields_new(bindings.encodeUint8Array(bindings.check_arr_len(payment_secret_arg, 32)), CommonBase.get_ptr_of(payment_metadata_arg));
		const ret_hu_conv: RecipientOnionFields = new RecipientOnionFields(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, payment_metadata_arg);
		return ret_hu_conv;
	}
	...
	public eq(b: RecipientOnionFields): boolean {
		const ret: boolean = bindings.RecipientOnionFields_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public static constructor_secret_only(payment_secret: Uint8Array): RecipientOnionFields {
		const ret: bigint = bindings.RecipientOnionFields_secret_only(bindings.encodeUint8Array(bindings.check_arr_len(payment_secret, 32)));
		const ret_hu_conv: RecipientOnionFields = new RecipientOnionFields(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

...
export class RecipientOnionFields extends CommonBase {
	 ...
	 */
	public get_payment_secret(): Option_PaymentSecretZ {
		const ret: bigint = bindings.RecipientOnionFields_get_payment_secret(this.ptr);
		const ret_hu_conv: Option_PaymentSecretZ = Option_PaymentSecretZ.constr_from_ptr(ret);
	 ...
	 * recipient will not reject it.
	 */
	public set_payment_secret(val: Option_PaymentSecretZ): void {
	 ...
	 */
	public static constructor_new(payment_secret_arg: Option_PaymentSecretZ, payment_metadata_arg: Option_CVec_u8ZZ): RecipientOnionFields {
		const ret: bigint = bindings.RecipientOnionFields_new(CommonBase.get_ptr_of(payment_secret_arg), CommonBase.get_ptr_of(payment_metadata_arg));
		const ret_hu_conv: RecipientOnionFields = new RecipientOnionFields(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, payment_secret_arg);

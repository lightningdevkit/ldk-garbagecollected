...
export class RecipientOnionFields extends CommonBase {
	...
	public with_custom_tlvs(custom_tlvs: TwoTuple_u64CVec_u8ZZ[]): Result_RecipientOnionFieldsNoneZ {
		const ret: bigint = bindings.RecipientOnionFields_with_custom_tlvs(this.ptr, bindings.encodeUint64Array(custom_tlvs.map(custom_tlvs_conv_23 => custom_tlvs_conv_23 != null ? CommonBase.get_ptr_of(custom_tlvs_conv_23) : 0n)));

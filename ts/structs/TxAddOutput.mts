...
export class TxAddOutput extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.TxAddOutput_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.TxAddOutput_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, serial_id_arg: bigint, sats_arg: bigint, script_arg: Uint8Array): TxAddOutput {
		const ret: bigint = bindings.TxAddOutput_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), serial_id_arg, sats_arg, bindings.encodeUint8Array(script_arg));
	...
	public eq(b: TxAddOutput): boolean {
		const ret: boolean = bindings.TxAddOutput_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

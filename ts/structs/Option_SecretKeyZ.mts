 ...
 */
export class Option_SecretKeyZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_SecretKeyZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_SecretKeyZ {
		const raw_ty: number = bindings.LDKCOption_SecretKeyZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: Uint8Array): Option_SecretKeyZ {
		const ret: bigint = bindings.COption_SecretKeyZ_some(bindings.encodeUint8Array(bindings.check_arr_len(o, 32)));
	 ...
	 */
	public static constructor_none(): Option_SecretKeyZ {
		const ret: bigint = bindings.COption_SecretKeyZ_none();
		const ret_hu_conv: Option_SecretKeyZ = Option_SecretKeyZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_SecretKeyZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_SecretKeyZ {
		const ret: bigint = bindings.COption_SecretKeyZ_clone(this.ptr);
		const ret_hu_conv: Option_SecretKeyZ = Option_SecretKeyZ.constr_from_ptr(ret);
...
export class Option_SecretKeyZ_Some extends Option_SecretKeyZ {
	public some: Uint8Array;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const some: number = bindings.LDKCOption_SecretKeyZ_Some_get_some(ptr);
		const some_conv: Uint8Array = bindings.decodeUint8Array(some);
		this.some = some_conv;
	}
}
/** A Option_SecretKeyZ of type None */
export class Option_SecretKeyZ_None extends Option_SecretKeyZ {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}

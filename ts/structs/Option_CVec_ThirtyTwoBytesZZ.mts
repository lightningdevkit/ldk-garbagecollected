...
export class Option_CVec_ThirtyTwoBytesZZ extends CommonBase {
	...
	public static constructor_some(o: Uint8Array[]): Option_CVec_ThirtyTwoBytesZZ {
		const ret: bigint = bindings.COption_CVec_ThirtyTwoBytesZZ_some(bindings.encodeUint32Array(o.map(o_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(o_conv_12, 32)))));

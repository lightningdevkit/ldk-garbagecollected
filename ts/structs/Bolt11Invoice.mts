...
export class Bolt11Invoice extends CommonBase {
	...
	public eq(b: Bolt11Invoice): boolean {
		const ret: boolean = bindings.Bolt11Invoice_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public static constructor_from_signed(signed_invoice: SignedRawBolt11Invoice): Result_Bolt11InvoiceBolt11SemanticErrorZ {
		const ret: bigint = bindings.Bolt11Invoice_from_signed(signed_invoice == null ? 0n : CommonBase.get_ptr_of(signed_invoice));

...
export class Result_BlindedHopDecodeErrorZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_BlindedHopDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: BlindedHop): Result_BlindedHopDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedHopDecodeErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_BlindedHopDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedHopDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_BlindedHopDecodeErrorZ = Result_BlindedHopDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_BlindedHopDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_BlindedHopDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_BlindedHopDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedHopDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_BlindedHopDecodeErrorZ = Result_BlindedHopDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_BlindedHopDecodeErrorZ_OK extends Result_BlindedHopDecodeErrorZ {
	public res: BlindedHop;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_BlindedHopDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: BlindedHop = new BlindedHop(null, res);
...
export class Result_BlindedHopDecodeErrorZ_Err extends Result_BlindedHopDecodeErrorZ {
	...
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_BlindedHopDecodeErrorZ_get_err(ptr);

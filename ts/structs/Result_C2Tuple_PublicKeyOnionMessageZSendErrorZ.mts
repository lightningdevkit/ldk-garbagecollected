...
export class Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_C2Tuple_PublicKeyOnionMessageZSendErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ {
	 ...
	 */
	public static constructor_ok(o: TwoTuple_PublicKeyOnionMessageZ): Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ {
		const ret: bigint = bindings.CResult_C2Tuple_PublicKeyOnionMessageZSendErrorZ_ok(o != null ? CommonBase.get_ptr_of(o) : 0n);
	 ...
	 */
	public static constructor_err(e: SendError): Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ {
		const ret: bigint = bindings.CResult_C2Tuple_PublicKeyOnionMessageZSendErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ = Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_C2Tuple_PublicKeyOnionMessageZSendErrorZ_is_ok(this.ptr);
		return ret;
	}

}
export class Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ_OK extends Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ {
	public res: TwoTuple_PublicKeyOnionMessageZ;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_C2Tuple_PublicKeyOnionMessageZSendErrorZ_get_ok(ptr);
		const res_hu_conv: TwoTuple_PublicKeyOnionMessageZ = new TwoTuple_PublicKeyOnionMessageZ(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ_Err extends Result_C2Tuple_PublicKeyOnionMessageZSendErrorZ {
	public err: SendError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_C2Tuple_PublicKeyOnionMessageZSendErrorZ_get_err(ptr);

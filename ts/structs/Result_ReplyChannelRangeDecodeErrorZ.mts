...
export class Result_ReplyChannelRangeDecodeErrorZ extends CommonBase {
	...
	public static constructor_ok(o: ReplyChannelRange): Result_ReplyChannelRangeDecodeErrorZ {
		const ret: bigint = bindings.CResult_ReplyChannelRangeDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
	...
	public static constructor_err(e: DecodeError): Result_ReplyChannelRangeDecodeErrorZ {
		const ret: bigint = bindings.CResult_ReplyChannelRangeDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_ReplyChannelRangeDecodeErrorZ = Result_ReplyChannelRangeDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_ReplyChannelRangeDecodeErrorZ_OK extends Result_ReplyChannelRangeDecodeErrorZ {
...
export class Result_ReplyChannelRangeDecodeErrorZ_Err extends Result_ReplyChannelRangeDecodeErrorZ {

...
export class AcceptChannelV2 extends CommonBase {
	...
	public get_temporary_channel_id(): Uint8Array {
		const ret: number = bindings.AcceptChannelV2_get_temporary_channel_id(this.ptr);
	...
	public set_temporary_channel_id(val: Uint8Array): void {
		bindings.AcceptChannelV2_set_temporary_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	...
	public get_shutdown_scriptpubkey(): Option_ScriptZ {
		const ret: bigint = bindings.AcceptChannelV2_get_shutdown_scriptpubkey(this.ptr);
	...
	public set_shutdown_scriptpubkey(val: Option_ScriptZ): void {
		bindings.AcceptChannelV2_set_shutdown_scriptpubkey(this.ptr, CommonBase.get_ptr_of(val));
	...
	public get_channel_type(): ChannelTypeFeatures {
		const ret: bigint = bindings.AcceptChannelV2_get_channel_type(this.ptr);
	...
	public set_channel_type(val: ChannelTypeFeatures|null): void {
		bindings.AcceptChannelV2_set_channel_type(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public eq(b: AcceptChannelV2): boolean {
		const ret: boolean = bindings.AcceptChannelV2_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

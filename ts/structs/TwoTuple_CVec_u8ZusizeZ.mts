 ...
 * A Tuple
 */
export class TwoTuple_CVec_u8ZusizeZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C2Tuple_CVec_u8ZusizeZ_free);
	}
	...
	public get_a(): Uint8Array {
		const ret: number = bindings.C2Tuple_CVec_u8ZusizeZ_get_a(this.ptr);
	 ...
	 */
	public get_b(): number {
		const ret: number = bindings.C2Tuple_CVec_u8ZusizeZ_get_b(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.C2Tuple_CVec_u8ZusizeZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TwoTuple_CVec_u8ZusizeZ {
		const ret: bigint = bindings.C2Tuple_CVec_u8ZusizeZ_clone(this.ptr);
		const ret_hu_conv: TwoTuple_CVec_u8ZusizeZ = new TwoTuple_CVec_u8ZusizeZ(null, ret);
	 ...
	 */
	public static constructor_new(a: Uint8Array, b: number): TwoTuple_CVec_u8ZusizeZ {
		const ret: bigint = bindings.C2Tuple_CVec_u8ZusizeZ_new(bindings.encodeUint8Array(a), b);
		const ret_hu_conv: TwoTuple_CVec_u8ZusizeZ = new TwoTuple_CVec_u8ZusizeZ(null, ret);

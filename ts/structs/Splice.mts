 ...
 */
export class Splice extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.Splice_free);
	}
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.Splice_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.Splice_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	...
	public get_chain_hash(): Uint8Array {
		const ret: number = bindings.Splice_get_chain_hash(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public set_chain_hash(val: Uint8Array): void {
		bindings.Splice_set_chain_hash(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	 ...
	 */
	public get_relative_satoshis(): bigint {
		const ret: bigint = bindings.Splice_get_relative_satoshis(this.ptr);
		return ret;
	}
	 ...
	 * or removed (negative value) by the sender (splice initiator) by splicing into/from the channel.
	 */
	public set_relative_satoshis(val: bigint): void {
	 ...
	 */
	public get_funding_feerate_perkw(): number {
		const ret: number = bindings.Splice_get_funding_feerate_perkw(this.ptr);
		return ret;
	}
	 ...
	 * The feerate for the new funding transaction, set by the splice initiator
	 */
	public set_funding_feerate_perkw(val: number): void {
	...
	public get_locktime(): number {
		const ret: number = bindings.Splice_get_locktime(this.ptr);
		return ret;
	}
	...
	public get_funding_pubkey(): Uint8Array {
		const ret: number = bindings.Splice_get_funding_pubkey(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public set_funding_pubkey(val: Uint8Array): void {
		bindings.Splice_set_funding_pubkey(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 33)));
	}

	/**
	 * Constructs a new Splice given each field
	 */
	public static constructor_new(channel_id_arg: Uint8Array, chain_hash_arg: Uint8Array, relative_satoshis_arg: bigint, funding_feerate_perkw_arg: number, locktime_arg: number, funding_pubkey_arg: Uint8Array): Splice {
		const ret: bigint = bindings.Splice_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), bindings.encodeUint8Array(bindings.check_arr_len(chain_hash_arg, 32)), relative_satoshis_arg, funding_feerate_perkw_arg, locktime_arg, bindings.encodeUint8Array(bindings.check_arr_len(funding_pubkey_arg, 33)));
		const ret_hu_conv: Splice = new Splice(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.Splice_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Splice {
		const ret: bigint = bindings.Splice_clone(this.ptr);
		const ret_hu_conv: Splice = new Splice(null, ret);
	 ...
	 */
	public eq(b: Splice): boolean {
		const ret: boolean = bindings.Splice_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public write(): Uint8Array {
		const ret: number = bindings.Splice_write(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_SpliceDecodeErrorZ {
		const ret: bigint = bindings.Splice_read(bindings.encodeUint8Array(ser));
		const ret_hu_conv: Result_SpliceDecodeErrorZ = Result_SpliceDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

...
export class ProbeSendFailure extends CommonBase {
	 ...
	 */
	public static constructor_sending_failed(a: PaymentSendFailure): ProbeSendFailure {
		const ret: bigint = bindings.ProbeSendFailure_sending_failed(CommonBase.get_ptr_of(a));
		const ret_hu_conv: ProbeSendFailure = ProbeSendFailure.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
	...
	public eq(b: ProbeSendFailure): boolean {
		const ret: boolean = bindings.ProbeSendFailure_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}
...
export class ProbeSendFailure_SendingFailed extends ProbeSendFailure {
	public sending_failed: PaymentSendFailure;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const sending_failed: bigint = bindings.LDKProbeSendFailure_SendingFailed_get_sending_failed(ptr);
		const sending_failed_hu_conv: PaymentSendFailure = PaymentSendFailure.constr_from_ptr(sending_failed);

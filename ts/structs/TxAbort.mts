...
export class TxAbort extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.TxAbort_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.TxAbort_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, data_arg: Uint8Array): TxAbort {
		const ret: bigint = bindings.TxAbort_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), bindings.encodeUint8Array(data_arg));
	...
	public eq(b: TxAbort): boolean {
		const ret: boolean = bindings.TxAbort_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

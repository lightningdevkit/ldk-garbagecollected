...
export class Result_BlindedPathDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_BlindedPathDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_BlindedPathDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: BlindedPath): Result_BlindedPathDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedPathDecodeErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
		const ret_hu_conv: Result_BlindedPathDecodeErrorZ = Result_BlindedPathDecodeErrorZ.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_BlindedPathDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedPathDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_BlindedPathDecodeErrorZ = Result_BlindedPathDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_BlindedPathDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_BlindedPathDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_BlindedPathDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedPathDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_BlindedPathDecodeErrorZ = Result_BlindedPathDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_BlindedPathDecodeErrorZ_OK extends Result_BlindedPathDecodeErrorZ {
	public res: BlindedPath;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_BlindedPathDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: BlindedPath = new BlindedPath(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_BlindedPathDecodeErrorZ_Err extends Result_BlindedPathDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_BlindedPathDecodeErrorZ_get_err(ptr);

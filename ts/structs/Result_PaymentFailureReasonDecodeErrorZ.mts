...
export class Result_PaymentFailureReasonDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_PaymentFailureReasonDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_PaymentFailureReasonDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: PaymentFailureReason): Result_PaymentFailureReasonDecodeErrorZ {
		const ret: bigint = bindings.CResult_PaymentFailureReasonDecodeErrorZ_ok(o);
		const ret_hu_conv: Result_PaymentFailureReasonDecodeErrorZ = Result_PaymentFailureReasonDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_PaymentFailureReasonDecodeErrorZ {
		const ret: bigint = bindings.CResult_PaymentFailureReasonDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_PaymentFailureReasonDecodeErrorZ = Result_PaymentFailureReasonDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_PaymentFailureReasonDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_PaymentFailureReasonDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_PaymentFailureReasonDecodeErrorZ {
		const ret: bigint = bindings.CResult_PaymentFailureReasonDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_PaymentFailureReasonDecodeErrorZ = Result_PaymentFailureReasonDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_PaymentFailureReasonDecodeErrorZ_OK extends Result_PaymentFailureReasonDecodeErrorZ {
	public res: PaymentFailureReason;
...
export class Result_PaymentFailureReasonDecodeErrorZ_Err extends Result_PaymentFailureReasonDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_PaymentFailureReasonDecodeErrorZ_get_err(ptr);

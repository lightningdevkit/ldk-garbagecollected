...
export class ClosingSigned extends CommonBase {
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, fee_satoshis_arg: bigint, signature_arg: Uint8Array, fee_range_arg: ClosingSignedFeeRange|null): ClosingSigned {
	...
	public eq(b: ClosingSigned): boolean {
		const ret: boolean = bindings.ClosingSigned_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

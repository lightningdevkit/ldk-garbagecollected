...
export class Result_CVec_BlindedPathZNoneZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_CVec_BlindedPathZNoneZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_CVec_BlindedPathZNoneZ {
	 ...
	 */
	public static constructor_ok(o: BlindedPath[]): Result_CVec_BlindedPathZNoneZ {
		const ret: bigint = bindings.CResult_CVec_BlindedPathZNoneZ_ok(bindings.encodeUint64Array(o.map(o_conv_13 => o_conv_13 == null ? 0n : CommonBase.get_ptr_of(o_conv_13))));
		const ret_hu_conv: Result_CVec_BlindedPathZNoneZ = Result_CVec_BlindedPathZNoneZ.constr_from_ptr(ret);
		o.forEach((o_conv_13: BlindedPath) => { CommonBase.add_ref_from(ret_hu_conv, o_conv_13); });
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_err(): Result_CVec_BlindedPathZNoneZ {
		const ret: bigint = bindings.CResult_CVec_BlindedPathZNoneZ_err();
		const ret_hu_conv: Result_CVec_BlindedPathZNoneZ = Result_CVec_BlindedPathZNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_CVec_BlindedPathZNoneZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_CVec_BlindedPathZNoneZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_CVec_BlindedPathZNoneZ {
		const ret: bigint = bindings.CResult_CVec_BlindedPathZNoneZ_clone(this.ptr);
		const ret_hu_conv: Result_CVec_BlindedPathZNoneZ = Result_CVec_BlindedPathZNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_CVec_BlindedPathZNoneZ_OK extends Result_CVec_BlindedPathZNoneZ {
	public res: BlindedPath[];

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_CVec_BlindedPathZNoneZ_get_ok(ptr);
		const res_conv_13_len: number = bindings.getArrayLength(res);
		const res_conv_13_arr: BlindedPath[] = new Array(res_conv_13_len).fill(null);
		for (var n = 0; n < res_conv_13_len; n++) {
			const res_conv_13: bigint = bindings.getU64ArrayElem(res, n);
			const res_conv_13_hu_conv: BlindedPath = new BlindedPath(null, res_conv_13);
			CommonBase.add_ref_from(res_conv_13_hu_conv, this);
...
export class Result_CVec_BlindedPathZNoneZ_Err extends Result_CVec_BlindedPathZNoneZ {

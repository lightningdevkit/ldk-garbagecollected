...
export class Invoice extends CommonBase {
	 ...
	 */
	public min_final_cltv_expiry(): bigint {
		const ret: bigint = bindings.Invoice_min_final_cltv_expiry(this.ptr);
		return ret;
	}
	 ...
	 */
	public static constructor_from_str(s: string): Result_InvoiceNoneZ {

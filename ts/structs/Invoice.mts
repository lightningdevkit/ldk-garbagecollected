...
export class Invoice extends CommonBase {
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.Invoice_hash(this.ptr);
		return ret;
	}
	...
	public signable_hash(): Uint8Array {
		const ret: number = bindings.Invoice_signable_hash(this.ptr);
	...
	public duration_since_epoch(): bigint {
		const ret: bigint = bindings.Invoice_duration_since_epoch(this.ptr);
		return ret;
	}
	...
	public payment_hash(): Uint8Array {
		const ret: number = bindings.Invoice_payment_hash(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public payee_pub_key(): Uint8Array {
		const ret: number = bindings.Invoice_payee_pub_key(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public payment_secret(): Uint8Array {
		const ret: number = bindings.Invoice_payment_secret(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public payment_metadata(): Option_CVec_u8ZZ {
		const ret: bigint = bindings.Invoice_payment_metadata(this.ptr);
	...
	public recover_payee_pub_key(): Uint8Array {
		const ret: number = bindings.Invoice_recover_payee_pub_key(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	 ...
	 */
	public expires_at(): Option_DurationZ {
		const ret: bigint = bindings.Invoice_expires_at(this.ptr);
		const ret_hu_conv: Option_DurationZ = Option_DurationZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	...
	public expiry_time(): bigint {
		const ret: bigint = bindings.Invoice_expiry_time(this.ptr);
		return ret;
	}
	...
	public expiration_remaining_from_epoch(time: bigint): bigint {
		const ret: bigint = bindings.Invoice_expiration_remaining_from_epoch(this.ptr, time);
		return ret;
	}
	...
	public would_expire(at_time: bigint): boolean {
		const ret: boolean = bindings.Invoice_would_expire(this.ptr, at_time);
		return ret;
	}
	...
	public min_final_cltv_expiry_delta(): bigint {
		const ret: bigint = bindings.Invoice_min_final_cltv_expiry_delta(this.ptr);
		return ret;
	}
	 ...
	 */
	public fallback_addresses(): string[] {
		const ret: number = bindings.Invoice_fallback_addresses(this.ptr);
		const ret_conv_8_len: number = bindings.getArrayLength(ret);
		const ret_conv_8_arr: string[] = new Array(ret_conv_8_len).fill(null);
		for (var i = 0; i < ret_conv_8_len; i++) {
			const ret_conv_8: number = bindings.getU32ArrayElem(ret, i);
			const ret_conv_8_conv: string = bindings.decodeString(ret_conv_8);
	...
	public private_routes(): PrivateRoute[] {
		const ret: number = bindings.Invoice_private_routes(this.ptr);
	...
	public route_hints(): RouteHint[] {
		const ret: number = bindings.Invoice_route_hints(this.ptr);
	...
	public currency(): Currency {
		const ret: Currency = bindings.Invoice_currency(this.ptr);
		return ret;
	}
	...
	public to_str(): string {
		const ret: number = bindings.Invoice_to_str(this.ptr);

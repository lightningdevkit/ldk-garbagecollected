...
export class Result_ScriptNoneZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_ScriptNoneZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_ScriptNoneZ {
	 ...
	 */
	public static constructor_ok(o: Uint8Array): Result_ScriptNoneZ {
		const ret: bigint = bindings.CResult_ScriptNoneZ_ok(bindings.encodeUint8Array(o));
	 ...
	 */
	public static constructor_err(): Result_ScriptNoneZ {
		const ret: bigint = bindings.CResult_ScriptNoneZ_err();
		const ret_hu_conv: Result_ScriptNoneZ = Result_ScriptNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_ScriptNoneZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_ScriptNoneZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_ScriptNoneZ {
		const ret: bigint = bindings.CResult_ScriptNoneZ_clone(this.ptr);
		const ret_hu_conv: Result_ScriptNoneZ = Result_ScriptNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_ScriptNoneZ_OK extends Result_ScriptNoneZ {
	public res: Uint8Array;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_ScriptNoneZ_get_ok(ptr);
		const res_conv: Uint8Array = bindings.decodeUint8Array(res);
		this.res = res_conv;
	}
}
export class Result_ScriptNoneZ_Err extends Result_ScriptNoneZ {

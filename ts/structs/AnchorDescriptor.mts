...
export class AnchorDescriptor extends CommonBase {
	...
	public set_channel_derivation_parameters(val: ChannelDerivationParameters): void {
		bindings.AnchorDescriptor_set_channel_derivation_parameters(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public set_outpoint(val: OutPoint): void {
		bindings.AnchorDescriptor_set_outpoint(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	 ...
	 */
	public static constructor_new(channel_derivation_parameters_arg: ChannelDerivationParameters, outpoint_arg: OutPoint): AnchorDescriptor {
		const ret: bigint = bindings.AnchorDescriptor_new(channel_derivation_parameters_arg == null ? 0n : CommonBase.get_ptr_of(channel_derivation_parameters_arg), outpoint_arg == null ? 0n : CommonBase.get_ptr_of(outpoint_arg));
		const ret_hu_conv: AnchorDescriptor = new AnchorDescriptor(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, channel_derivation_parameters_arg);
	...
	public eq(b: AnchorDescriptor): boolean {
		const ret: boolean = bindings.AnchorDescriptor_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public witness_script(): Uint8Array {
		const ret: number = bindings.AnchorDescriptor_witness_script(this.ptr);
	...
	public tx_input_witness(signature: Uint8Array): Uint8Array {
		const ret: number = bindings.AnchorDescriptor_tx_input_witness(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(signature, 64)));
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	 ...
	 */
	public derive_channel_signer(signer_provider: SignerProvider): WriteableEcdsaChannelSigner {
		const ret: bigint = bindings.AnchorDescriptor_derive_channel_signer(this.ptr, CommonBase.get_ptr_of(signer_provider));

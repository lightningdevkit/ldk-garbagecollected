...
export class Result_CVec_ECDSASignatureZNoneZ extends CommonBase {
	...
	public static constructor_ok(o: Uint8Array[]): Result_CVec_ECDSASignatureZNoneZ {
		const ret: bigint = bindings.CResult_CVec_ECDSASignatureZNoneZ_ok(bindings.encodeUint32Array(o.map(o_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(o_conv_12, 64)))));

...
export class Result_DescriptionCreationErrorZ extends CommonBase {
	...
	public static constructor_ok(o: Description): Result_DescriptionCreationErrorZ {
		const ret: bigint = bindings.CResult_DescriptionCreationErrorZ_ok(CommonBase.get_ptr_of(o));
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_DescriptionCreationErrorZ_is_ok(this.ptr);
		return ret;
	}

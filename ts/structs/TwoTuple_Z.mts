...
export class TwoTuple_Z extends CommonBase {
	...
	public static constructor_new(a: Uint16Array, b: Uint16Array): TwoTuple_Z {
		const ret: bigint = bindings.C2Tuple_Z_new(bindings.encodeUint16Array(bindings.check_16_arr_len(a, 32)), bindings.encodeUint16Array(bindings.check_16_arr_len(b, 32)));

...
export class PaymentError extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.PaymentError_free); }
	/* @internal */
	 ...
	 */
	public static constructor_sending(a: RetryableSendFailure): PaymentError {
		const ret: bigint = bindings.PaymentError_sending(a);
		const ret_hu_conv: PaymentError = PaymentError.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
...
export class PaymentError_Sending extends PaymentError {
	public sending: RetryableSendFailure;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);

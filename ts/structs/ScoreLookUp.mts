...
export class ScoreLookUp extends CommonBase {
	...
	public channel_penalty_msat(candidate: CandidateRouteHop, usage: ChannelUsage, score_params: ProbabilisticScoringFeeParameters): bigint {
		const ret: bigint = bindings.ScoreLookUp_channel_penalty_msat(this.ptr, candidate == null ? 0n : CommonBase.get_ptr_of(candidate), usage == null ? 0n : CommonBase.get_ptr_of(usage), score_params == null ? 0n : CommonBase.get_ptr_of(score_params));

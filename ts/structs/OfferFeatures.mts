...
export class OfferFeatures extends CommonBase {
	 ...
	 */
	public eq(b: OfferFeatures): boolean {
		const ret: boolean = bindings.OfferFeatures_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public requires_unknown_bits_from(other: OfferFeatures): boolean {
		const ret: boolean = bindings.OfferFeatures_requires_unknown_bits_from(this.ptr, other == null ? 0n : CommonBase.get_ptr_of(other));

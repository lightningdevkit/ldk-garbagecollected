...
export class OfferFeatures extends CommonBase {
	...
	public write(): Uint8Array {
		const ret: number = bindings.OfferFeatures_write(this.ptr);
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_OfferFeaturesDecodeErrorZ {
		const ret: bigint = bindings.OfferFeatures_read(bindings.encodeUint8Array(ser));

 ...
 */
export class Option_PaymentHashZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_PaymentHashZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_PaymentHashZ {
		const raw_ty: number = bindings.LDKCOption_PaymentHashZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: Uint8Array): Option_PaymentHashZ {
		const ret: bigint = bindings.COption_PaymentHashZ_some(bindings.encodeUint8Array(bindings.check_arr_len(o, 32)));
		const ret_hu_conv: Option_PaymentHashZ = Option_PaymentHashZ.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_none(): Option_PaymentHashZ {
		const ret: bigint = bindings.COption_PaymentHashZ_none();
		const ret_hu_conv: Option_PaymentHashZ = Option_PaymentHashZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_PaymentHashZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_PaymentHashZ {
		const ret: bigint = bindings.COption_PaymentHashZ_clone(this.ptr);
		const ret_hu_conv: Option_PaymentHashZ = Option_PaymentHashZ.constr_from_ptr(ret);
...
export class Option_PaymentHashZ_Some extends Option_PaymentHashZ {
	public some: Uint8Array;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const some: number = bindings.LDKCOption_PaymentHashZ_Some_get_some(ptr);
		const some_conv: Uint8Array = bindings.decodeUint8Array(some);
		this.some = some_conv;
	}
}
/** A Option_PaymentHashZ of type None */
export class Option_PaymentHashZ_None extends Option_PaymentHashZ {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}

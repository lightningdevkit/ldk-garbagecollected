 ...
 */
export class ClosingComplete extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.ClosingComplete_free);
	}
	...
	public get_channel_id(): ChannelId {
		const ret: bigint = bindings.ClosingComplete_get_channel_id(this.ptr);
	...
	public set_channel_id(val: ChannelId): void {
		bindings.ClosingComplete_set_channel_id(this.ptr, CommonBase.get_ptr_of(val));
	}
	...
	public get_closer_scriptpubkey(): Uint8Array {
		const ret: number = bindings.ClosingComplete_get_closer_scriptpubkey(this.ptr);
	...
	public set_closer_scriptpubkey(val: Uint8Array): void {
		bindings.ClosingComplete_set_closer_scriptpubkey(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public get_closee_scriptpubkey(): Uint8Array {
		const ret: number = bindings.ClosingComplete_get_closee_scriptpubkey(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public set_closee_scriptpubkey(val: Uint8Array): void {
		bindings.ClosingComplete_set_closee_scriptpubkey(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public get_fee_satoshis(): bigint {
		const ret: bigint = bindings.ClosingComplete_get_fee_satoshis(this.ptr);
		return ret;
	}
	...
	public get_locktime(): number {
		const ret: number = bindings.ClosingComplete_get_locktime(this.ptr);
		return ret;
	}
	...
	public get_closer_output_only(): Option_ECDSASignatureZ {
		const ret: bigint = bindings.ClosingComplete_get_closer_output_only(this.ptr);
	...
	public set_closer_output_only(val: Option_ECDSASignatureZ): void {
		bindings.ClosingComplete_set_closer_output_only(this.ptr, CommonBase.get_ptr_of(val));
	}
	...
	public get_closee_output_only(): Option_ECDSASignatureZ {
		const ret: bigint = bindings.ClosingComplete_get_closee_output_only(this.ptr);
		const ret_hu_conv: Option_ECDSASignatureZ = Option_ECDSASignatureZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	...
	public set_closee_output_only(val: Option_ECDSASignatureZ): void {
		bindings.ClosingComplete_set_closee_output_only(this.ptr, CommonBase.get_ptr_of(val));
	}
	...
	public get_closer_and_closee_outputs(): Option_ECDSASignatureZ {
		const ret: bigint = bindings.ClosingComplete_get_closer_and_closee_outputs(this.ptr);
		const ret_hu_conv: Option_ECDSASignatureZ = Option_ECDSASignatureZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public clone(): ClosingComplete {
		const ret: bigint = bindings.ClosingComplete_clone(this.ptr);
		const ret_hu_conv: ClosingComplete = new ClosingComplete(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.ClosingComplete_hash(this.ptr);
		return ret;
	}
	 ...
	 */
	public eq(b: ClosingComplete): boolean {
		const ret: boolean = bindings.ClosingComplete_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}
	...
	public write(): Uint8Array {
		const ret: number = bindings.ClosingComplete_write(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_ClosingCompleteDecodeErrorZ {
		const ret: bigint = bindings.ClosingComplete_read(bindings.encodeUint8Array(ser));
		const ret_hu_conv: Result_ClosingCompleteDecodeErrorZ = Result_ClosingCompleteDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

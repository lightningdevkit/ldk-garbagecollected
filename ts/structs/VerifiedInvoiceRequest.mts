...
export class VerifiedInvoiceRequest extends CommonBase {
	 ...
	 */
	public get_keys(): Option_SecretKeyZ {
		const ret: bigint = bindings.VerifiedInvoiceRequest_get_keys(this.ptr);
		const ret_hu_conv: Option_SecretKeyZ = Option_SecretKeyZ.constr_from_ptr(ret);
	 ...
	 * [`respond_with`]: Self::respond_with
	 */
	public set_keys(val: Option_SecretKeyZ): void {
		bindings.VerifiedInvoiceRequest_set_keys(this.ptr, CommonBase.get_ptr_of(val));
	...
	public signing_pubkey(): Uint8Array {
		const ret: number = bindings.VerifiedInvoiceRequest_signing_pubkey(this.ptr);
	...
	public payer_id(): Uint8Array {
		const ret: number = bindings.VerifiedInvoiceRequest_payer_id(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}

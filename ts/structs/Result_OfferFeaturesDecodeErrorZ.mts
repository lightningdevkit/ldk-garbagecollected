...
export class Result_OfferFeaturesDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_OfferFeaturesDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_OfferFeaturesDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: OfferFeatures): Result_OfferFeaturesDecodeErrorZ {
		const ret: bigint = bindings.CResult_OfferFeaturesDecodeErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
		const ret_hu_conv: Result_OfferFeaturesDecodeErrorZ = Result_OfferFeaturesDecodeErrorZ.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_OfferFeaturesDecodeErrorZ {
		const ret: bigint = bindings.CResult_OfferFeaturesDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_OfferFeaturesDecodeErrorZ = Result_OfferFeaturesDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_OfferFeaturesDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_OfferFeaturesDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_OfferFeaturesDecodeErrorZ {
		const ret: bigint = bindings.CResult_OfferFeaturesDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_OfferFeaturesDecodeErrorZ = Result_OfferFeaturesDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_OfferFeaturesDecodeErrorZ_OK extends Result_OfferFeaturesDecodeErrorZ {
	public res: OfferFeatures;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_OfferFeaturesDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: OfferFeatures = new OfferFeatures(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_OfferFeaturesDecodeErrorZ_Err extends Result_OfferFeaturesDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_OfferFeaturesDecodeErrorZ_get_err(ptr);

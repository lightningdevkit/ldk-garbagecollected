...
export class Result_NonePaymentErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_NonePaymentErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_NonePaymentErrorZ {
	 ...
	 */
	public static constructor_ok(): Result_NonePaymentErrorZ {
		const ret: bigint = bindings.CResult_NonePaymentErrorZ_ok();
	 ...
	 */
	public static constructor_err(e: PaymentError): Result_NonePaymentErrorZ {
		const ret: bigint = bindings.CResult_NonePaymentErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_NonePaymentErrorZ = Result_NonePaymentErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_NonePaymentErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_NonePaymentErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_NonePaymentErrorZ {
		const ret: bigint = bindings.CResult_NonePaymentErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_NonePaymentErrorZ = Result_NonePaymentErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_NonePaymentErrorZ_OK extends Result_NonePaymentErrorZ {
...
export class Result_NonePaymentErrorZ_Err extends Result_NonePaymentErrorZ {
	public err: PaymentError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_NonePaymentErrorZ_get_err(ptr);

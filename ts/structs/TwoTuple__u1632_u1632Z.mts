...
export class TwoTuple__u1632_u1632Z extends CommonBase {
	...
	public static constructor_new(a: Uint16Array, b: Uint16Array): TwoTuple__u1632_u1632Z {
		const ret: bigint = bindings.C2Tuple__u1632_u1632Z_new(bindings.encodeUint16Array(bindings.check_16_arr_len(a, 32)), bindings.encodeUint16Array(bindings.check_16_arr_len(b, 32)));

...
export class HtlcBasepoint extends CommonBase {
	...
	public static constructor_new(a_arg: Uint8Array): HtlcBasepoint {
		const ret: bigint = bindings.HtlcBasepoint_new(bindings.encodeUint8Array(bindings.check_arr_len(a_arg, 33)));
	...
	public eq(b: HtlcBasepoint): boolean {
		const ret: boolean = bindings.HtlcBasepoint_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

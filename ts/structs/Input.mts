...
export class Input extends CommonBase {
	...
	public set_outpoint(val: OutPoint): void {
		bindings.Input_set_outpoint(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public static constructor_new(outpoint_arg: OutPoint, previous_utxo_arg: TxOut, satisfaction_weight_arg: bigint): Input {
		const ret: bigint = bindings.Input_new(outpoint_arg == null ? 0n : CommonBase.get_ptr_of(outpoint_arg), CommonBase.get_ptr_of(previous_utxo_arg), satisfaction_weight_arg);
	...
	public eq(b: Input): boolean {
		const ret: boolean = bindings.Input_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

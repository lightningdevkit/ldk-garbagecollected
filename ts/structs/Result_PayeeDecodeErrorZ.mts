...
export class Result_PayeeDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: object, ptr: number) {
		super(ptr, bindings.CResult_PayeeDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: number): Result_PayeeDecodeErrorZ {
	...
	public clone_ptr(): number {
		const ret: number = bindings.CResult_PayeeDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
...
export class Result_PayeeDecodeErrorZ_OK extends Result_PayeeDecodeErrorZ {
	public res: Payee;

	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_PayeeDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: Payee = new Payee(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_PayeeDecodeErrorZ_Err extends Result_PayeeDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const err: number = bindings.CResult_PayeeDecodeErrorZ_get_err(ptr);

...
export class NetworkGraph extends CommonBase {
	...
	public handle_network_update(network_update: NetworkUpdate): void {
		bindings.NetworkGraph_handle_network_update(this.ptr, network_update == null ? 0n : CommonBase.get_ptr_of(network_update));
	}
	...
	public update_channel_from_announcement(msg: ChannelAnnouncement, utxo_lookup: Option_UtxoLookupZ): Result_NoneLightningErrorZ {
		const ret: bigint = bindings.NetworkGraph_update_channel_from_announcement(this.ptr, msg == null ? 0n : CommonBase.get_ptr_of(msg), CommonBase.get_ptr_of(utxo_lookup));
		const ret_hu_conv: Result_NoneLightningErrorZ = Result_NoneLightningErrorZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(this, msg);
	...
	public update_channel_from_announcement_no_lookup(msg: ChannelAnnouncement): Result_NoneLightningErrorZ {
		const ret: bigint = bindings.NetworkGraph_update_channel_from_announcement_no_lookup(this.ptr, msg == null ? 0n : CommonBase.get_ptr_of(msg));
		const ret_hu_conv: Result_NoneLightningErrorZ = Result_NoneLightningErrorZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(this, msg);
		return ret_hu_conv;
	}
	...
	public update_channel_from_unsigned_announcement(msg: UnsignedChannelAnnouncement, utxo_lookup: Option_UtxoLookupZ): Result_NoneLightningErrorZ {
		const ret: bigint = bindings.NetworkGraph_update_channel_from_unsigned_announcement(this.ptr, msg == null ? 0n : CommonBase.get_ptr_of(msg), CommonBase.get_ptr_of(utxo_lookup));
		const ret_hu_conv: Result_NoneLightningErrorZ = Result_NoneLightningErrorZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(this, msg);
		CommonBase.add_ref_from(this, utxo_lookup);
		return ret_hu_conv;
	...
	public node_failed_permanent(node_id: Uint8Array): void {
		bindings.NetworkGraph_node_failed_permanent(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(node_id, 33)));
	}
	...
	public verify_channel_update(msg: ChannelUpdate): Result_NoneLightningErrorZ {
		const ret: bigint = bindings.NetworkGraph_verify_channel_update(this.ptr, msg == null ? 0n : CommonBase.get_ptr_of(msg));
		const ret_hu_conv: Result_NoneLightningErrorZ = Result_NoneLightningErrorZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(this, msg);
		return ret_hu_conv;
	}

...
export class SocketAddress extends CommonBase {
	...
	public static constructor_tcp_ip_v4(addr: Uint8Array, port: number): SocketAddress {
		const ret: bigint = bindings.SocketAddress_tcp_ip_v4(bindings.encodeUint8Array(bindings.check_arr_len(addr, 4)), port);
		const ret_hu_conv: SocketAddress = SocketAddress.constr_from_ptr(ret);
	...
	public static constructor_tcp_ip_v6(addr: Uint8Array, port: number): SocketAddress {
		const ret: bigint = bindings.SocketAddress_tcp_ip_v6(bindings.encodeUint8Array(bindings.check_arr_len(addr, 16)), port);
		const ret_hu_conv: SocketAddress = SocketAddress.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public static constructor_onion_v2(a: Uint8Array): SocketAddress {
		const ret: bigint = bindings.SocketAddress_onion_v2(bindings.encodeUint8Array(bindings.check_arr_len(a, 12)));
		const ret_hu_conv: SocketAddress = SocketAddress.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public static constructor_onion_v3(ed25519_pubkey: Uint8Array, checksum: number, version: number, port: number): SocketAddress {
		const ret: bigint = bindings.SocketAddress_onion_v3(bindings.encodeUint8Array(bindings.check_arr_len(ed25519_pubkey, 32)), checksum, version, port);
		const ret_hu_conv: SocketAddress = SocketAddress.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public static constructor_hostname(hostname: Hostname, port: number): SocketAddress {
		const ret: bigint = bindings.SocketAddress_hostname(hostname == null ? 0n : CommonBase.get_ptr_of(hostname), port);
		const ret_hu_conv: SocketAddress = SocketAddress.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
	...
	public eq(b: SocketAddress): boolean {
		const ret: boolean = bindings.SocketAddress_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}

...
export class UnsignedBolt12Invoice extends CommonBase {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.UnsignedBolt12Invoice_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): UnsignedBolt12Invoice {
		const ret: bigint = bindings.UnsignedBolt12Invoice_clone(this.ptr);
		const ret_hu_conv: UnsignedBolt12Invoice = new UnsignedBolt12Invoice(null, ret);
	...
	public tagged_hash(): TaggedHash {
		const ret: bigint = bindings.UnsignedBolt12Invoice_tagged_hash(this.ptr);
	...
	public payment_paths(): BlindedPaymentPath[] {
		const ret: number = bindings.UnsignedBolt12Invoice_payment_paths(this.ptr);
	...
	public created_at(): bigint {
		const ret: bigint = bindings.UnsignedBolt12Invoice_created_at(this.ptr);
		return ret;
	}
	...
	public relative_expiry(): bigint {
		const ret: bigint = bindings.UnsignedBolt12Invoice_relative_expiry(this.ptr);
		return ret;
	}
	...
	public is_expired_no_std(duration_since_epoch: bigint): boolean {
		const ret: boolean = bindings.UnsignedBolt12Invoice_is_expired_no_std(this.ptr, duration_since_epoch);
		return ret;
	}
	...
	public fallbacks(): Address[] {
		const ret: number = bindings.UnsignedBolt12Invoice_fallbacks(this.ptr);
	...
	public invoice_features(): Bolt12InvoiceFeatures {
		const ret: bigint = bindings.UnsignedBolt12Invoice_invoice_features(this.ptr);
	...
	public signing_pubkey(): Uint8Array {
		const ret: number = bindings.UnsignedBolt12Invoice_signing_pubkey(this.ptr);
	...
	public offer_chains(): Option_CVec_ThirtyTwoBytesZZ {
		const ret: bigint = bindings.UnsignedBolt12Invoice_offer_chains(this.ptr);
	...
	public chain(): Uint8Array {
		const ret: number = bindings.UnsignedBolt12Invoice_chain(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public metadata(): Option_CVec_u8ZZ {
		const ret: bigint = bindings.UnsignedBolt12Invoice_metadata(this.ptr);
	...
	public amount(): Option_AmountZ {
		const ret: bigint = bindings.UnsignedBolt12Invoice_amount(this.ptr);
	...
	public offer_features(): OfferFeatures {
		const ret: bigint = bindings.UnsignedBolt12Invoice_offer_features(this.ptr);
	...
	public description(): PrintableString {
		const ret: bigint = bindings.UnsignedBolt12Invoice_description(this.ptr);
	...
	public absolute_expiry(): Option_u64Z {
		const ret: bigint = bindings.UnsignedBolt12Invoice_absolute_expiry(this.ptr);
	...
	public issuer(): PrintableString {
		const ret: bigint = bindings.UnsignedBolt12Invoice_issuer(this.ptr);
		const ret_hu_conv: PrintableString = new PrintableString(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	...
	public message_paths(): BlindedMessagePath[] {
		const ret: number = bindings.UnsignedBolt12Invoice_message_paths(this.ptr);
		const ret_conv_20_len: number = bindings.getArrayLength(ret);
	...
	public supported_quantity(): Option_QuantityZ {
		const ret: bigint = bindings.UnsignedBolt12Invoice_supported_quantity(this.ptr);
	...
	public issuer_signing_pubkey(): Uint8Array {
		const ret: number = bindings.UnsignedBolt12Invoice_issuer_signing_pubkey(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public payer_metadata(): Uint8Array {
		const ret: number = bindings.UnsignedBolt12Invoice_payer_metadata(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public invoice_request_features(): InvoiceRequestFeatures {
		const ret: bigint = bindings.UnsignedBolt12Invoice_invoice_request_features(this.ptr);
	...
	public quantity(): Option_u64Z {
		const ret: bigint = bindings.UnsignedBolt12Invoice_quantity(this.ptr);
		const ret_hu_conv: Option_u64Z = Option_u64Z.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	...
	public payer_signing_pubkey(): Uint8Array {
		const ret: number = bindings.UnsignedBolt12Invoice_payer_signing_pubkey(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public payer_note(): PrintableString {
		const ret: bigint = bindings.UnsignedBolt12Invoice_payer_note(this.ptr);
		const ret_hu_conv: PrintableString = new PrintableString(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	...
	public payment_hash(): Uint8Array {
		const ret: number = bindings.UnsignedBolt12Invoice_payment_hash(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public amount_msats(): bigint {
		const ret: bigint = bindings.UnsignedBolt12Invoice_amount_msats(this.ptr);
		return ret;
	}
	...
	public write(): Uint8Array {
		const ret: number = bindings.UnsignedBolt12Invoice_write(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}

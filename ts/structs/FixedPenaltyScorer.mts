...
export class FixedPenaltyScorer extends CommonBase {
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_FixedPenaltyScorerDecodeErrorZ {
		const ret: number = bindings.FixedPenaltyScorer_read(bindings.encodeUint8Array(ser));

 ...
 */
export class Option_PaymentSecretZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_PaymentSecretZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_PaymentSecretZ {
		const raw_ty: number = bindings.LDKCOption_PaymentSecretZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: Uint8Array): Option_PaymentSecretZ {
		const ret: bigint = bindings.COption_PaymentSecretZ_some(bindings.encodeUint8Array(bindings.check_arr_len(o, 32)));
	 ...
	 */
	public static constructor_none(): Option_PaymentSecretZ {
		const ret: bigint = bindings.COption_PaymentSecretZ_none();
		const ret_hu_conv: Option_PaymentSecretZ = Option_PaymentSecretZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_PaymentSecretZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_PaymentSecretZ {
		const ret: bigint = bindings.COption_PaymentSecretZ_clone(this.ptr);
		const ret_hu_conv: Option_PaymentSecretZ = Option_PaymentSecretZ.constr_from_ptr(ret);
...
export class Option_PaymentSecretZ_Some extends Option_PaymentSecretZ {
	public some: Uint8Array;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const some: number = bindings.LDKCOption_PaymentSecretZ_Some_get_some(ptr);
		const some_conv: Uint8Array = bindings.decodeUint8Array(some);
		this.some = some_conv;
	}
}
/** A Option_PaymentSecretZ of type None */
export class Option_PaymentSecretZ_None extends Option_PaymentSecretZ {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}

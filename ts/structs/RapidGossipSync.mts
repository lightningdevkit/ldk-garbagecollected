...
export class RapidGossipSync extends CommonBase {
	 ...
	 */
	public static constructor_new(network_graph: NetworkGraph): RapidGossipSync {
		const ret: bigint = bindings.RapidGossipSync_new(network_graph == null ? 0n : CommonBase.get_ptr_of(network_graph));

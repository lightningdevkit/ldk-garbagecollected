...
export class InvoiceRequest extends CommonBase {
	...
	public metadata(): Uint8Array {
		const ret: number = bindings.InvoiceRequest_metadata(this.ptr);
	...
	public features(): InvoiceRequestFeatures {
		const ret: bigint = bindings.InvoiceRequest_features(this.ptr);
	...
	public payer_id(): Uint8Array {
		const ret: number = bindings.InvoiceRequest_payer_id(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	 ...
	 * [`Bolt12Invoice`]: crate::offers::invoice::Bolt12Invoice
	 */
	public verify(key: ExpandedKey): Result_COption_KeyPairZNoneZ {
		const ret: bigint = bindings.InvoiceRequest_verify(this.ptr, key == null ? 0n : CommonBase.get_ptr_of(key));
		const ret_hu_conv: Result_COption_KeyPairZNoneZ = Result_COption_KeyPairZNoneZ.constr_from_ptr(ret);

...
export class Result_QueryShortChannelIdsDecodeErrorZ extends CommonBase {
	...
	public static constructor_ok(o: QueryShortChannelIds): Result_QueryShortChannelIdsDecodeErrorZ {
		const ret: bigint = bindings.CResult_QueryShortChannelIdsDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
	...
	public static constructor_err(e: DecodeError): Result_QueryShortChannelIdsDecodeErrorZ {
		const ret: bigint = bindings.CResult_QueryShortChannelIdsDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_QueryShortChannelIdsDecodeErrorZ = Result_QueryShortChannelIdsDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_QueryShortChannelIdsDecodeErrorZ_OK extends Result_QueryShortChannelIdsDecodeErrorZ {
...
export class Result_QueryShortChannelIdsDecodeErrorZ_Err extends Result_QueryShortChannelIdsDecodeErrorZ {

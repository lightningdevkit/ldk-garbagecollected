...
export class BumpTransactionEventHandler extends CommonBase {
	 ...
	 * [`Event::BumpTransaction`]: crate::events::Event::BumpTransaction
	 */
	public static constructor_new(broadcaster: BroadcasterInterface, utxo_source: CoinSelectionSource, signer_provider: SignerProvider, logger: Logger): BumpTransactionEventHandler {
		const ret: bigint = bindings.BumpTransactionEventHandler_new(CommonBase.get_ptr_of(broadcaster), CommonBase.get_ptr_of(utxo_source), CommonBase.get_ptr_of(signer_provider), CommonBase.get_ptr_of(logger));
		const ret_hu_conv: BumpTransactionEventHandler = new BumpTransactionEventHandler(null, ret);
	...
	public handle_event(event: BumpTransactionEvent): void {
		bindings.BumpTransactionEventHandler_handle_event(this.ptr, event == null ? 0n : CommonBase.get_ptr_of(event));
	}

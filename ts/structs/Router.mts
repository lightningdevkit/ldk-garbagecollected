...
export interface RouterInterface {
	 ...
	 * given in `tlvs`.
	 */
	create_blinded_payment_paths(recipient: Uint8Array, first_hops: ChannelDetails[], tlvs: ReceiveTlvs, amount_msats: bigint): Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ;
}
...
export class Router extends CommonBase {
	...
	public static new_impl(arg: RouterInterface, messageRouter_impl: MessageRouterInterface): Router {
		...
		const ptr_idx: [bigint, number] = bindings.LDKRouter_new(structImplementation, messageRouter.instance_idx!);
	 ...
	 * Note that first_hops (or a relevant inner pointer) may be NULL or all-0s to represent None
	 */
	public find_route(payer: Uint8Array, route_params: RouteParameters, first_hops: ChannelDetails[]|null, inflight_htlcs: InFlightHtlcs): Result_RouteLightningErrorZ {
	 ...
	 * Note that first_hops (or a relevant inner pointer) may be NULL or all-0s to represent None
	 */
	public find_route_with_id(payer: Uint8Array, route_params: RouteParameters, first_hops: ChannelDetails[]|null, inflight_htlcs: InFlightHtlcs, _payment_hash: Uint8Array, _payment_id: Uint8Array): Result_RouteLightningErrorZ {
		const ret: bigint = bindings.Router_find_route_with_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(payer, 33)), route_params == null ? 0n : CommonBase.get_ptr_of(route_params), bindings.encodeUint64Array(first_hops != null ? first_hops.map(first_hops_conv_16 => first_hops_conv_16 == null ? 0n : CommonBase.get_ptr_of(first_hops_conv_16)) : null), inflight_htlcs == null ? 0n : CommonBase.get_ptr_of(inflight_htlcs), bindings.encodeUint8Array(bindings.check_arr_len(_payment_hash, 32)), bindings.encodeUint8Array(bindings.check_arr_len(_payment_id, 32)));
		const ret_hu_conv: Result_RouteLightningErrorZ = Result_RouteLightningErrorZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(this, route_params);
		if (first_hops != null) { first_hops.forEach((first_hops_conv_16: ChannelDetails) => { CommonBase.add_ref_from(this, first_hops_conv_16); }) };
		CommonBase.add_ref_from(this, inflight_htlcs);
	 ...
	 * given in `tlvs`.
	 */
	public create_blinded_payment_paths(recipient: Uint8Array, first_hops: ChannelDetails[], tlvs: ReceiveTlvs, amount_msats: bigint): Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ {
		const ret: bigint = bindings.Router_create_blinded_payment_paths(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(recipient, 33)), bindings.encodeUint64Array(first_hops.map(first_hops_conv_16 => first_hops_conv_16 == null ? 0n : CommonBase.get_ptr_of(first_hops_conv_16))), tlvs == null ? 0n : CommonBase.get_ptr_of(tlvs), amount_msats);
		const ret_hu_conv: Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ = Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ.constr_from_ptr(ret);
		first_hops.forEach((first_hops_conv_16: ChannelDetails) => { CommonBase.add_ref_from(this, first_hops_conv_16); });
		CommonBase.add_ref_from(this, tlvs);
		return ret_hu_conv;
	}

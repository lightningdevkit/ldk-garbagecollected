 ...
 * A Tuple
 */
export class TwoTuple_PublicKeyOnionMessageZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C2Tuple_PublicKeyOnionMessageZ_free);
	}
	...
	public get_a(): Uint8Array {
		const ret: number = bindings.C2Tuple_PublicKeyOnionMessageZ_get_a(this.ptr);
	...
	public get_b(): OnionMessage {
		const ret: bigint = bindings.C2Tuple_PublicKeyOnionMessageZ_get_b(this.ptr);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.C2Tuple_PublicKeyOnionMessageZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TwoTuple_PublicKeyOnionMessageZ {
		const ret: bigint = bindings.C2Tuple_PublicKeyOnionMessageZ_clone(this.ptr);
		const ret_hu_conv: TwoTuple_PublicKeyOnionMessageZ = new TwoTuple_PublicKeyOnionMessageZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(a: Uint8Array, b: OnionMessage): TwoTuple_PublicKeyOnionMessageZ {
		const ret: bigint = bindings.C2Tuple_PublicKeyOnionMessageZ_new(bindings.encodeUint8Array(bindings.check_arr_len(a, 33)), b == null ? 0n : CommonBase.get_ptr_of(b));
		const ret_hu_conv: TwoTuple_PublicKeyOnionMessageZ = new TwoTuple_PublicKeyOnionMessageZ(null, ret);

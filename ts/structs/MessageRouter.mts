...
export interface MessageRouterInterface {
	 ...
	 */
	create_blinded_paths(recipient: Uint8Array, peers: Uint8Array[]): Result_CVec_BlindedPathZNoneZ;
}
...
export class MessageRouter extends CommonBase {
	...
	public static new_impl(arg: MessageRouterInterface): MessageRouter {
		...
		let structImplementation = {
			...
			create_blinded_paths (recipient: number, peers: number): bigint {
				...
				bindings.freeWasmMemory(peers)
				const ret: Result_CVec_BlindedPathZNoneZ = arg.create_blinded_paths(recipient_conv, peers_conv_12_arr);
				const result: bigint = ret == null ? 0n : ret.clone_ptr();
				return result;
			},
	...
	public find_path(sender: Uint8Array, peers: Uint8Array[], destination: Destination): Result_OnionMessagePathNoneZ {
		const ret: bigint = bindings.MessageRouter_find_path(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(sender, 33)), bindings.encodeUint32Array(peers.map(peers_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(peers_conv_12, 33)))), CommonBase.get_ptr_of(destination));
	 ...
	 * direct peers with the `recipient`.
	 */
	public create_blinded_paths(recipient: Uint8Array, peers: Uint8Array[]): Result_CVec_BlindedPathZNoneZ {
		const ret: bigint = bindings.MessageRouter_create_blinded_paths(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(recipient, 33)), bindings.encodeUint32Array(peers.map(peers_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(peers_conv_12, 33)))));

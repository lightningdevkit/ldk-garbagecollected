...
export class MessageRouter extends CommonBase {
	...
	public find_path(sender: Uint8Array, peers: Uint8Array[], destination: Destination): Result_OnionMessagePathNoneZ {
		const ret: bigint = bindings.MessageRouter_find_path(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(sender, 33)), bindings.encodeUint32Array(peers != null ? peers.map(peers_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(peers_conv_12, 33))) : null), CommonBase.get_ptr_of(destination));

 ...
 * A Tuple
 */
export class TwoTuple_OutPointCVec_MonitorUpdateIdZZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C2Tuple_OutPointCVec_MonitorUpdateIdZZ_free);
	}
	...
	public get_a(): OutPoint {
		const ret: bigint = bindings.C2Tuple_OutPointCVec_MonitorUpdateIdZZ_get_a(this.ptr);
	 ...
	 * 
	 */
	public get_b(): MonitorUpdateId[] {
		const ret: number = bindings.C2Tuple_OutPointCVec_MonitorUpdateIdZZ_get_b(this.ptr);
		const ret_conv_17_len: number = bindings.getArrayLength(ret);
		const ret_conv_17_arr: MonitorUpdateId[] = new Array(ret_conv_17_len).fill(null);
		for (var r = 0; r < ret_conv_17_len; r++) {
			const ret_conv_17: bigint = bindings.getU64ArrayElem(ret, r);
			const ret_conv_17_hu_conv: MonitorUpdateId = new MonitorUpdateId(null, ret_conv_17);
			CommonBase.add_ref_from(ret_conv_17_hu_conv, this);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.C2Tuple_OutPointCVec_MonitorUpdateIdZZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TwoTuple_OutPointCVec_MonitorUpdateIdZZ {
		const ret: bigint = bindings.C2Tuple_OutPointCVec_MonitorUpdateIdZZ_clone(this.ptr);
		const ret_hu_conv: TwoTuple_OutPointCVec_MonitorUpdateIdZZ = new TwoTuple_OutPointCVec_MonitorUpdateIdZZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(a: OutPoint, b: MonitorUpdateId[]): TwoTuple_OutPointCVec_MonitorUpdateIdZZ {
		const ret: bigint = bindings.C2Tuple_OutPointCVec_MonitorUpdateIdZZ_new(a == null ? 0n : CommonBase.get_ptr_of(a), bindings.encodeUint64Array(b != null ? b.map(b_conv_17 => b_conv_17 == null ? 0n : CommonBase.get_ptr_of(b_conv_17)) : null));
		const ret_hu_conv: TwoTuple_OutPointCVec_MonitorUpdateIdZZ = new TwoTuple_OutPointCVec_MonitorUpdateIdZZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, a);
		b.forEach((b_conv_17: MonitorUpdateId) => { CommonBase.add_ref_from(ret_hu_conv, b_conv_17); });
		return ret_hu_conv;
	}

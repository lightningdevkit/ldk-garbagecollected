...
export class ChannelSigner extends CommonBase {
	...
	public static new_impl(arg: ChannelSignerInterface, pubkeys: ChannelPublicKeys): ChannelSigner {
		...
		const ptr_idx: [bigint, number] = bindings.LDKChannelSigner_new(structImplementation, pubkeys == null ? 0n : pubkeys.clone_ptr());
	...
	public get_per_commitment_point(idx: bigint): Uint8Array {
		const ret: number = bindings.ChannelSigner_get_per_commitment_point(this.ptr, idx);
	...
	public release_commitment_secret(idx: bigint): Uint8Array {
		const ret: number = bindings.ChannelSigner_release_commitment_secret(this.ptr, idx);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public validate_holder_commitment(holder_tx: HolderCommitmentTransaction, outbound_htlc_preimages: Uint8Array[]): Result_NoneNoneZ {
		const ret: bigint = bindings.ChannelSigner_validate_holder_commitment(this.ptr, holder_tx == null ? 0n : CommonBase.get_ptr_of(holder_tx), bindings.encodeUint32Array(outbound_htlc_preimages.map(outbound_htlc_preimages_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(outbound_htlc_preimages_conv_12, 32)))));
	...
	public validate_counterparty_revocation(idx: bigint, secret: Uint8Array): Result_NoneNoneZ {
		const ret: bigint = bindings.ChannelSigner_validate_counterparty_revocation(this.ptr, idx, bindings.encodeUint8Array(bindings.check_arr_len(secret, 32)));
		const ret_hu_conv: Result_NoneNoneZ = Result_NoneNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public provide_channel_parameters(channel_parameters: ChannelTransactionParameters): void {
		bindings.ChannelSigner_provide_channel_parameters(this.ptr, channel_parameters == null ? 0n : CommonBase.get_ptr_of(channel_parameters));
	...
	public get_pubkeys(): ChannelPublicKeys {
		const ret: bigint = bindings.ChannelSigner_get_pubkeys(this.ptr);

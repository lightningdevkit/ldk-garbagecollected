...
export class PaymentParameters extends CommonBase {
	 ...
	 */
	public static constructor_new(payee_arg: Payee, expiry_time_arg: Option_u64Z, max_total_cltv_expiry_delta_arg: number, max_path_count_arg: number, max_channel_saturation_power_of_half_arg: number, previously_failed_channels_arg: bigint[]): PaymentParameters {
		const ret: bigint = bindings.PaymentParameters_new(CommonBase.get_ptr_of(payee_arg), CommonBase.get_ptr_of(expiry_time_arg), max_total_cltv_expiry_delta_arg, max_path_count_arg, max_channel_saturation_power_of_half_arg, bindings.encodeUint64Array(previously_failed_channels_arg));
	...
	public static constructor_from_bolt12_invoice(invoice: Bolt12Invoice): PaymentParameters {
		const ret: bigint = bindings.PaymentParameters_from_bolt12_invoice(invoice == null ? 0n : CommonBase.get_ptr_of(invoice));
		const ret_hu_conv: PaymentParameters = new PaymentParameters(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
	...
	public static constructor_blinded(blinded_route_hints: TwoTuple_BlindedPayInfoBlindedPathZ[]): PaymentParameters {
		const ret: bigint = bindings.PaymentParameters_blinded(bindings.encodeUint64Array(blinded_route_hints.map(blinded_route_hints_conv_37 => blinded_route_hints_conv_37 != null ? CommonBase.get_ptr_of(blinded_route_hints_conv_37) : 0n)));
		const ret_hu_conv: PaymentParameters = new PaymentParameters(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

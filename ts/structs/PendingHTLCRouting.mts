...
export class PendingHTLCRouting extends CommonBase {
	...
	public static constructor_forward(onion_packet: OnionPacket, short_channel_id: bigint, blinded: BlindedForward): PendingHTLCRouting {
		const ret: bigint = bindings.PendingHTLCRouting_forward(onion_packet == null ? 0n : CommonBase.get_ptr_of(onion_packet), short_channel_id, blinded == null ? 0n : CommonBase.get_ptr_of(blinded));
		const ret_hu_conv: PendingHTLCRouting = PendingHTLCRouting.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, onion_packet);
		CommonBase.add_ref_from(ret_hu_conv, blinded);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_receive(payment_data: FinalOnionHopData, payment_metadata: Option_CVec_u8ZZ, incoming_cltv_expiry: number, phantom_shared_secret: Uint8Array, custom_tlvs: TwoTuple_u64CVec_u8ZZ[], requires_blinded_error: boolean): PendingHTLCRouting {
		const ret: bigint = bindings.PendingHTLCRouting_receive(payment_data == null ? 0n : CommonBase.get_ptr_of(payment_data), CommonBase.get_ptr_of(payment_metadata), incoming_cltv_expiry, bindings.encodeUint8Array(bindings.check_arr_len(phantom_shared_secret, 32)), bindings.encodeUint64Array(custom_tlvs.map(custom_tlvs_conv_23 => custom_tlvs_conv_23 != null ? CommonBase.get_ptr_of(custom_tlvs_conv_23) : 0n)), requires_blinded_error);
		const ret_hu_conv: PendingHTLCRouting = PendingHTLCRouting.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, payment_data);
		CommonBase.add_ref_from(ret_hu_conv, payment_metadata);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_receive_keysend(payment_data: FinalOnionHopData, payment_preimage: Uint8Array, payment_metadata: Option_CVec_u8ZZ, incoming_cltv_expiry: number, custom_tlvs: TwoTuple_u64CVec_u8ZZ[]): PendingHTLCRouting {
		const ret: bigint = bindings.PendingHTLCRouting_receive_keysend(payment_data == null ? 0n : CommonBase.get_ptr_of(payment_data), bindings.encodeUint8Array(bindings.check_arr_len(payment_preimage, 32)), CommonBase.get_ptr_of(payment_metadata), incoming_cltv_expiry, bindings.encodeUint64Array(custom_tlvs.map(custom_tlvs_conv_23 => custom_tlvs_conv_23 != null ? CommonBase.get_ptr_of(custom_tlvs_conv_23) : 0n)));
		const ret_hu_conv: PendingHTLCRouting = PendingHTLCRouting.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, payment_data);
		CommonBase.add_ref_from(ret_hu_conv, payment_metadata);

...
export interface WriteableEcdsaChannelSignerInterface {
	/**Serialize the object into a byte array
	 */
	write(): Uint8Array;
}

class LDKWriteableEcdsaChannelSignerHolder {
	held: WriteableEcdsaChannelSigner|null = null;
}
 ...
 */
export class WriteableEcdsaChannelSigner extends CommonBase {
	/* @internal */
	public bindings_instance: bindings.LDKWriteableEcdsaChannelSigner|null;
	...
	constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.WriteableEcdsaChannelSigner_free);
		this.bindings_instance = null;
	}

	/** Creates a new instance of WriteableEcdsaChannelSigner from a given implementation */
	public static new_impl(arg: WriteableEcdsaChannelSignerInterface, ecdsaChannelSigner_impl: EcdsaChannelSignerInterface, channelSigner_impl: ChannelSignerInterface, pubkeys: ChannelPublicKeys): WriteableEcdsaChannelSigner {
		const impl_holder: LDKWriteableEcdsaChannelSignerHolder = new LDKWriteableEcdsaChannelSignerHolder();
		...
		} as bindings.LDKWriteableEcdsaChannelSigner;
		const ecdsaChannelSigner = EcdsaChannelSigner.new_impl(ecdsaChannelSigner_impl, channelSigner_impl, pubkeys, );
		const channelSigner = ChannelSigner.new_impl(channelSigner_impl, pubkeys, );
		const ptr_idx: [bigint, number] = bindings.LDKWriteableEcdsaChannelSigner_new(structImplementation, ecdsaChannelSigner.instance_idx!, channelSigner.instance_idx!, pubkeys == null ? 0n : pubkeys.clone_ptr());

		impl_holder.held = new WriteableEcdsaChannelSigner(null, ptr_idx[0]);
		impl_holder.held.instance_idx = ptr_idx[1];
		impl_holder.held.bindings_instance = structImplementation;
		impl_holder.held.ptrs_to.push(ecdsaChannelSigner);
	...
	public write(): Uint8Array {
		const ret: number = bindings.WriteableEcdsaChannelSigner_write(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.WriteableEcdsaChannelSigner_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): WriteableEcdsaChannelSigner {
		const ret: bigint = bindings.WriteableEcdsaChannelSigner_clone(this.ptr);

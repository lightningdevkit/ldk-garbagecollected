...
export class RawBolt11Invoice extends CommonBase {
	...
	public set_data(val: RawDataPart): void {
		bindings.RawBolt11Invoice_set_data(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public eq(b: RawBolt11Invoice): boolean {
		const ret: boolean = bindings.RawBolt11Invoice_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public payment_secret(): Option_PaymentSecretZ {

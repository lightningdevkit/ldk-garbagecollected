...
export class Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ {
	 ...
	 */
	public static constructor_ok(o: TwoTuple_BlindedPayInfoBlindedPathZ[]): Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ {
		const ret: bigint = bindings.CResult_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ_ok(bindings.encodeUint64Array(o.map(o_conv_37 => o_conv_37 != null ? CommonBase.get_ptr_of(o_conv_37) : 0n)));
	 ...
	 */
	public static constructor_err(): Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ {
		const ret: bigint = bindings.CResult_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ_err();
		const ret_hu_conv: Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ = Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ {
		const ret: bigint = bindings.CResult_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ_clone(this.ptr);
		const ret_hu_conv: Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ = Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ_OK extends Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ {
	public res: TwoTuple_BlindedPayInfoBlindedPathZ[];

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ_get_ok(ptr);
		const res_conv_37_len: number = bindings.getArrayLength(res);
		const res_conv_37_arr: TwoTuple_BlindedPayInfoBlindedPathZ[] = new Array(res_conv_37_len).fill(null);
		for (var l = 0; l < res_conv_37_len; l++) {
			const res_conv_37: bigint = bindings.getU64ArrayElem(res, l);
			const res_conv_37_hu_conv: TwoTuple_BlindedPayInfoBlindedPathZ = new TwoTuple_BlindedPayInfoBlindedPathZ(null, res_conv_37);
			CommonBase.add_ref_from(res_conv_37_hu_conv, this);
...
export class Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ_Err extends Result_CVec_C2Tuple_BlindedPayInfoBlindedPathZZNoneZ {

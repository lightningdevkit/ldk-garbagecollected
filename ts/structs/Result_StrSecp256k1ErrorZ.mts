...
export class Result_StrSecp256k1ErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_StrSecp256k1ErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_StrSecp256k1ErrorZ {
	 ...
	 */
	public static constructor_ok(o: string): Result_StrSecp256k1ErrorZ {
		const ret: bigint = bindings.CResult_StrSecp256k1ErrorZ_ok(bindings.encodeString(o));
	 ...
	 */
	public static constructor_err(e: Secp256k1Error): Result_StrSecp256k1ErrorZ {
		const ret: bigint = bindings.CResult_StrSecp256k1ErrorZ_err(e);
		const ret_hu_conv: Result_StrSecp256k1ErrorZ = Result_StrSecp256k1ErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_StrSecp256k1ErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_StrSecp256k1ErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_StrSecp256k1ErrorZ {
		const ret: bigint = bindings.CResult_StrSecp256k1ErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_StrSecp256k1ErrorZ = Result_StrSecp256k1ErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_StrSecp256k1ErrorZ_OK extends Result_StrSecp256k1ErrorZ {
	public res: string;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_StrSecp256k1ErrorZ_get_ok(ptr);
		const res_conv: string = bindings.decodeString(res);
		this.res = res_conv;
	}
}
export class Result_StrSecp256k1ErrorZ_Err extends Result_StrSecp256k1ErrorZ {

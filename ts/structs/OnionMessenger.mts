...
export class OnionMessenger extends CommonBase {
	 ...
	 */
	public send_onion_message(contents: OnionMessageContents, destination: Destination, reply_path: BlindedPath|null): Result_SendSuccessSendErrorZ {
		const ret: bigint = bindings.OnionMessenger_send_onion_message(this.ptr, CommonBase.get_ptr_of(contents), CommonBase.get_ptr_of(destination), reply_path == null ? 0n : CommonBase.get_ptr_of(reply_path));
		...
		CommonBase.add_ref_from(this, destination);

...
export class OnionMessenger extends CommonBase {
	 ...
	 */
	public static constructor_new(entropy_source: EntropySource, node_signer: NodeSigner, logger: Logger, message_router: MessageRouter, offers_handler: OffersMessageHandler, custom_handler: CustomOnionMessageHandler): OnionMessenger {
		const ret: bigint = bindings.OnionMessenger_new(CommonBase.get_ptr_of(entropy_source), CommonBase.get_ptr_of(node_signer), CommonBase.get_ptr_of(logger), CommonBase.get_ptr_of(message_router), CommonBase.get_ptr_of(offers_handler), CommonBase.get_ptr_of(custom_handler));
	 ...
	 */
	public send_onion_message(path: OnionMessagePath, message: OnionMessageContents, reply_path: BlindedPath|null): Result_NoneSendErrorZ {
		const ret: bigint = bindings.OnionMessenger_send_onion_message(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path), CommonBase.get_ptr_of(message), reply_path == null ? 0n : CommonBase.get_ptr_of(reply_path));
	 ...
	 */
	public as_OnionMessageProvider(): OnionMessageProvider {
		const ret: bigint = bindings.OnionMessenger_as_OnionMessageProvider(this.ptr);
		const ret_hu_conv: OnionMessageProvider = new OnionMessageProvider(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}

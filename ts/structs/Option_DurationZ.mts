 ...
 */
export class Option_DurationZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_DurationZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_DurationZ {
		const raw_ty: number = bindings.LDKCOption_DurationZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: bigint): Option_DurationZ {
		const ret: bigint = bindings.COption_DurationZ_some(o);
	 ...
	 */
	public static constructor_none(): Option_DurationZ {
		const ret: bigint = bindings.COption_DurationZ_none();
		const ret_hu_conv: Option_DurationZ = Option_DurationZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_DurationZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_DurationZ {
		const ret: bigint = bindings.COption_DurationZ_clone(this.ptr);
		const ret_hu_conv: Option_DurationZ = Option_DurationZ.constr_from_ptr(ret);
...
export class Option_DurationZ_Some extends Option_DurationZ {
	public some: bigint;
	/* @internal */
...
export class Option_DurationZ_None extends Option_DurationZ {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}

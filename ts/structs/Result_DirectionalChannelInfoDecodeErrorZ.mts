...
export class Result_DirectionalChannelInfoDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: object, ptr: number) {
		super(ptr, bindings.CResult_DirectionalChannelInfoDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: number): Result_DirectionalChannelInfoDecodeErrorZ {
	...
	public clone_ptr(): number {
		const ret: number = bindings.CResult_DirectionalChannelInfoDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
...
export class Result_DirectionalChannelInfoDecodeErrorZ_OK extends Result_DirectionalChannelInfoDecodeErrorZ {
	public res: DirectionalChannelInfo;

	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_DirectionalChannelInfoDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: DirectionalChannelInfo = new DirectionalChannelInfo(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_DirectionalChannelInfoDecodeErrorZ_Err extends Result_DirectionalChannelInfoDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const err: number = bindings.CResult_DirectionalChannelInfoDecodeErrorZ_get_err(ptr);

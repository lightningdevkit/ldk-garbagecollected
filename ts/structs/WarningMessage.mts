...
export class WarningMessage extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.WarningMessage_get_channel_id(this.ptr);
	...
	public eq(b: WarningMessage): boolean {
		const ret: boolean = bindings.WarningMessage_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

...
export class MonitorUpdatingPersister extends CommonBase {
	 ...
	 */
	public static constructor_new(kv_store: KVStoreSync, logger: Logger, maximum_pending_updates: bigint, entropy_source: EntropySource, signer_provider: SignerProvider, broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator): MonitorUpdatingPersister {
		const ret: bigint = bindings.MonitorUpdatingPersister_new(CommonBase.get_ptr_of(kv_store), CommonBase.get_ptr_of(logger), maximum_pending_updates, CommonBase.get_ptr_of(entropy_source), CommonBase.get_ptr_of(signer_provider), CommonBase.get_ptr_of(broadcaster), CommonBase.get_ptr_of(fee_estimator));
	 ...
	 */
	public read_all_channel_monitors_with_updates(): Result_CVec_C2Tuple_ThirtyTwoBytesChannelMonitorZZIOErrorZ {
		const ret: bigint = bindings.MonitorUpdatingPersister_read_all_channel_monitors_with_updates(this.ptr);
	 ...
	 */
	public read_channel_monitor_with_updates(monitor_key: string): Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ {
		const ret: bigint = bindings.MonitorUpdatingPersister_read_channel_monitor_with_updates(this.ptr, bindings.encodeString(monitor_key));

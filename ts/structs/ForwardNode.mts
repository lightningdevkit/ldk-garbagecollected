 ...
 */
export class ForwardNode extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.ForwardNode_free);
	}
	...
	public get_tlvs(): ForwardTlvs {
		const ret: bigint = bindings.ForwardNode_get_tlvs(this.ptr);
	...
	public set_tlvs(val: ForwardTlvs): void {
		bindings.ForwardNode_set_tlvs(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public get_node_id(): Uint8Array {
		const ret: number = bindings.ForwardNode_get_node_id(this.ptr);
	...
	public set_node_id(val: Uint8Array): void {
		bindings.ForwardNode_set_node_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 33)));
	}
	...
	public get_htlc_maximum_msat(): bigint {
		const ret: bigint = bindings.ForwardNode_get_htlc_maximum_msat(this.ptr);
		return ret;
	}
	 ...
	 */
	public static constructor_new(tlvs_arg: ForwardTlvs, node_id_arg: Uint8Array, htlc_maximum_msat_arg: bigint): ForwardNode {
		const ret: bigint = bindings.ForwardNode_new(tlvs_arg == null ? 0n : CommonBase.get_ptr_of(tlvs_arg), bindings.encodeUint8Array(bindings.check_arr_len(node_id_arg, 33)), htlc_maximum_msat_arg);
		const ret_hu_conv: ForwardNode = new ForwardNode(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, tlvs_arg);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.ForwardNode_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): ForwardNode {
		const ret: bigint = bindings.ForwardNode_clone(this.ptr);
		const ret_hu_conv: ForwardNode = new ForwardNode(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}

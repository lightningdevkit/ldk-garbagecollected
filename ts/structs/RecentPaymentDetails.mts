...
export class RecentPaymentDetails extends CommonBase {
	 ...
	 */
	public static constructor_fulfilled(payment_hash: Option_PaymentHashZ): RecentPaymentDetails {
		const ret: bigint = bindings.RecentPaymentDetails_fulfilled(CommonBase.get_ptr_of(payment_hash));
		const ret_hu_conv: RecentPaymentDetails = RecentPaymentDetails.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);

...
export class RecentPaymentDetails extends CommonBase {
	...
	public static constructor_awaiting_invoice(payment_id: Uint8Array): RecentPaymentDetails {
		const ret: bigint = bindings.RecentPaymentDetails_awaiting_invoice(bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)));
		const ret_hu_conv: RecentPaymentDetails = RecentPaymentDetails.constr_from_ptr(ret);
	...
	public static constructor_pending(payment_id: Uint8Array, payment_hash: Uint8Array, total_msat: bigint): RecentPaymentDetails {
		const ret: bigint = bindings.RecentPaymentDetails_pending(bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)), bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)), total_msat);
		const ret_hu_conv: RecentPaymentDetails = RecentPaymentDetails.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public static constructor_fulfilled(payment_id: Uint8Array, payment_hash: Option_ThirtyTwoBytesZ): RecentPaymentDetails {
		const ret: bigint = bindings.RecentPaymentDetails_fulfilled(bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)), CommonBase.get_ptr_of(payment_hash));
		const ret_hu_conv: RecentPaymentDetails = RecentPaymentDetails.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
	...
	public static constructor_abandoned(payment_id: Uint8Array, payment_hash: Uint8Array): RecentPaymentDetails {
		const ret: bigint = bindings.RecentPaymentDetails_abandoned(bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)), bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)));
		const ret_hu_conv: RecentPaymentDetails = RecentPaymentDetails.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

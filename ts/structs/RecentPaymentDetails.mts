...
export class RecentPaymentDetails extends CommonBase {
	 ...
	 */
	public static constructor_pending(payment_hash: Uint8Array, total_msat: bigint): RecentPaymentDetails {
		const ret: bigint = bindings.RecentPaymentDetails_pending(bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)), total_msat);
		const ret_hu_conv: RecentPaymentDetails = RecentPaymentDetails.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_fulfilled(payment_hash: Uint8Array): RecentPaymentDetails {
		const ret: bigint = bindings.RecentPaymentDetails_fulfilled(bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)));
		const ret_hu_conv: RecentPaymentDetails = RecentPaymentDetails.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_abandoned(payment_hash: Uint8Array): RecentPaymentDetails {
		const ret: bigint = bindings.RecentPaymentDetails_abandoned(bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)));
		const ret_hu_conv: RecentPaymentDetails = RecentPaymentDetails.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
...
export class RecentPaymentDetails_Fulfilled extends RecentPaymentDetails {
	...
	public constructor(ptr: bigint) {
		super(null, ptr);
		const payment_hash: number = bindings.LDKRecentPaymentDetails_Fulfilled_get_payment_hash(ptr);
		const payment_hash_conv: Uint8Array = bindings.decodeUint8Array(payment_hash);
		this.payment_hash = payment_hash_conv;
	}
}

...
export interface ChannelMessageHandlerInterface {
	 ...
	 * connecting to peers.
	 */
	get_genesis_hashes(): Option_CVec_ChainHashZZ;
}
...
export class ChannelMessageHandler extends CommonBase {
	...
	public static new_impl(arg: ChannelMessageHandlerInterface, messageSendEventsProvider_impl: MessageSendEventsProviderInterface): ChannelMessageHandler {
		...
		let structImplementation = {
			...
			get_genesis_hashes (): bigint {
				const ret: Option_CVec_ChainHashZZ = arg.get_genesis_hashes();
				const result: bigint = ret == null ? 0n : ret.clone_ptr();
	...
	public handle_open_channel_v2(their_node_id: Uint8Array, msg: OpenChannelV2): void {
		bindings.ChannelMessageHandler_handle_open_channel_v2(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(their_node_id, 33)), msg == null ? 0n : CommonBase.get_ptr_of(msg));
		CommonBase.add_ref_from(this, msg);
	}
	...
	public handle_accept_channel_v2(their_node_id: Uint8Array, msg: AcceptChannelV2): void {
		bindings.ChannelMessageHandler_handle_accept_channel_v2(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(their_node_id, 33)), msg == null ? 0n : CommonBase.get_ptr_of(msg));
		CommonBase.add_ref_from(this, msg);
	}
	 ...
	 * connecting to peers.
	 */
	public get_genesis_hashes(): Option_CVec_ChainHashZZ {
		const ret: bigint = bindings.ChannelMessageHandler_get_genesis_hashes(this.ptr);

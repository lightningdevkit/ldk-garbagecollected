...
export class Destination extends CommonBase {
	protected constructor(_dummy: object, ptr: bigint) { super(ptr, bindings.Destination_free); }
	/* @internal */
	...
	public static constructor_node(a: Uint8Array): Destination {
		const ret: bigint = bindings.Destination_node(bindings.encodeUint8Array(bindings.check_arr_len(a, 33)));
	 ...
	 */
	public static constructor_blinded_route(a: BlindedRoute): Destination {
		const ret: bigint = bindings.Destination_blinded_route(a == null ? 0n : CommonBase.get_ptr_of(a));
		const ret_hu_conv: Destination = Destination.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
...
export class Destination_BlindedRoute extends Destination {
	public blinded_route: BlindedRoute;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const blinded_route: bigint = bindings.LDKDestination_BlindedRoute_get_blinded_route(ptr);
		const blinded_route_hu_conv: BlindedRoute = new BlindedRoute(null, blinded_route);

...
export class RoutingMessageHandler extends CommonBase {
	...
	public static new_impl(arg: RoutingMessageHandlerInterface, messageSendEventsProvider_impl: MessageSendEventsProviderInterface): RoutingMessageHandler {
		...
		let structImplementation = {
			...
			peer_connected (their_node_id: number, init: bigint, inbound: boolean): bigint {
				...
				const ret: Result_NoneNoneZ = arg.peer_connected(their_node_id_conv, init_hu_conv, inbound);
				const result: bigint = ret == null ? 0n : ret.clone_ptr();
				return result;
			},
	...
	public get_next_node_announcement(starting_point: NodeId|null): NodeAnnouncement {
		...
		CommonBase.add_ref_from(ret_hu_conv, this);
		CommonBase.add_ref_from(this, starting_point);
		return ret_hu_conv;
	}
	 ...
	 * message handlers may still wish to communicate with this peer.
	 */
	public peer_connected(their_node_id: Uint8Array, init: Init, inbound: boolean): Result_NoneNoneZ {
		const ret: bigint = bindings.RoutingMessageHandler_peer_connected(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(their_node_id, 33)), init == null ? 0n : CommonBase.get_ptr_of(init), inbound);
	...
	public provided_node_features(): NodeFeatures {
		const ret: bigint = bindings.RoutingMessageHandler_provided_node_features(this.ptr);
	...
	public provided_init_features(their_node_id: Uint8Array): InitFeatures {
		const ret: bigint = bindings.RoutingMessageHandler_provided_init_features(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(their_node_id, 33)));

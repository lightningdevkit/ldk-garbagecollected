...
export class Result_PendingHTLCInfoInboundHTLCErrZ extends CommonBase {
	...
	public static constructor_ok(o: PendingHTLCInfo): Result_PendingHTLCInfoInboundHTLCErrZ {
		const ret: bigint = bindings.CResult_PendingHTLCInfoInboundHTLCErrZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_err(e_err_code_arg: number, e_err_data_arg: Uint8Array, e_msg_arg: string): Result_PendingHTLCInfoInboundHTLCErrZ {
		const ret: bigint = bindings.CResult_PendingHTLCInfoInboundHTLCErrZ_err(bindings.InboundHTLCErr_new(e_err_code_arg, bindings.encodeUint8Array(e_err_data_arg), bindings.encodeString(e_msg_arg)));
		const ret_hu_conv: Result_PendingHTLCInfoInboundHTLCErrZ = Result_PendingHTLCInfoInboundHTLCErrZ.constr_from_ptr(ret);
		;
		;
		return ret_hu_conv;

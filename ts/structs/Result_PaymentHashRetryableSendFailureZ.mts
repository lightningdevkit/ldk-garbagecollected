...
export class Result_PaymentHashRetryableSendFailureZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_PaymentHashRetryableSendFailureZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_PaymentHashRetryableSendFailureZ {
	 ...
	 */
	public static constructor_ok(o: Uint8Array): Result_PaymentHashRetryableSendFailureZ {
		const ret: bigint = bindings.CResult_PaymentHashRetryableSendFailureZ_ok(bindings.encodeUint8Array(bindings.check_arr_len(o, 32)));
	 ...
	 */
	public static constructor_err(e: RetryableSendFailure): Result_PaymentHashRetryableSendFailureZ {
		const ret: bigint = bindings.CResult_PaymentHashRetryableSendFailureZ_err(e);
		const ret_hu_conv: Result_PaymentHashRetryableSendFailureZ = Result_PaymentHashRetryableSendFailureZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_PaymentHashRetryableSendFailureZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_PaymentHashRetryableSendFailureZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_PaymentHashRetryableSendFailureZ {
		const ret: bigint = bindings.CResult_PaymentHashRetryableSendFailureZ_clone(this.ptr);
		const ret_hu_conv: Result_PaymentHashRetryableSendFailureZ = Result_PaymentHashRetryableSendFailureZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_PaymentHashRetryableSendFailureZ_OK extends Result_PaymentHashRetryableSendFailureZ {
	public res: Uint8Array;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_PaymentHashRetryableSendFailureZ_get_ok(ptr);
		const res_conv: Uint8Array = bindings.decodeUint8Array(res);
		this.res = res_conv;
	}
}
export class Result_PaymentHashRetryableSendFailureZ_Err extends Result_PaymentHashRetryableSendFailureZ {

...
export class PaymentPurpose extends CommonBase {
	 ...
	 */
	public static constructor_invoice_payment(payment_preimage: Option_PaymentPreimageZ, payment_secret: Uint8Array): PaymentPurpose {
		const ret: bigint = bindings.PaymentPurpose_invoice_payment(CommonBase.get_ptr_of(payment_preimage), bindings.encodeUint8Array(bindings.check_arr_len(payment_secret, 32)));
		const ret_hu_conv: PaymentPurpose = PaymentPurpose.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, payment_preimage);
		return ret_hu_conv;
	}
	...
	public eq(b: PaymentPurpose): boolean {
		const ret: boolean = bindings.PaymentPurpose_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}
...
export class PaymentPurpose_InvoicePayment extends PaymentPurpose {
	 ...
	 */
	public payment_preimage: Option_PaymentPreimageZ;
	/**
	...
	public constructor(ptr: bigint) {
		super(null, ptr);
		const payment_preimage: bigint = bindings.LDKPaymentPurpose_InvoicePayment_get_payment_preimage(ptr);
		const payment_preimage_hu_conv: Option_PaymentPreimageZ = Option_PaymentPreimageZ.constr_from_ptr(payment_preimage);

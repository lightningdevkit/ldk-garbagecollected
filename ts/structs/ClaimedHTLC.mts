...
export class ClaimedHTLC extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.ClaimedHTLC_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.ClaimedHTLC_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, user_channel_id_arg: bigint, cltv_expiry_arg: number, value_msat_arg: bigint, counterparty_skimmed_fee_msat_arg: bigint): ClaimedHTLC {
		const ret: bigint = bindings.ClaimedHTLC_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), bindings.encodeUint128(user_channel_id_arg), cltv_expiry_arg, value_msat_arg, counterparty_skimmed_fee_msat_arg);
	...
	public eq(b: ClaimedHTLC): boolean {
		const ret: boolean = bindings.ClaimedHTLC_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

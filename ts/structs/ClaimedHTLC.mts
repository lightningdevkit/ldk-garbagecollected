...
export class ClaimedHTLC extends CommonBase {
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, user_channel_id_arg: bigint, cltv_expiry_arg: number, value_msat_arg: bigint): ClaimedHTLC {
		const ret: bigint = bindings.ClaimedHTLC_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), bindings.encodeUint128(user_channel_id_arg), cltv_expiry_arg, value_msat_arg);

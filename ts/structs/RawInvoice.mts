...
export class RawInvoice extends CommonBase {
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.RawInvoice_hash(this.ptr);
		return ret;
	}
	...
	public signable_hash(): Uint8Array {
		const ret: number = bindings.RawInvoice_signable_hash(this.ptr);
	...
	public min_final_cltv_expiry_delta(): MinFinalCltvExpiryDelta {
		const ret: bigint = bindings.RawInvoice_min_final_cltv_expiry_delta(this.ptr);
	...
	public payment_secret(): Uint8Array {
		const ret: number = bindings.RawInvoice_payment_secret(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}

	public payment_metadata(): Option_CVec_u8ZZ {
		const ret: bigint = bindings.RawInvoice_payment_metadata(this.ptr);
	...
	public private_routes(): PrivateRoute[] {
		const ret: number = bindings.RawInvoice_private_routes(this.ptr);
	...
	public currency(): Currency {
		const ret: Currency = bindings.RawInvoice_currency(this.ptr);
		return ret;
	}

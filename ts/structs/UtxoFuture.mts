...
export class UtxoFuture extends CommonBase {
	...
	public resolve_without_forwarding(graph: NetworkGraph, result: Result_TxOutUtxoLookupErrorZ): void {
		bindings.UtxoFuture_resolve_without_forwarding(this.ptr, graph == null ? 0n : CommonBase.get_ptr_of(graph), result != null ? CommonBase.get_ptr_of(result) : 0n);
	...
	public resolve(graph: NetworkGraph, gossip: P2PGossipSync, result: Result_TxOutUtxoLookupErrorZ): void {
		bindings.UtxoFuture_resolve(this.ptr, graph == null ? 0n : CommonBase.get_ptr_of(graph), gossip == null ? 0n : CommonBase.get_ptr_of(gossip), result != null ? CommonBase.get_ptr_of(result) : 0n);
		CommonBase.add_ref_from(this, graph);

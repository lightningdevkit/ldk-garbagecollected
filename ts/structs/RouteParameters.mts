...
export class RouteParameters extends CommonBase {
	 ...
	 */
	public static constructor_new(payment_params_arg: PaymentParameters, final_value_msat_arg: bigint): RouteParameters {
		const ret: bigint = bindings.RouteParameters_new(payment_params_arg == null ? 0n : CommonBase.get_ptr_of(payment_params_arg), final_value_msat_arg);

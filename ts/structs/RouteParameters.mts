...
export class RouteParameters extends CommonBase {
	...
	public static constructor_new(payment_params_arg: PaymentParameters, final_value_msat_arg: bigint, max_total_routing_fee_msat_arg: Option_u64Z): RouteParameters {
		const ret: bigint = bindings.RouteParameters_new(payment_params_arg == null ? 0n : CommonBase.get_ptr_of(payment_params_arg), final_value_msat_arg, CommonBase.get_ptr_of(max_total_routing_fee_msat_arg));
		...
		CommonBase.add_ref_from(ret_hu_conv, max_total_routing_fee_msat_arg);
		return ret_hu_conv;
	}
	...
	public eq(b: RouteParameters): boolean {
		const ret: boolean = bindings.RouteParameters_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public static constructor_from_payment_params_and_value(payment_params: PaymentParameters, final_value_msat: bigint): RouteParameters {
		const ret: bigint = bindings.RouteParameters_from_payment_params_and_value(payment_params == null ? 0n : CommonBase.get_ptr_of(payment_params), final_value_msat);
		const ret_hu_conv: RouteParameters = new RouteParameters(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, payment_params);
		return ret_hu_conv;
	}

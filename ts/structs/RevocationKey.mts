...
export class RevocationKey extends CommonBase {
	...
	public static constructor_new(a_arg: Uint8Array): RevocationKey {
		const ret: bigint = bindings.RevocationKey_new(bindings.encodeUint8Array(bindings.check_arr_len(a_arg, 33)));
	...
	public eq(b: RevocationKey): boolean {
		const ret: boolean = bindings.RevocationKey_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public static constructor_from_basepoint(countersignatory_basepoint: RevocationBasepoint, per_commitment_point: Uint8Array): RevocationKey {
		const ret: bigint = bindings.RevocationKey_from_basepoint(countersignatory_basepoint == null ? 0n : CommonBase.get_ptr_of(countersignatory_basepoint), bindings.encodeUint8Array(bindings.check_arr_len(per_commitment_point, 33)));
		const ret_hu_conv: RevocationKey = new RevocationKey(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);

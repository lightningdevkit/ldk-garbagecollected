...
export class InvoiceWithDerivedSigningPubkeyBuilder extends CommonBase {
	 ...
	 */
	public build_and_sign(): Result_Bolt12InvoiceBolt12SemanticErrorZ {
		const ret: bigint = bindings.InvoiceWithDerivedSigningPubkeyBuilder_build_and_sign(this.ptr);
	...
	public fallback_v0_p2wsh(script_hash: Uint8Array): void {
		bindings.InvoiceWithDerivedSigningPubkeyBuilder_fallback_v0_p2wsh(this.ptr, bindings.encodeUint8Array(script_hash));
	}
	...
	public fallback_v0_p2wpkh(pubkey_hash: Uint8Array): void {
		bindings.InvoiceWithDerivedSigningPubkeyBuilder_fallback_v0_p2wpkh(this.ptr, bindings.encodeUint8Array(pubkey_hash));
	}
	...
	public fallback_v1_p2tr_tweaked(utput_key: Uint8Array): void {
		bindings.InvoiceWithDerivedSigningPubkeyBuilder_fallback_v1_p2tr_tweaked(this.ptr, bindings.encodeUint8Array(utput_key));
	}

...
export class Packet extends CommonBase {
	...
	public static constructor_new(version_arg: number, public_key_arg: Uint8Array, hop_data_arg: Uint8Array, hmac_arg: Uint8Array): Packet {
		const ret: bigint = bindings.Packet_new(version_arg, bindings.encodeUint8Array(bindings.check_arr_len(public_key_arg, 33)), bindings.encodeUint8Array(hop_data_arg), bindings.encodeUint8Array(bindings.check_arr_len(hmac_arg, 32)));
	...
	public eq(b: Packet): boolean {
		const ret: boolean = bindings.Packet_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

...
export class ChannelPublicKeys extends CommonBase {
	...
	public set_revocation_basepoint(val: RevocationBasepoint): void {
		bindings.ChannelPublicKeys_set_revocation_basepoint(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public set_delayed_payment_basepoint(val: DelayedPaymentBasepoint): void {
		bindings.ChannelPublicKeys_set_delayed_payment_basepoint(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public set_htlc_basepoint(val: HtlcBasepoint): void {
		bindings.ChannelPublicKeys_set_htlc_basepoint(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public static constructor_new(funding_pubkey_arg: Uint8Array, revocation_basepoint_arg: RevocationBasepoint, payment_point_arg: Uint8Array, delayed_payment_basepoint_arg: DelayedPaymentBasepoint, htlc_basepoint_arg: HtlcBasepoint): ChannelPublicKeys {
		const ret: bigint = bindings.ChannelPublicKeys_new(bindings.encodeUint8Array(bindings.check_arr_len(funding_pubkey_arg, 33)), revocation_basepoint_arg == null ? 0n : CommonBase.get_ptr_of(revocation_basepoint_arg), bindings.encodeUint8Array(bindings.check_arr_len(payment_point_arg, 33)), delayed_payment_basepoint_arg == null ? 0n : CommonBase.get_ptr_of(delayed_payment_basepoint_arg), htlc_basepoint_arg == null ? 0n : CommonBase.get_ptr_of(htlc_basepoint_arg));
		const ret_hu_conv: ChannelPublicKeys = new ChannelPublicKeys(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, revocation_basepoint_arg);
		CommonBase.add_ref_from(ret_hu_conv, delayed_payment_basepoint_arg);
		CommonBase.add_ref_from(ret_hu_conv, htlc_basepoint_arg);
		return ret_hu_conv;
	}
	...
	public eq(b: ChannelPublicKeys): boolean {
		const ret: boolean = bindings.ChannelPublicKeys_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

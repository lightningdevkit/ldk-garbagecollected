...
export class Result_PayeePubKeyErrorZ extends CommonBase {
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_PayeePubKeyErrorZ_is_ok(this.ptr);
		return ret;
	}
...
export class Result_PayeePubKeyErrorZ_OK extends Result_PayeePubKeyErrorZ {
...
export class Result_PayeePubKeyErrorZ_Err extends Result_PayeePubKeyErrorZ {

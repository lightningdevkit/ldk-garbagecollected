...
export class Route extends CommonBase {
	...
	public set_paths(val: Path[]): void {
		bindings.Route_set_paths(this.ptr, bindings.encodeUint64Array(val.map(val_conv_6 => val_conv_6 == null ? 0n : CommonBase.get_ptr_of(val_conv_6))));
	...
	public static constructor_new(paths_arg: Path[], route_params_arg: RouteParameters|null): Route {
		const ret: bigint = bindings.Route_new(bindings.encodeUint64Array(paths_arg.map(paths_arg_conv_6 => paths_arg_conv_6 == null ? 0n : CommonBase.get_ptr_of(paths_arg_conv_6))), route_params_arg == null ? 0n : CommonBase.get_ptr_of(route_params_arg));
		...
		CommonBase.add_ref_from(ret_hu_conv, route_params_arg);
		return ret_hu_conv;
	}

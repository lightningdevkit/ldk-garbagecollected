...
export class HTLCDestination extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.HTLCDestination_free); }
	/* @internal */
	 ...
	 */
	public static constructor_invalid_forward(requested_forward_scid: bigint): HTLCDestination {
		const ret: bigint = bindings.HTLCDestination_invalid_forward(requested_forward_scid);
		const ret_hu_conv: HTLCDestination = HTLCDestination.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: HTLCDestination): boolean {
		const ret: boolean = bindings.HTLCDestination_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}
	...
	public write(): Uint8Array {
		const ret: number = bindings.HTLCDestination_write(this.ptr);
...
export class HTLCDestination_NextHopChannel extends HTLCDestination {
	...
	public constructor(ptr: bigint) {
		...
		const channel_id: number = bindings.LDKHTLCDestination_NextHopChannel_get_channel_id(ptr);

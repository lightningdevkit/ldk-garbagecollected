...
export class Result_NodeAnnouncementDecodeErrorZ extends CommonBase {
	...
	public static constructor_ok(o: NodeAnnouncement): Result_NodeAnnouncementDecodeErrorZ {
		const ret: bigint = bindings.CResult_NodeAnnouncementDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
	...
	public static constructor_err(e: DecodeError): Result_NodeAnnouncementDecodeErrorZ {
		const ret: bigint = bindings.CResult_NodeAnnouncementDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_NodeAnnouncementDecodeErrorZ = Result_NodeAnnouncementDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_NodeAnnouncementDecodeErrorZ_OK extends Result_NodeAnnouncementDecodeErrorZ {
...
export class Result_NodeAnnouncementDecodeErrorZ_Err extends Result_NodeAnnouncementDecodeErrorZ {

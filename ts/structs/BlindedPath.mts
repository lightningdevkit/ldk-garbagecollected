...
export class BlindedPath extends CommonBase {
	 ...
	 */
	public static constructor_new(node_pks: Uint8Array[], keys_manager: KeysInterface): Result_BlindedPathNoneZ {
		const ret: bigint = bindings.BlindedPath_new(bindings.encodeUint32Array(node_pks != null ? node_pks.map(node_pks_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(node_pks_conv_12, 33))) : null), keys_manager == null ? 0n : CommonBase.get_ptr_of(keys_manager));

 ...
 */
export class BlindedPath extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.BlindedPath_free);
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.BlindedPath_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): BlindedPath {
		const ret: bigint = bindings.BlindedPath_clone(this.ptr);
		const ret_hu_conv: BlindedPath = new BlindedPath(null, ret);
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.BlindedPath_hash(this.ptr);
		return ret;
	}
	 ...
	 */
	public eq(b: BlindedPath): boolean {
		const ret: boolean = bindings.BlindedPath_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	 ...
	 */
	public static constructor_one_hop_for_message(recipient_node_id: Uint8Array, entropy_source: EntropySource): Result_BlindedPathNoneZ {
		const ret: bigint = bindings.BlindedPath_one_hop_for_message(bindings.encodeUint8Array(bindings.check_arr_len(recipient_node_id, 33)), CommonBase.get_ptr_of(entropy_source));
	...
	public static constructor_new_for_message(node_pks: Uint8Array[], entropy_source: EntropySource): Result_BlindedPathNoneZ {
		const ret: bigint = bindings.BlindedPath_new_for_message(bindings.encodeUint32Array(node_pks.map(node_pks_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(node_pks_conv_12, 33)))), CommonBase.get_ptr_of(entropy_source));
		const ret_hu_conv: Result_BlindedPathNoneZ = Result_BlindedPathNoneZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, entropy_source);
		return ret_hu_conv;
	}
	...
	public write(): Uint8Array {
		const ret: number = bindings.BlindedPath_write(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_BlindedPathDecodeErrorZ {
		const ret: bigint = bindings.BlindedPath_read(bindings.encodeUint8Array(ser));

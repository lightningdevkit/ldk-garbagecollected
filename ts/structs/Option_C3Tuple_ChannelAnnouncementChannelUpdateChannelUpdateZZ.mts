...
export class Option_C3Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZZ extends CommonBase {
	protected constructor(_dummy: object, ptr: bigint) { super(ptr, bindings.COption_C3Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZZ_free); }
	/* @internal */
	...
	public static constructor_some(o: ThreeTuple_ChannelAnnouncementChannelUpdateChannelUpdateZ): Option_C3Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZZ {
		const ret: bigint = bindings.COption_C3Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZZ_some(o != null ? CommonBase.get_ptr_of(o) : 0n);

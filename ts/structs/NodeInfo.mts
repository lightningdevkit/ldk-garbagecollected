...
export class NodeInfo extends CommonBase {
	 ...
	 */
	public set_announcement_info(val: NodeAnnouncementInfo|null): void {
	 ...
	 */
	public static constructor_new(channels_arg: bigint[], announcement_info_arg: NodeAnnouncementInfo|null): NodeInfo {
		const ret: bigint = bindings.NodeInfo_new(bindings.encodeUint64Array(channels_arg), announcement_info_arg == null ? 0n : CommonBase.get_ptr_of(announcement_info_arg));
	...
	public eq(b: NodeInfo): boolean {
		const ret: boolean = bindings.NodeInfo_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

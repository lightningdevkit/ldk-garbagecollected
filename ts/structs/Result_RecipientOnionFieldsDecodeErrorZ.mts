...
export class Result_RecipientOnionFieldsDecodeErrorZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_RecipientOnionFieldsDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: RecipientOnionFields): Result_RecipientOnionFieldsDecodeErrorZ {
		const ret: bigint = bindings.CResult_RecipientOnionFieldsDecodeErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_RecipientOnionFieldsDecodeErrorZ {
		const ret: bigint = bindings.CResult_RecipientOnionFieldsDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_RecipientOnionFieldsDecodeErrorZ = Result_RecipientOnionFieldsDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_RecipientOnionFieldsDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_RecipientOnionFieldsDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_RecipientOnionFieldsDecodeErrorZ {
		const ret: bigint = bindings.CResult_RecipientOnionFieldsDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_RecipientOnionFieldsDecodeErrorZ = Result_RecipientOnionFieldsDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_RecipientOnionFieldsDecodeErrorZ_OK extends Result_RecipientOnionFieldsDecodeErrorZ {
	...
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_RecipientOnionFieldsDecodeErrorZ_get_ok(ptr);
...
export class Result_RecipientOnionFieldsDecodeErrorZ_Err extends Result_RecipientOnionFieldsDecodeErrorZ {
	...
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_RecipientOnionFieldsDecodeErrorZ_get_err(ptr);

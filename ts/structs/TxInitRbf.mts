...
export class TxInitRbf extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.TxInitRbf_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.TxInitRbf_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	 ...
	 */
	public static constructor_new(channel_id_arg: Uint8Array, locktime_arg: number, feerate_sat_per_1000_weight_arg: number, funding_output_contribution_arg: Option_i64Z): TxInitRbf {
		const ret: bigint = bindings.TxInitRbf_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), locktime_arg, feerate_sat_per_1000_weight_arg, CommonBase.get_ptr_of(funding_output_contribution_arg));
		const ret_hu_conv: TxInitRbf = new TxInitRbf(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, funding_output_contribution_arg);
		return ret_hu_conv;
	}
	...
	public eq(b: TxInitRbf): boolean {
		const ret: boolean = bindings.TxInitRbf_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

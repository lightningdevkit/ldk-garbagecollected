...
export class Path extends CommonBase {
	...
	public set_hops(val: RouteHop[]): void {
		bindings.Path_set_hops(this.ptr, bindings.encodeUint64Array(val.map(val_conv_10 => val_conv_10 == null ? 0n : CommonBase.get_ptr_of(val_conv_10))));
	...
	public static constructor_new(hops_arg: RouteHop[], blinded_tail_arg: BlindedTail|null): Path {
		const ret: bigint = bindings.Path_new(bindings.encodeUint64Array(hops_arg.map(hops_arg_conv_10 => hops_arg_conv_10 == null ? 0n : CommonBase.get_ptr_of(hops_arg_conv_10))), blinded_tail_arg == null ? 0n : CommonBase.get_ptr_of(blinded_tail_arg));

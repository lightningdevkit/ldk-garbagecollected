 ...
 * A Tuple
 */
export class TwoTuple_PublicKeyCOption_SocketAddressZZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C2Tuple_PublicKeyCOption_SocketAddressZZ_free);
	}
	...
	public get_a(): Uint8Array {
		const ret: number = bindings.C2Tuple_PublicKeyCOption_SocketAddressZZ_get_a(this.ptr);
	 ...
	 * 
	 */
	public get_b(): Option_SocketAddressZ {
		const ret: bigint = bindings.C2Tuple_PublicKeyCOption_SocketAddressZZ_get_b(this.ptr);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.C2Tuple_PublicKeyCOption_SocketAddressZZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TwoTuple_PublicKeyCOption_SocketAddressZZ {
		const ret: bigint = bindings.C2Tuple_PublicKeyCOption_SocketAddressZZ_clone(this.ptr);
		const ret_hu_conv: TwoTuple_PublicKeyCOption_SocketAddressZZ = new TwoTuple_PublicKeyCOption_SocketAddressZZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(a: Uint8Array, b: Option_SocketAddressZ): TwoTuple_PublicKeyCOption_SocketAddressZZ {
		const ret: bigint = bindings.C2Tuple_PublicKeyCOption_SocketAddressZZ_new(bindings.encodeUint8Array(bindings.check_arr_len(a, 33)), CommonBase.get_ptr_of(b));
		const ret_hu_conv: TwoTuple_PublicKeyCOption_SocketAddressZZ = new TwoTuple_PublicKeyCOption_SocketAddressZZ(null, ret);

...
export class Result_ScorerDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: object, ptr: number) {
		super(ptr, bindings.CResult_ScorerDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: number): Result_ScorerDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o_params: ScoringParameters): Result_ScorerDecodeErrorZ {
		const ret: number = bindings.CResult_ScorerDecodeErrorZ_ok(bindings.Scorer_new(o_params == null ? 0 : CommonBase.get_ptr_of(o_params) & ~1));
		const ret_hu_conv: Result_ScorerDecodeErrorZ = Result_ScorerDecodeErrorZ.constr_from_ptr(ret);
		;
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_ScorerDecodeErrorZ {
		const ret: number = bindings.CResult_ScorerDecodeErrorZ_err(e == null ? 0 : CommonBase.get_ptr_of(e) & ~1);
		const ret_hu_conv: Result_ScorerDecodeErrorZ = Result_ScorerDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_ScorerDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

}
export class Result_ScorerDecodeErrorZ_OK extends Result_ScorerDecodeErrorZ {
	public res: Scorer;

	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_ScorerDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: Scorer = new Scorer(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_ScorerDecodeErrorZ_Err extends Result_ScorerDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const err: number = bindings.CResult_ScorerDecodeErrorZ_get_err(ptr);

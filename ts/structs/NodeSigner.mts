...
export interface NodeSignerInterface {
	 ...
	 */
	sign_gossip_message(msg: UnsignedGossipMessage): Result_SignatureNoneZ;
}
...
export class NodeSigner extends CommonBase {
	...
	public static new_impl(arg: NodeSignerInterface): NodeSigner {
		...
		let structImplementation = {
			...
			sign_gossip_message (msg: bigint): bigint {
				...
				const ret: Result_SignatureNoneZ = arg.sign_gossip_message(msg_hu_conv);
				const result: bigint = ret == null ? 0n : ret.clone_ptr();
				return result;
			},
	 ...
	 * corresponding channel.
	 */
	public sign_gossip_message(msg: UnsignedGossipMessage): Result_SignatureNoneZ {

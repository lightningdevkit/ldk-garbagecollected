...
export interface WatchInterface {
	 ...
	 */
	watch_channel(funding_txo: OutPoint, monitor: ChannelMonitor): Result_ChannelMonitorUpdateStatusNoneZ;
...
export class Watch extends CommonBase {
	...
	public static new_impl(arg: WatchInterface): Watch {
		...
		let structImplementation = {
			watch_channel (funding_txo: bigint, monitor: bigint): bigint {
				...
				const ret: Result_ChannelMonitorUpdateStatusNoneZ = arg.watch_channel(funding_txo_hu_conv, monitor_hu_conv);
	 ...
	 * [`block_disconnected`]: channelmonitor::ChannelMonitor::block_disconnected
	 */
	public watch_channel(funding_txo: OutPoint, monitor: ChannelMonitor): Result_ChannelMonitorUpdateStatusNoneZ {

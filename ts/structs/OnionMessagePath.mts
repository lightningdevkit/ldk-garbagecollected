...
export class OnionMessagePath extends CommonBase {
	...
	public set_intermediate_nodes(val: Uint8Array[]): void {
		bindings.OnionMessagePath_set_intermediate_nodes(this.ptr, bindings.encodeUint32Array(val != null ? val.map(val_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(val_conv_12, 33))) : null));
	}
	 ...
	 */
	public static constructor_new(intermediate_nodes_arg: Uint8Array[], destination_arg: Destination): OnionMessagePath {
		const ret: bigint = bindings.OnionMessagePath_new(bindings.encodeUint32Array(intermediate_nodes_arg != null ? intermediate_nodes_arg.map(intermediate_nodes_arg_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(intermediate_nodes_arg_conv_12, 33))) : null), CommonBase.get_ptr_of(destination_arg));

...
export class OnionMessagePath extends CommonBase {
	 ...
	 * Returns a copy of the field.
	 */
	public get_first_node_addresses(): Option_CVec_SocketAddressZZ {
		const ret: bigint = bindings.OnionMessagePath_get_first_node_addresses(this.ptr);
	 ...
	 * this to initiate such a connection.
	 */
	public set_first_node_addresses(val: Option_CVec_SocketAddressZZ): void {
	 ...
	 */
	public static constructor_new(intermediate_nodes_arg: Uint8Array[], destination_arg: Destination, first_node_addresses_arg: Option_CVec_SocketAddressZZ): OnionMessagePath {
		const ret: bigint = bindings.OnionMessagePath_new(bindings.encodeUint32Array(intermediate_nodes_arg.map(intermediate_nodes_arg_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(intermediate_nodes_arg_conv_12, 33)))), CommonBase.get_ptr_of(destination_arg), CommonBase.get_ptr_of(first_node_addresses_arg));
		const ret_hu_conv: OnionMessagePath = new OnionMessagePath(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, destination_arg);
		CommonBase.add_ref_from(ret_hu_conv, first_node_addresses_arg);
		return ret_hu_conv;
	}

...
export class ParseOrSemanticError extends CommonBase {
	...
	public eq(b: ParseOrSemanticError): boolean {
		const ret: boolean = bindings.ParseOrSemanticError_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}
...
export class ParseOrSemanticError_ParseError extends ParseOrSemanticError {
	...
	public constructor(ptr: bigint) {
		...
		const parse_error_hu_conv: Bolt11ParseError = Bolt11ParseError.constr_from_ptr(parse_error);

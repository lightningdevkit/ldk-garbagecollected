...
export class Payee extends CommonBase {
	 ...
	 */
	public static constructor_blinded(route_hints: TwoTuple_BlindedPayInfoBlindedPathZ[], features: Bolt12InvoiceFeatures): Payee {
		const ret: bigint = bindings.Payee_blinded(bindings.encodeUint64Array(route_hints != null ? route_hints.map(route_hints_conv_37 => route_hints_conv_37 != null ? CommonBase.get_ptr_of(route_hints_conv_37) : 0n) : null), features == null ? 0n : CommonBase.get_ptr_of(features));
		const ret_hu_conv: Payee = Payee.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, features);
		return ret_hu_conv;
	}
	...
	public static constructor_clear(node_id: Uint8Array, route_hints: RouteHint[], features: Bolt11InvoiceFeatures, final_cltv_expiry_delta: number): Payee {
		const ret: bigint = bindings.Payee_clear(bindings.encodeUint8Array(bindings.check_arr_len(node_id, 33)), bindings.encodeUint64Array(route_hints != null ? route_hints.map(route_hints_conv_11 => route_hints_conv_11 == null ? 0n : CommonBase.get_ptr_of(route_hints_conv_11)) : null), features == null ? 0n : CommonBase.get_ptr_of(features), final_cltv_expiry_delta);
		const ret_hu_conv: Payee = Payee.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		route_hints.forEach((route_hints_conv_11: RouteHint) => { CommonBase.add_ref_from(ret_hu_conv, route_hints_conv_11); });
		CommonBase.add_ref_from(ret_hu_conv, features);
		return ret_hu_conv;
	}
	...
	public eq(b: Payee): boolean {
		const ret: boolean = bindings.Payee_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}
...
export class Payee_Blinded extends Payee {
	 ...
	 * node id.
	 */
	public route_hints: TwoTuple_BlindedPayInfoBlindedPathZ[];
	/**
	...
	public constructor(ptr: bigint) {
		...
		const route_hints_conv_37_len: number = bindings.getArrayLength(route_hints);
			const route_hints_conv_37_arr: TwoTuple_BlindedPayInfoBlindedPathZ[] = new Array(route_hints_conv_37_len).fill(null);
			for (var l = 0; l < route_hints_conv_37_len; l++) {
				const route_hints_conv_37: bigint = bindings.getU64ArrayElem(route_hints, l);
				const route_hints_conv_37_hu_conv: TwoTuple_BlindedPayInfoBlindedPathZ = new TwoTuple_BlindedPayInfoBlindedPathZ(null, route_hints_conv_37);
				CommonBase.add_ref_from(route_hints_conv_37_hu_conv, this);

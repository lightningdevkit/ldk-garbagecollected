...
export class Payee extends CommonBase {
	...
	public static constructor_blinded(route_hints: TwoTuple_BlindedPayInfoBlindedPathZ[], features: Bolt12InvoiceFeatures): Payee {
		const ret: bigint = bindings.Payee_blinded(bindings.encodeUint64Array(route_hints.map(route_hints_conv_37 => route_hints_conv_37 != null ? CommonBase.get_ptr_of(route_hints_conv_37) : 0n)), features == null ? 0n : CommonBase.get_ptr_of(features));
		const ret_hu_conv: Payee = Payee.constr_from_ptr(ret);

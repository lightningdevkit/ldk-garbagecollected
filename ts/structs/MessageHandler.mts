...
export class MessageHandler extends CommonBase {
	 ...
	 */
	public static constructor_new(chan_handler_arg: ChannelMessageHandler, route_handler_arg: RoutingMessageHandler, onion_message_handler_arg: OnionMessageHandler, custom_message_handler_arg: CustomMessageHandler): MessageHandler {
		const ret: bigint = bindings.MessageHandler_new(CommonBase.get_ptr_of(chan_handler_arg), CommonBase.get_ptr_of(route_handler_arg), CommonBase.get_ptr_of(onion_message_handler_arg), CommonBase.get_ptr_of(custom_message_handler_arg));

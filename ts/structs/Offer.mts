...
export class Offer extends CommonBase {
	...
	public supports_chain(chain: Uint8Array): boolean {
		const ret: boolean = bindings.Offer_supports_chain(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(chain, 32)));
		return ret;
	}
	...
	public features(): OfferFeatures {
		const ret: bigint = bindings.Offer_features(this.ptr);
	 ...
	 */
	public absolute_expiry(): Option_DurationZ {
	...
	public signing_pubkey(): Uint8Array {
		const ret: number = bindings.Offer_signing_pubkey(this.ptr);

...
export class WatchedOutput extends CommonBase {
	 ...
	 */
	public get_block_hash(): Option_BlockHashZ {
		const ret: bigint = bindings.WatchedOutput_get_block_hash(this.ptr);
		const ret_hu_conv: Option_BlockHashZ = Option_BlockHashZ.constr_from_ptr(ret);
	 ...
	 * First block where the transaction output may have been spent.
	 */
	public set_block_hash(val: Option_BlockHashZ): void {
	 ...
	 */
	public static constructor_new(block_hash_arg: Option_BlockHashZ, outpoint_arg: OutPoint, script_pubkey_arg: Uint8Array): WatchedOutput {
		const ret: bigint = bindings.WatchedOutput_new(CommonBase.get_ptr_of(block_hash_arg), outpoint_arg == null ? 0n : CommonBase.get_ptr_of(outpoint_arg), bindings.encodeUint8Array(script_pubkey_arg));
		const ret_hu_conv: WatchedOutput = new WatchedOutput(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, block_hash_arg);
	...
	public eq(b: WatchedOutput): boolean {
		const ret: boolean = bindings.WatchedOutput_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

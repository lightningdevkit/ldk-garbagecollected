...
export class Result_OfferBolt12ParseErrorZ extends CommonBase {
	...
	public static constructor_ok(o: Offer): Result_OfferBolt12ParseErrorZ {
		const ret: bigint = bindings.CResult_OfferBolt12ParseErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
	...
	public static constructor_err(e: Bolt12ParseError): Result_OfferBolt12ParseErrorZ {
		const ret: bigint = bindings.CResult_OfferBolt12ParseErrorZ_err(e == null ? 0n : CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_OfferBolt12ParseErrorZ = Result_OfferBolt12ParseErrorZ.constr_from_ptr(ret);

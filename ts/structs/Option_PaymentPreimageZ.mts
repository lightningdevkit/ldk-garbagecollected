 ...
 */
export class Option_PaymentPreimageZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_PaymentPreimageZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_PaymentPreimageZ {
		const raw_ty: number = bindings.LDKCOption_PaymentPreimageZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: Uint8Array): Option_PaymentPreimageZ {
		const ret: bigint = bindings.COption_PaymentPreimageZ_some(bindings.encodeUint8Array(bindings.check_arr_len(o, 32)));
	 ...
	 */
	public static constructor_none(): Option_PaymentPreimageZ {
		const ret: bigint = bindings.COption_PaymentPreimageZ_none();
		const ret_hu_conv: Option_PaymentPreimageZ = Option_PaymentPreimageZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_PaymentPreimageZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_PaymentPreimageZ {
		const ret: bigint = bindings.COption_PaymentPreimageZ_clone(this.ptr);
		const ret_hu_conv: Option_PaymentPreimageZ = Option_PaymentPreimageZ.constr_from_ptr(ret);
...
export class Option_PaymentPreimageZ_Some extends Option_PaymentPreimageZ {
	public some: Uint8Array;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const some: number = bindings.LDKCOption_PaymentPreimageZ_Some_get_some(ptr);
		const some_conv: Uint8Array = bindings.decodeUint8Array(some);
		this.some = some_conv;
	}
}
/** A Option_PaymentPreimageZ of type None */
export class Option_PaymentPreimageZ_None extends Option_PaymentPreimageZ {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}

 ...
 */
export class Option_PackedLockTimeZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_PackedLockTimeZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_PackedLockTimeZ {
		const raw_ty: number = bindings.LDKCOption_PackedLockTimeZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: number): Option_PackedLockTimeZ {
		const ret: bigint = bindings.COption_PackedLockTimeZ_some(o);
		const ret_hu_conv: Option_PackedLockTimeZ = Option_PackedLockTimeZ.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_none(): Option_PackedLockTimeZ {
		const ret: bigint = bindings.COption_PackedLockTimeZ_none();
		const ret_hu_conv: Option_PackedLockTimeZ = Option_PackedLockTimeZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_PackedLockTimeZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_PackedLockTimeZ {
		const ret: bigint = bindings.COption_PackedLockTimeZ_clone(this.ptr);
		const ret_hu_conv: Option_PackedLockTimeZ = Option_PackedLockTimeZ.constr_from_ptr(ret);
...
export class Option_PackedLockTimeZ_Some extends Option_PackedLockTimeZ {
	public some: number;
	/* @internal */
...
export class Option_PackedLockTimeZ_None extends Option_PackedLockTimeZ {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}

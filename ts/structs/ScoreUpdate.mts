...
export class ScoreUpdate extends CommonBase {
	...
	public payment_path_failed(path: Path, short_channel_id: bigint, duration_since_epoch: bigint): void {
		bindings.ScoreUpdate_payment_path_failed(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path), short_channel_id, duration_since_epoch);
	...
	public payment_path_successful(path: Path, duration_since_epoch: bigint): void {
		bindings.ScoreUpdate_payment_path_successful(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path), duration_since_epoch);
		CommonBase.add_ref_from(this, path);
	}
	...
	public probe_failed(path: Path, short_channel_id: bigint, duration_since_epoch: bigint): void {
		bindings.ScoreUpdate_probe_failed(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path), short_channel_id, duration_since_epoch);
		CommonBase.add_ref_from(this, path);
	}
	...
	public probe_successful(path: Path, duration_since_epoch: bigint): void {
		bindings.ScoreUpdate_probe_successful(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path), duration_since_epoch);
		CommonBase.add_ref_from(this, path);
	}

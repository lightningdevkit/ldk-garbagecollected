...
export class ScoreUpdate extends CommonBase {
	...
	public payment_path_failed(path: Path, short_channel_id: bigint): void {
		bindings.ScoreUpdate_payment_path_failed(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path), short_channel_id);
	...
	public payment_path_successful(path: Path): void {
		bindings.ScoreUpdate_payment_path_successful(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path));
		CommonBase.add_ref_from(this, path);
	}
	...
	public probe_failed(path: Path, short_channel_id: bigint): void {
		bindings.ScoreUpdate_probe_failed(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path), short_channel_id);
		CommonBase.add_ref_from(this, path);
	}
	...
	public probe_successful(path: Path): void {
		bindings.ScoreUpdate_probe_successful(this.ptr, path == null ? 0n : CommonBase.get_ptr_of(path));
		CommonBase.add_ref_from(this, path);
	}

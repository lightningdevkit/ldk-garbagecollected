...
export class Bolt12Invoice extends CommonBase {
	...
	public features(): Bolt12InvoiceFeatures {
		const ret: bigint = bindings.Bolt12Invoice_features(this.ptr);
	 ...
	 */
	public verify(key: ExpandedKey): boolean {
		const ret: boolean = bindings.Bolt12Invoice_verify(this.ptr, key == null ? 0n : CommonBase.get_ptr_of(key));

...
export class PhantomRouteHints extends CommonBase {
	...
	public set_channels(val: ChannelDetails[]): void {
		bindings.PhantomRouteHints_set_channels(this.ptr, bindings.encodeUint64Array(val.map(val_conv_16 => val_conv_16 == null ? 0n : CommonBase.get_ptr_of(val_conv_16))));
	...
	public static constructor_new(channels_arg: ChannelDetails[], phantom_scid_arg: bigint, real_node_pubkey_arg: Uint8Array): PhantomRouteHints {
		const ret: bigint = bindings.PhantomRouteHints_new(bindings.encodeUint64Array(channels_arg.map(channels_arg_conv_16 => channels_arg_conv_16 == null ? 0n : CommonBase.get_ptr_of(channels_arg_conv_16))), phantom_scid_arg, bindings.encodeUint8Array(bindings.check_arr_len(real_node_pubkey_arg, 33)));

 ...
 */
export class Scorer extends CommonBase {
	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(ptr, bindings.Scorer_free);
	}

	/**
	 * Creates a new scorer using the given scoring parameters.
	 */
	public static constructor_new(params: ScoringParameters): Scorer {
		const ret: number = bindings.Scorer_new(params == null ? 0 : CommonBase.get_ptr_of(params) & ~1);
	 ...
	 */
	public static constructor_default(): Scorer {
		const ret: number = bindings.Scorer_default();
		const ret_hu_conv: Scorer = new Scorer(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public as_Score(): Score {
		const ret: number = bindings.Scorer_as_Score(this.ptr);
	...
	public write(): Uint8Array {
		const ret: number = bindings.Scorer_write(this.ptr);
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_ScorerDecodeErrorZ {
		const ret: number = bindings.Scorer_read(bindings.encodeUint8Array(ser));

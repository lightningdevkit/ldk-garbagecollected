...
export class UserConfig extends CommonBase {
	 ...
	 */
	public get_accept_mpp_keysend(): boolean {
		const ret: boolean = bindings.UserConfig_get_accept_mpp_keysend(this.ptr);
		return ret;
	}
	 ...
	 * [`ChannelManager`]: crate::ln::channelmanager::ChannelManager
	 */
	public set_accept_mpp_keysend(val: boolean): void {

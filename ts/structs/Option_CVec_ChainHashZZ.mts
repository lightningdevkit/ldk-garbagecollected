 ...
 */
export class Option_CVec_ChainHashZZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_CVec_ChainHashZZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_CVec_ChainHashZZ {
		const raw_ty: number = bindings.LDKCOption_CVec_ChainHashZZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: Uint8Array[]): Option_CVec_ChainHashZZ {
		const ret: bigint = bindings.COption_CVec_ChainHashZZ_some(bindings.encodeUint32Array(o != null ? o.map(o_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(o_conv_12, 32))) : null));
	 ...
	 */
	public static constructor_none(): Option_CVec_ChainHashZZ {
		const ret: bigint = bindings.COption_CVec_ChainHashZZ_none();
		const ret_hu_conv: Option_CVec_ChainHashZZ = Option_CVec_ChainHashZZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_CVec_ChainHashZZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_CVec_ChainHashZZ {
		const ret: bigint = bindings.COption_CVec_ChainHashZZ_clone(this.ptr);
		const ret_hu_conv: Option_CVec_ChainHashZZ = Option_CVec_ChainHashZZ.constr_from_ptr(ret);
...
export class Option_CVec_ChainHashZZ_Some extends Option_CVec_ChainHashZZ {
	public some: Uint8Array[];
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const some: number = bindings.LDKCOption_CVec_ChainHashZZ_Some_get_some(ptr);
...
export class Option_CVec_ChainHashZZ_None extends Option_CVec_ChainHashZZ {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}

...
export interface EcdsaChannelSignerInterface {
	 ...
	 */
	sign_holder_commitment_and_htlcs(commitment_tx: HolderCommitmentTransaction): Result_C2Tuple_ECDSASignatureCVec_ECDSASignatureZZNoneZ;
...
export class EcdsaChannelSigner extends CommonBase {
	...
	public static new_impl(arg: EcdsaChannelSignerInterface, channelSigner_impl: ChannelSignerInterface, pubkeys: ChannelPublicKeys): EcdsaChannelSigner {
		...
		let structImplementation = {
			...
			sign_holder_commitment_and_htlcs (commitment_tx: bigint): bigint {
				...
				const ret: Result_C2Tuple_ECDSASignatureCVec_ECDSASignatureZZNoneZ = arg.sign_holder_commitment_and_htlcs(commitment_tx_hu_conv);
				const result: bigint = ret == null ? 0n : ret.clone_ptr();
				return result;
			},
	 ...
	 * [`ChannelMonitor`]: crate::chain::channelmonitor::ChannelMonitor
	 */
	public sign_holder_commitment_and_htlcs(commitment_tx: HolderCommitmentTransaction): Result_C2Tuple_ECDSASignatureCVec_ECDSASignatureZZNoneZ {

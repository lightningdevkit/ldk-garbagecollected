...
export class ProbabilisticScorer extends CommonBase {
	 ...
	 */
	public static constructor_new(params: ProbabilisticScoringParameters, network_graph: NetworkGraph): ProbabilisticScorer {
		const ret: number = bindings.ProbabilisticScorer_new(params == null ? 0 : CommonBase.get_ptr_of(params) & ~1, network_graph == null ? 0 : CommonBase.get_ptr_of(network_graph) & ~1);
	 ...
	 */
	public static constructor_read(ser: Uint8Array, arg_a: ProbabilisticScoringParameters, arg_b: NetworkGraph): Result_ProbabilisticScorerDecodeErrorZ {
		const ret: number = bindings.ProbabilisticScorer_read(bindings.encodeUint8Array(ser), arg_a == null ? 0 : CommonBase.get_ptr_of(arg_a) & ~1, arg_b == null ? 0 : CommonBase.get_ptr_of(arg_b) & ~1);

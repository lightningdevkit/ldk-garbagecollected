...
export class ProbabilisticScorer extends CommonBase {
	...
	public static constructor_new(decay_params: ProbabilisticScoringDecayParameters, network_graph: NetworkGraph, logger: Logger): ProbabilisticScorer {
		const ret: bigint = bindings.ProbabilisticScorer_new(decay_params == null ? 0n : CommonBase.get_ptr_of(decay_params), network_graph == null ? 0n : CommonBase.get_ptr_of(network_graph), CommonBase.get_ptr_of(logger));
		const ret_hu_conv: ProbabilisticScorer = new ProbabilisticScorer(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, decay_params);
	 ...
	 */
	public historical_estimated_payment_success_probability(scid: bigint, target: NodeId, amount_msat: bigint, params: ProbabilisticScoringFeeParameters): Option_f64Z {
		const ret: bigint = bindings.ProbabilisticScorer_historical_estimated_payment_success_probability(this.ptr, scid, target == null ? 0n : CommonBase.get_ptr_of(target), amount_msat, params == null ? 0n : CommonBase.get_ptr_of(params));

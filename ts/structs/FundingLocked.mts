...
export class FundingLocked extends CommonBase {
	...
	public get_short_channel_id_alias(): Option_u64Z {
		const ret: number = bindings.FundingLocked_get_short_channel_id_alias(this.ptr);
	...
	public set_short_channel_id_alias(val: Option_u64Z): void {
		bindings.FundingLocked_set_short_channel_id_alias(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * Constructs a new FundingLocked given each field
	 */
	public static constructor_new(channel_id_arg: Uint8Array, next_per_commitment_point_arg: Uint8Array, short_channel_id_alias_arg: Option_u64Z): FundingLocked {
		const ret: number = bindings.FundingLocked_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), bindings.encodeUint8Array(bindings.check_arr_len(next_per_commitment_point_arg, 33)), CommonBase.get_ptr_of(short_channel_id_alias_arg));
	...
	public clone_ptr(): number {
		const ret: number = bindings.FundingLocked_clone_ptr(this.ptr);
		return ret;
	}

...
export class ForwardTlvs extends CommonBase {
	...
	public set_payment_relay(val: PaymentRelay): void {
		bindings.ForwardTlvs_set_payment_relay(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public set_payment_constraints(val: PaymentConstraints): void {
		bindings.ForwardTlvs_set_payment_constraints(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public set_features(val: BlindedHopFeatures): void {
		bindings.ForwardTlvs_set_features(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	 ...
	 */
	public static constructor_new(short_channel_id_arg: bigint, payment_relay_arg: PaymentRelay, payment_constraints_arg: PaymentConstraints, features_arg: BlindedHopFeatures): ForwardTlvs {
		const ret: bigint = bindings.ForwardTlvs_new(short_channel_id_arg, payment_relay_arg == null ? 0n : CommonBase.get_ptr_of(payment_relay_arg), payment_constraints_arg == null ? 0n : CommonBase.get_ptr_of(payment_constraints_arg), features_arg == null ? 0n : CommonBase.get_ptr_of(features_arg));
		const ret_hu_conv: ForwardTlvs = new ForwardTlvs(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, payment_relay_arg);

...
export class HTLCDescriptor extends CommonBase {
	...
	public set_channel_derivation_parameters(val: ChannelDerivationParameters): void {
		bindings.HTLCDescriptor_set_channel_derivation_parameters(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	...
	public set_htlc(val: HTLCOutputInCommitment): void {
		bindings.HTLCDescriptor_set_htlc(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	 ...
	 * taken.
	 */
	public get_preimage(): Option_PaymentPreimageZ {
		const ret: bigint = bindings.HTLCDescriptor_get_preimage(this.ptr);
		const ret_hu_conv: Option_PaymentPreimageZ = Option_PaymentPreimageZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 * taken.
	 */
	public set_preimage(val: Option_PaymentPreimageZ): void {
	...
	public eq(b: HTLCDescriptor): boolean {
		const ret: boolean = bindings.HTLCDescriptor_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public tx_input_witness(signature: Uint8Array, witness_script: Uint8Array): Uint8Array {
		const ret: number = bindings.HTLCDescriptor_tx_input_witness(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(signature, 64)), bindings.encodeUint8Array(witness_script));
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public derive_channel_signer(signer_provider: SignerProvider): WriteableEcdsaChannelSigner {
		const ret: bigint = bindings.HTLCDescriptor_derive_channel_signer(this.ptr, CommonBase.get_ptr_of(signer_provider));

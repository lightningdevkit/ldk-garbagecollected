...
export class BlindedHopFeatures extends CommonBase {
	 ...
	 */
	public eq(b: BlindedHopFeatures): boolean {
		const ret: boolean = bindings.BlindedHopFeatures_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public requires_unknown_bits_from(other: BlindedHopFeatures): boolean {
		const ret: boolean = bindings.BlindedHopFeatures_requires_unknown_bits_from(this.ptr, other == null ? 0n : CommonBase.get_ptr_of(other));

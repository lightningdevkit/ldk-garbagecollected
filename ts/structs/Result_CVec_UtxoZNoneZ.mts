...
export class Result_CVec_UtxoZNoneZ extends CommonBase {
	...
	public static constructor_ok(o: Utxo[]): Result_CVec_UtxoZNoneZ {
		const ret: bigint = bindings.CResult_CVec_UtxoZNoneZ_ok(bindings.encodeUint64Array(o != null ? o.map(o_conv_6 => o_conv_6 == null ? 0n : CommonBase.get_ptr_of(o_conv_6)) : null));
		const ret_hu_conv: Result_CVec_UtxoZNoneZ = Result_CVec_UtxoZNoneZ.constr_from_ptr(ret);
		o.forEach((o_conv_6: Utxo) => { CommonBase.add_ref_from(ret_hu_conv, o_conv_6); });
		return ret_hu_conv;
	}

...
export class Result_BlindedRouteDecodeErrorZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_BlindedRouteDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: BlindedRoute): Result_BlindedRouteDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedRouteDecodeErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
		const ret_hu_conv: Result_BlindedRouteDecodeErrorZ = Result_BlindedRouteDecodeErrorZ.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_BlindedRouteDecodeErrorZ {
		const ret: bigint = bindings.CResult_BlindedRouteDecodeErrorZ_err(e == null ? 0n : CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_BlindedRouteDecodeErrorZ = Result_BlindedRouteDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_BlindedRouteDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}
...
export class Result_BlindedRouteDecodeErrorZ_OK extends Result_BlindedRouteDecodeErrorZ {
	...
	public constructor(_dummy: object, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_BlindedRouteDecodeErrorZ_get_ok(ptr);
...
export class Result_BlindedRouteDecodeErrorZ_Err extends Result_BlindedRouteDecodeErrorZ {
	...
	public constructor(_dummy: object, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_BlindedRouteDecodeErrorZ_get_err(ptr);

...
export class ThreeTuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ extends CommonBase {
	...
	public get_a(): Uint8Array {
		const ret: number = bindings.C3Tuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ_get_a(this.ptr);
	...
	public get_b(): OnionMessage {
		const ret: bigint = bindings.C3Tuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ_get_b(this.ptr);
	 ...
	 * 
	 */
	public get_c(): Option_CVec_SocketAddressZZ {
		const ret: bigint = bindings.C3Tuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ_get_c(this.ptr);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.C3Tuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): ThreeTuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ {
		const ret: bigint = bindings.C3Tuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ_clone(this.ptr);
		const ret_hu_conv: ThreeTuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ = new ThreeTuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(a: Uint8Array, b: OnionMessage, c: Option_CVec_SocketAddressZZ): ThreeTuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ {
		const ret: bigint = bindings.C3Tuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ_new(bindings.encodeUint8Array(bindings.check_arr_len(a, 33)), b == null ? 0n : CommonBase.get_ptr_of(b), CommonBase.get_ptr_of(c));
		const ret_hu_conv: ThreeTuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ = new ThreeTuple_PublicKeyOnionMessageCOption_CVec_SocketAddressZZZ(null, ret);

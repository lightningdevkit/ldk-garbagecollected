...
export class RevocationBasepoint extends CommonBase {
	...
	public static constructor_new(a_arg: Uint8Array): RevocationBasepoint {
		const ret: bigint = bindings.RevocationBasepoint_new(bindings.encodeUint8Array(bindings.check_arr_len(a_arg, 33)));
	...
	public eq(b: RevocationBasepoint): boolean {
		const ret: boolean = bindings.RevocationBasepoint_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

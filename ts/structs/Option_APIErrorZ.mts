...
export class Option_APIErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_APIErrorZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_APIErrorZ {
		const raw_ty: number = bindings.LDKCOption_APIErrorZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o: APIError): Option_APIErrorZ {
		const ret: bigint = bindings.COption_APIErrorZ_some(CommonBase.get_ptr_of(o));
		const ret_hu_conv: Option_APIErrorZ = Option_APIErrorZ.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_none(): Option_APIErrorZ {
		const ret: bigint = bindings.COption_APIErrorZ_none();
		const ret_hu_conv: Option_APIErrorZ = Option_APIErrorZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.COption_APIErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Option_APIErrorZ {
		const ret: bigint = bindings.COption_APIErrorZ_clone(this.ptr);
		const ret_hu_conv: Option_APIErrorZ = Option_APIErrorZ.constr_from_ptr(ret);
...
export class Option_APIErrorZ_Some extends Option_APIErrorZ {
	public some: APIError;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const some: bigint = bindings.LDKCOption_APIErrorZ_Some_get_some(ptr);
		const some_hu_conv: APIError = APIError.constr_from_ptr(some);

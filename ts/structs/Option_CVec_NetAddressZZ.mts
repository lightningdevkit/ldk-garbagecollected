...
export class Option_CVec_NetAddressZZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_CVec_NetAddressZZ_free); }
	/* @internal */
	...
	public static constructor_some(o: NetAddress[]): Option_CVec_NetAddressZZ {
		...
		o.forEach((o_conv_12: NetAddress) => { CommonBase.add_ref_from(ret_hu_conv, o_conv_12); });
		return ret_hu_conv;
	}

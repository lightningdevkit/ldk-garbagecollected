...
export class InvoiceError extends CommonBase {
	...
	public set_message(val: UntrustedString): void {
		bindings.InvoiceError_set_message(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	 ...
	 */
	public static constructor_new(erroneous_field_arg: ErroneousField, message_arg: UntrustedString): InvoiceError {
		const ret: bigint = bindings.InvoiceError_new(erroneous_field_arg == null ? 0n : CommonBase.get_ptr_of(erroneous_field_arg), message_arg == null ? 0n : CommonBase.get_ptr_of(message_arg));
		const ret_hu_conv: InvoiceError = new InvoiceError(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, erroneous_field_arg);
		CommonBase.add_ref_from(ret_hu_conv, message_arg);
		return ret_hu_conv;
	}

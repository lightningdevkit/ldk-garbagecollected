...
export class BlindedForward extends CommonBase {
	 ...
	 */
	public static constructor_new(inbound_blinding_point_arg: Uint8Array, failure_arg: BlindedFailure): BlindedForward {
		const ret: bigint = bindings.BlindedForward_new(bindings.encodeUint8Array(bindings.check_arr_len(inbound_blinding_point_arg, 33)), failure_arg);
	...
	public eq(b: BlindedForward): boolean {
		const ret: boolean = bindings.BlindedForward_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

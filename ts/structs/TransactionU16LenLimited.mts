...
export class TransactionU16LenLimited extends CommonBase {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.TransactionU16LenLimited_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TransactionU16LenLimited {
		const ret: bigint = bindings.TransactionU16LenLimited_clone(this.ptr);
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.TransactionU16LenLimited_hash(this.ptr);
		return ret;
	}
	 ...
	 */
	public eq(b: TransactionU16LenLimited): boolean {
		const ret: boolean = bindings.TransactionU16LenLimited_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	 ...
	 */
	public static constructor_new(transaction: Uint8Array): Result_TransactionU16LenLimitedNoneZ {
		const ret: bigint = bindings.TransactionU16LenLimited_new(bindings.encodeUint8Array(transaction));
	 ...
	 */
	public into_transaction(): Uint8Array {
		const ret: number = bindings.TransactionU16LenLimited_into_transaction(this.ptr);
	...
	public write(): Uint8Array {
		const ret: number = bindings.TransactionU16LenLimited_write(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_TransactionU16LenLimitedDecodeErrorZ {
		const ret: bigint = bindings.TransactionU16LenLimited_read(bindings.encodeUint8Array(ser));

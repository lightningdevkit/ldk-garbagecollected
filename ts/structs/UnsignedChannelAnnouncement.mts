...
export class UnsignedChannelAnnouncement extends CommonBase {
	...
	public set_node_id_1(val: NodeId): void {
		bindings.UnsignedChannelAnnouncement_set_node_id_1(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public set_node_id_2(val: NodeId): void {
		bindings.UnsignedChannelAnnouncement_set_node_id_2(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public set_bitcoin_key_1(val: NodeId): void {
		bindings.UnsignedChannelAnnouncement_set_bitcoin_key_1(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public set_bitcoin_key_2(val: NodeId): void {
		bindings.UnsignedChannelAnnouncement_set_bitcoin_key_2(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public static constructor_new(features_arg: ChannelFeatures, chain_hash_arg: Uint8Array, short_channel_id_arg: bigint, node_id_1_arg: NodeId, node_id_2_arg: NodeId, bitcoin_key_1_arg: NodeId, bitcoin_key_2_arg: NodeId, excess_data_arg: Uint8Array): UnsignedChannelAnnouncement {
		const ret: bigint = bindings.UnsignedChannelAnnouncement_new(features_arg == null ? 0n : CommonBase.get_ptr_of(features_arg), bindings.encodeUint8Array(bindings.check_arr_len(chain_hash_arg, 32)), short_channel_id_arg, node_id_1_arg == null ? 0n : CommonBase.get_ptr_of(node_id_1_arg), node_id_2_arg == null ? 0n : CommonBase.get_ptr_of(node_id_2_arg), bitcoin_key_1_arg == null ? 0n : CommonBase.get_ptr_of(bitcoin_key_1_arg), bitcoin_key_2_arg == null ? 0n : CommonBase.get_ptr_of(bitcoin_key_2_arg), bindings.encodeUint8Array(excess_data_arg));
		...
		CommonBase.add_ref_from(ret_hu_conv, node_id_1_arg);
		CommonBase.add_ref_from(ret_hu_conv, node_id_2_arg);
		CommonBase.add_ref_from(ret_hu_conv, bitcoin_key_1_arg);
		CommonBase.add_ref_from(ret_hu_conv, bitcoin_key_2_arg);
		return ret_hu_conv;
	}
	...
	public eq(b: UnsignedChannelAnnouncement): boolean {
		const ret: boolean = bindings.UnsignedChannelAnnouncement_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

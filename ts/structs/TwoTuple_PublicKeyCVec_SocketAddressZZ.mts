 ...
 * A Tuple
 */
export class TwoTuple_PublicKeyCVec_SocketAddressZZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C2Tuple_PublicKeyCVec_SocketAddressZZ_free);
	}
	...
	public get_a(): Uint8Array {
		const ret: number = bindings.C2Tuple_PublicKeyCVec_SocketAddressZZ_get_a(this.ptr);
	 ...
	 * 
	 */
	public get_b(): SocketAddress[] {
		const ret: number = bindings.C2Tuple_PublicKeyCVec_SocketAddressZZ_get_b(this.ptr);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.C2Tuple_PublicKeyCVec_SocketAddressZZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TwoTuple_PublicKeyCVec_SocketAddressZZ {
		const ret: bigint = bindings.C2Tuple_PublicKeyCVec_SocketAddressZZ_clone(this.ptr);
		const ret_hu_conv: TwoTuple_PublicKeyCVec_SocketAddressZZ = new TwoTuple_PublicKeyCVec_SocketAddressZZ(null, ret);
	 ...
	 */
	public static constructor_new(a: Uint8Array, b: SocketAddress[]): TwoTuple_PublicKeyCVec_SocketAddressZZ {
		const ret: bigint = bindings.C2Tuple_PublicKeyCVec_SocketAddressZZ_new(bindings.encodeUint8Array(bindings.check_arr_len(a, 33)), bindings.encodeUint64Array(b.map(b_conv_15 => CommonBase.get_ptr_of(b_conv_15))));
		const ret_hu_conv: TwoTuple_PublicKeyCVec_SocketAddressZZ = new TwoTuple_PublicKeyCVec_SocketAddressZZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		b.forEach((b_conv_15: SocketAddress) => { CommonBase.add_ref_from(ret_hu_conv, b_conv_15); });
		return ret_hu_conv;
	}

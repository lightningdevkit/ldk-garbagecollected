...
export class ClosureReason extends CommonBase {
	...
	public static constructor_counterparty_force_closed(peer_msg: UntrustedString): ClosureReason {
		const ret: bigint = bindings.ClosureReason_counterparty_force_closed(peer_msg == null ? 0n : CommonBase.get_ptr_of(peer_msg));
		const ret_hu_conv: ClosureReason = ClosureReason.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, peer_msg);
		return ret_hu_conv;
	}
	...
	public eq(b: ClosureReason): boolean {
		const ret: boolean = bindings.ClosureReason_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}

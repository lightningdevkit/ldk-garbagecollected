...
export class ChannelFeatures extends CommonBase {
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.ChannelFeatures_hash(this.ptr);
		return ret;
	}
	...
	public le_flags(): Uint8Array {
		const ret: number = bindings.ChannelFeatures_le_flags(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	...
	public supports_any_optional_bits(): boolean {
		const ret: boolean = bindings.ChannelFeatures_supports_any_optional_bits(this.ptr);
		return ret;
	}
	 ...
	 */
	public requires_unknown_bits_from(other: ChannelFeatures): boolean {
		const ret: boolean = bindings.ChannelFeatures_requires_unknown_bits_from(this.ptr, CommonBase.get_ptr_of(other));
		return ret;
	}
	 ...
	 */
	public required_unknown_bits_from(other: ChannelFeatures): BigUint64Array {
		const ret: number = bindings.ChannelFeatures_required_unknown_bits_from(this.ptr, CommonBase.get_ptr_of(other));
	...
	public supports_unknown_bits(): boolean {
		const ret: boolean = bindings.ChannelFeatures_supports_unknown_bits(this.ptr);
		return ret;
	}
	...
	public set_required_feature_bit(bit: number): Result_NoneNoneZ {
		const ret: bigint = bindings.ChannelFeatures_set_required_feature_bit(this.ptr, bit);
	...
	public set_optional_feature_bit(bit: number): Result_NoneNoneZ {
		const ret: bigint = bindings.ChannelFeatures_set_optional_feature_bit(this.ptr, bit);
		const ret_hu_conv: Result_NoneNoneZ = Result_NoneNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public set_required_custom_bit(bit: number): Result_NoneNoneZ {
		const ret: bigint = bindings.ChannelFeatures_set_required_custom_bit(this.ptr, bit);
		const ret_hu_conv: Result_NoneNoneZ = Result_NoneNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public set_optional_custom_bit(bit: number): Result_NoneNoneZ {
		const ret: bigint = bindings.ChannelFeatures_set_optional_custom_bit(this.ptr, bit);
		const ret_hu_conv: Result_NoneNoneZ = Result_NoneNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

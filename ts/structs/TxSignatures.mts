...
export class TxSignatures extends CommonBase {
	...
	public get_channel_id(): Uint8Array {
		const ret: number = bindings.TxSignatures_get_channel_id(this.ptr);
	...
	public set_channel_id(val: Uint8Array): void {
		bindings.TxSignatures_set_channel_id(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	...
	public set_witnesses(val: Uint8Array[]): void {
		bindings.TxSignatures_set_witnesses(this.ptr, bindings.encodeUint32Array(val != null ? val.map(val_conv_12 => bindings.encodeUint8Array(val_conv_12)) : null));
	}

	/**
	 * Constructs a new TxSignatures given each field
	 */
	public static constructor_new(channel_id_arg: Uint8Array, tx_hash_arg: Uint8Array, witnesses_arg: Uint8Array[]): TxSignatures {
		const ret: bigint = bindings.TxSignatures_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), bindings.encodeUint8Array(bindings.check_arr_len(tx_hash_arg, 32)), bindings.encodeUint32Array(witnesses_arg != null ? witnesses_arg.map(witnesses_arg_conv_12 => bindings.encodeUint8Array(witnesses_arg_conv_12)) : null));
	...
	public eq(b: TxSignatures): boolean {
		const ret: boolean = bindings.TxSignatures_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

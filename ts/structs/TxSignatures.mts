...
export class TxSignatures extends CommonBase {
	...
	public static constructor_new(channel_id_arg: Uint8Array, tx_hash_arg: Uint8Array, witnesses_arg: Uint8Array[]): TxSignatures {
		const ret: bigint = bindings.TxSignatures_new(bindings.encodeUint8Array(bindings.check_arr_len(channel_id_arg, 32)), bindings.encodeUint8Array(bindings.check_arr_len(tx_hash_arg, 32)), bindings.encodeUint32Array(witnesses_arg.map(witnesses_arg_conv_12 => bindings.encodeUint8Array(witnesses_arg_conv_12))));

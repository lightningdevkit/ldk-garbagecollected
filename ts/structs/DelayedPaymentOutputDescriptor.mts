...
export class DelayedPaymentOutputDescriptor extends CommonBase {
	...
	public set_revocation_pubkey(val: RevocationKey): void {
		bindings.DelayedPaymentOutputDescriptor_set_revocation_pubkey(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	 ...
	 */
	public static constructor_new(outpoint_arg: OutPoint, per_commitment_point_arg: Uint8Array, to_self_delay_arg: number, output_arg: TxOut, revocation_pubkey_arg: RevocationKey, channel_keys_id_arg: Uint8Array, channel_value_satoshis_arg: bigint): DelayedPaymentOutputDescriptor {
		const ret: bigint = bindings.DelayedPaymentOutputDescriptor_new(outpoint_arg == null ? 0n : CommonBase.get_ptr_of(outpoint_arg), bindings.encodeUint8Array(bindings.check_arr_len(per_commitment_point_arg, 33)), to_self_delay_arg, CommonBase.get_ptr_of(output_arg), revocation_pubkey_arg == null ? 0n : CommonBase.get_ptr_of(revocation_pubkey_arg), bindings.encodeUint8Array(bindings.check_arr_len(channel_keys_id_arg, 32)), channel_value_satoshis_arg);
		...
		CommonBase.add_ref_from(ret_hu_conv, revocation_pubkey_arg);
		return ret_hu_conv;
	}
	...
	public eq(b: DelayedPaymentOutputDescriptor): boolean {
		const ret: boolean = bindings.DelayedPaymentOutputDescriptor_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

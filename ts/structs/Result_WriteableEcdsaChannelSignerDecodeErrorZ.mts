...
export class Result_WriteableEcdsaChannelSignerDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_WriteableEcdsaChannelSignerDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_WriteableEcdsaChannelSignerDecodeErrorZ {
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_WriteableEcdsaChannelSignerDecodeErrorZ {
		const ret: bigint = bindings.CResult_WriteableEcdsaChannelSignerDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_WriteableEcdsaChannelSignerDecodeErrorZ = Result_WriteableEcdsaChannelSignerDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_WriteableEcdsaChannelSignerDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_WriteableEcdsaChannelSignerDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_WriteableEcdsaChannelSignerDecodeErrorZ {
		const ret: bigint = bindings.CResult_WriteableEcdsaChannelSignerDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_WriteableEcdsaChannelSignerDecodeErrorZ = Result_WriteableEcdsaChannelSignerDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_WriteableEcdsaChannelSignerDecodeErrorZ_OK extends Result_WriteableEcdsaChannelSignerDecodeErrorZ {
	public res: WriteableEcdsaChannelSigner;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_WriteableEcdsaChannelSignerDecodeErrorZ_get_ok(ptr);
		const ret_hu_conv: WriteableEcdsaChannelSigner = new WriteableEcdsaChannelSigner(null, res);
		CommonBase.add_ref_from(ret_hu_conv, this);
		this.res = ret_hu_conv;
	}
}
export class Result_WriteableEcdsaChannelSignerDecodeErrorZ_Err extends Result_WriteableEcdsaChannelSignerDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_WriteableEcdsaChannelSignerDecodeErrorZ_get_err(ptr);

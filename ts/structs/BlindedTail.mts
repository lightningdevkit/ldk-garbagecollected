...
export class BlindedTail extends CommonBase {
	...
	public set_hops(val: BlindedHop[]): void {
		bindings.BlindedTail_set_hops(this.ptr, bindings.encodeUint64Array(val.map(val_conv_12 => val_conv_12 == null ? 0n : CommonBase.get_ptr_of(val_conv_12))));
	...
	public static constructor_new(hops_arg: BlindedHop[], blinding_point_arg: Uint8Array, excess_final_cltv_expiry_delta_arg: number, final_value_msat_arg: bigint): BlindedTail {
		const ret: bigint = bindings.BlindedTail_new(bindings.encodeUint64Array(hops_arg.map(hops_arg_conv_12 => hops_arg_conv_12 == null ? 0n : CommonBase.get_ptr_of(hops_arg_conv_12))), bindings.encodeUint8Array(bindings.check_arr_len(blinding_point_arg, 33)), excess_final_cltv_expiry_delta_arg, final_value_msat_arg);

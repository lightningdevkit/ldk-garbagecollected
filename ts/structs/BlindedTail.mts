...
export class BlindedTail extends CommonBase {
	...
	public set_hops(val: BlindedHop[]): void {
		bindings.BlindedTail_set_hops(this.ptr, bindings.encodeUint64Array(val != null ? val.map(val_conv_12 => val_conv_12 == null ? 0n : CommonBase.get_ptr_of(val_conv_12)) : null));
	 ...
	 */
	public static constructor_new(hops_arg: BlindedHop[], blinding_point_arg: Uint8Array, excess_final_cltv_expiry_delta_arg: number, final_value_msat_arg: bigint): BlindedTail {
		const ret: bigint = bindings.BlindedTail_new(bindings.encodeUint64Array(hops_arg != null ? hops_arg.map(hops_arg_conv_12 => hops_arg_conv_12 == null ? 0n : CommonBase.get_ptr_of(hops_arg_conv_12)) : null), bindings.encodeUint8Array(bindings.check_arr_len(blinding_point_arg, 33)), excess_final_cltv_expiry_delta_arg, final_value_msat_arg);
		const ret_hu_conv: BlindedTail = new BlindedTail(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		hops_arg.forEach((hops_arg_conv_12: BlindedHop) => { CommonBase.add_ref_from(ret_hu_conv, hops_arg_conv_12); });
		return ret_hu_conv;
	}
	...
	public eq(b: BlindedTail): boolean {
		const ret: boolean = bindings.BlindedTail_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

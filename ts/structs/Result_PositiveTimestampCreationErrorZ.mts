...
export class Result_PositiveTimestampCreationErrorZ extends CommonBase {
	...
	public static constructor_ok(o: PositiveTimestamp): Result_PositiveTimestampCreationErrorZ {
		const ret: bigint = bindings.CResult_PositiveTimestampCreationErrorZ_ok(CommonBase.get_ptr_of(o));
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_PositiveTimestampCreationErrorZ_is_ok(this.ptr);
		return ret;
	}

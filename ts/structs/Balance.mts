...
export class Balance extends CommonBase {
	 ...
	 */
	public static constructor_claimable_on_channel_close(amount_satoshis: bigint): Balance {
		const ret: bigint = bindings.Balance_claimable_on_channel_close(amount_satoshis);
		const ret_hu_conv: Balance = Balance.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_claimable_awaiting_confirmations(amount_satoshis: bigint, confirmation_height: number): Balance {
		const ret: bigint = bindings.Balance_claimable_awaiting_confirmations(amount_satoshis, confirmation_height);
		const ret_hu_conv: Balance = Balance.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public static constructor_contentious_claimable(amount_satoshis: bigint, timeout_height: number, payment_hash: Uint8Array, payment_preimage: Uint8Array): Balance {
		const ret: bigint = bindings.Balance_contentious_claimable(amount_satoshis, timeout_height, bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)), bindings.encodeUint8Array(bindings.check_arr_len(payment_preimage, 32)));
		const ret_hu_conv: Balance = Balance.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_maybe_timeout_claimable_htlc(amount_satoshis: bigint, claimable_height: number, payment_hash: Uint8Array): Balance {
		const ret: bigint = bindings.Balance_maybe_timeout_claimable_htlc(amount_satoshis, claimable_height, bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)));
		const ret_hu_conv: Balance = Balance.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public static constructor_maybe_preimage_claimable_htlc(amount_satoshis: bigint, expiry_height: number, payment_hash: Uint8Array): Balance {
		const ret: bigint = bindings.Balance_maybe_preimage_claimable_htlc(amount_satoshis, expiry_height, bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)));
		const ret_hu_conv: Balance = Balance.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

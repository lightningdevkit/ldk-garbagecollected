...
export class SignedRawInvoice extends CommonBase {
	...
	public hash(): Uint8Array {
		const ret: number = bindings.SignedRawInvoice_hash(this.ptr);
	...
	public check_signature(): boolean {
		const ret: boolean = bindings.SignedRawInvoice_check_signature(this.ptr);
		return ret;
	}
	 ...
	 */
	public static constructor_from_str(s: string): Result_SignedRawInvoiceNoneZ {
	...
	public to_str(): string {
		const ret: number = bindings.SignedRawInvoice_to_str(this.ptr);

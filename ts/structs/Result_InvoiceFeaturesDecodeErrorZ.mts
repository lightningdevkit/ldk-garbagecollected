...
export class Result_InvoiceFeaturesDecodeErrorZ extends CommonBase {
	...
	public static constructor_err(e: DecodeError): Result_InvoiceFeaturesDecodeErrorZ {
		const ret: bigint = bindings.CResult_InvoiceFeaturesDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_InvoiceFeaturesDecodeErrorZ = Result_InvoiceFeaturesDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_InvoiceFeaturesDecodeErrorZ_OK extends Result_InvoiceFeaturesDecodeErrorZ {
...
export class Result_InvoiceFeaturesDecodeErrorZ_Err extends Result_InvoiceFeaturesDecodeErrorZ {

	...
	public static new_impl(arg: MessageSendEventsProviderInterface): MessageSendEventsProvider {
		...
		let structImplementation = {
			get_and_clear_pending_msg_events (): number {
				...
				const result: number = bindings.encodeUint64Array(ret.map(ret_conv_18 => ret_conv_18 == null ? 0n : ret_conv_18.clone_ptr()));
				ret.forEach((ret_conv_18: MessageSendEvent) => { CommonBase.add_ref_from(impl_holder.held, ret_conv_18); });
				return result;
			},

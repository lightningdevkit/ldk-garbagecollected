...
class LDKMessageSendEventsProviderHolder {
	held: MessageSendEventsProvider|null = null;
}
...
export class MessageSendEventsProvider extends CommonBase {
	/* @internal */
	public bindings_instance: bindings.LDKMessageSendEventsProvider|null;
	...
	public static new_impl(arg: MessageSendEventsProviderInterface): MessageSendEventsProvider {
		...
		const ptr_idx: [bigint, number] = bindings.LDKMessageSendEventsProvider_new(structImplementation);

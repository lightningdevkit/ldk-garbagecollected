...
export class Option_ScalarZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.COption_ScalarZ_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Option_ScalarZ {
		const raw_ty: number = bindings.LDKCOption_ScalarZ_ty_from_ptr(ptr);
		switch (raw_ty) {
	 ...
	 */
	public static constructor_some(o_big_endian_bytes: Uint8Array): Option_ScalarZ {
		const ret: bigint = bindings.COption_ScalarZ_some(bindings.BigEndianScalar_new(bindings.encodeUint8Array(bindings.check_arr_len(o_big_endian_bytes, 32))));
	 ...
	 */
	public static constructor_none(): Option_ScalarZ {
		const ret: bigint = bindings.COption_ScalarZ_none();
		const ret_hu_conv: Option_ScalarZ = Option_ScalarZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
...
export class Option_ScalarZ_Some extends Option_ScalarZ {
	...
	public constructor(ptr: bigint) {
		super(null, ptr);
		const some: bigint = bindings.LDKCOption_ScalarZ_Some_get_some(ptr);

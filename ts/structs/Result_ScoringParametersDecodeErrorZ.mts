...
export class Result_ScoringParametersDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: object, ptr: number) {
		super(ptr, bindings.CResult_ScoringParametersDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: number): Result_ScoringParametersDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: ScoringParameters): Result_ScoringParametersDecodeErrorZ {
		const ret: number = bindings.CResult_ScoringParametersDecodeErrorZ_ok(o == null ? 0 : CommonBase.get_ptr_of(o) & ~1);
	...
	public clone_ptr(): number {
		const ret: number = bindings.CResult_ScoringParametersDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_ScoringParametersDecodeErrorZ {
		const ret: number = bindings.CResult_ScoringParametersDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_ScoringParametersDecodeErrorZ = Result_ScoringParametersDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_ScoringParametersDecodeErrorZ_OK extends Result_ScoringParametersDecodeErrorZ {
	public res: ScoringParameters;

	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_ScoringParametersDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: ScoringParameters = new ScoringParameters(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_ScoringParametersDecodeErrorZ_Err extends Result_ScoringParametersDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(_dummy, ptr);
		const err: number = bindings.CResult_ScoringParametersDecodeErrorZ_get_err(ptr);

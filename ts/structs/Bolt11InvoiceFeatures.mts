...
export class Bolt11InvoiceFeatures extends CommonBase {
	 ...
	 */
	public eq(b: Bolt11InvoiceFeatures): boolean {
		const ret: boolean = bindings.Bolt11InvoiceFeatures_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
	...
	public requires_unknown_bits_from(other: Bolt11InvoiceFeatures): boolean {
		const ret: boolean = bindings.Bolt11InvoiceFeatures_requires_unknown_bits_from(this.ptr, other == null ? 0n : CommonBase.get_ptr_of(other));

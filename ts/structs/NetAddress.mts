...
export class NetAddress extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.NetAddress_free); }
	/* @internal */
	 ...
	 */
	public eq(b: NetAddress): boolean {
		const ret: boolean = bindings.NetAddress_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));
		return ret;
	}

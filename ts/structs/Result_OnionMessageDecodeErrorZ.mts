...
export class Result_OnionMessageDecodeErrorZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_OnionMessageDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: OnionMessage): Result_OnionMessageDecodeErrorZ {
		const ret: bigint = bindings.CResult_OnionMessageDecodeErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_OnionMessageDecodeErrorZ {
		const ret: bigint = bindings.CResult_OnionMessageDecodeErrorZ_err(e == null ? 0n : CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_OnionMessageDecodeErrorZ = Result_OnionMessageDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_OnionMessageDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_OnionMessageDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_OnionMessageDecodeErrorZ {
		const ret: bigint = bindings.CResult_OnionMessageDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_OnionMessageDecodeErrorZ = Result_OnionMessageDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_OnionMessageDecodeErrorZ_OK extends Result_OnionMessageDecodeErrorZ {
	public res: OnionMessage;

	/* @internal */
	public constructor(_dummy: object, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_OnionMessageDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: OnionMessage = new OnionMessage(null, res);
...
export class Result_OnionMessageDecodeErrorZ_Err extends Result_OnionMessageDecodeErrorZ {
	...
	public constructor(_dummy: object, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_OnionMessageDecodeErrorZ_get_err(ptr);

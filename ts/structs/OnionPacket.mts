...
export class OnionPacket extends CommonBase {
	...
	public set_public_key(val: Result_PublicKeySecp256k1ErrorZ): void {
		bindings.OnionPacket_set_public_key(this.ptr, val != null ? CommonBase.get_ptr_of(val) : 0n);
	}
	...
	public eq(b: OnionPacket): boolean {
		const ret: boolean = bindings.OnionPacket_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

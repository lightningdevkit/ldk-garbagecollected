...
export class Result_RefundBolt12ParseErrorZ extends CommonBase {
	...
	public static constructor_ok(o: Refund): Result_RefundBolt12ParseErrorZ {
		const ret: bigint = bindings.CResult_RefundBolt12ParseErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
	...
	public static constructor_err(e: Bolt12ParseError): Result_RefundBolt12ParseErrorZ {
		const ret: bigint = bindings.CResult_RefundBolt12ParseErrorZ_err(e == null ? 0n : CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_RefundBolt12ParseErrorZ = Result_RefundBolt12ParseErrorZ.constr_from_ptr(ret);

...
export class NodeAnnouncementInfo extends CommonBase {
	 ...
	 */
	public set_announcement_message(val: NodeAnnouncement|null): void {
	 ...
	 */
	public static constructor_new(features_arg: NodeFeatures, last_update_arg: number, rgb_arg: Uint8Array, alias_arg: NodeAlias, announcement_message_arg: NodeAnnouncement): NodeAnnouncementInfo {
		const ret: bigint = bindings.NodeAnnouncementInfo_new(features_arg == null ? 0n : CommonBase.get_ptr_of(features_arg), last_update_arg, bindings.encodeUint8Array(bindings.check_arr_len(rgb_arg, 3)), alias_arg == null ? 0n : CommonBase.get_ptr_of(alias_arg), announcement_message_arg == null ? 0n : CommonBase.get_ptr_of(announcement_message_arg));
	...
	public eq(b: NodeAnnouncementInfo): boolean {
		const ret: boolean = bindings.NodeAnnouncementInfo_eq(this.ptr, b == null ? 0n : CommonBase.get_ptr_of(b));

...
export class Result_ThirtyTwoBytesPaymentErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_ThirtyTwoBytesPaymentErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_ThirtyTwoBytesPaymentErrorZ {
	 ...
	 */
	public static constructor_ok(o: Uint8Array): Result_ThirtyTwoBytesPaymentErrorZ {
		const ret: bigint = bindings.CResult_ThirtyTwoBytesPaymentErrorZ_ok(bindings.encodeUint8Array(bindings.check_arr_len(o, 32)));
	 ...
	 */
	public static constructor_err(e: PaymentError): Result_ThirtyTwoBytesPaymentErrorZ {
		const ret: bigint = bindings.CResult_ThirtyTwoBytesPaymentErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_ThirtyTwoBytesPaymentErrorZ = Result_ThirtyTwoBytesPaymentErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_ThirtyTwoBytesPaymentErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_ThirtyTwoBytesPaymentErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_ThirtyTwoBytesPaymentErrorZ {
		const ret: bigint = bindings.CResult_ThirtyTwoBytesPaymentErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_ThirtyTwoBytesPaymentErrorZ = Result_ThirtyTwoBytesPaymentErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_ThirtyTwoBytesPaymentErrorZ_OK extends Result_ThirtyTwoBytesPaymentErrorZ {
	public res: Uint8Array;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: number = bindings.CResult_ThirtyTwoBytesPaymentErrorZ_get_ok(ptr);
		const res_conv: Uint8Array = bindings.decodeUint8Array(res);
		this.res = res_conv;
	}
}
export class Result_ThirtyTwoBytesPaymentErrorZ_Err extends Result_ThirtyTwoBytesPaymentErrorZ {
	public err: PaymentError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_ThirtyTwoBytesPaymentErrorZ_get_err(ptr);

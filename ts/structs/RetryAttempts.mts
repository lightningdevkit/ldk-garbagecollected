 ...
 * payment's paths.
 */
export class RetryAttempts extends CommonBase {
	/* @internal */
	public constructor(_dummy: object, ptr: number) {
		super(ptr, bindings.RetryAttempts_free);
	}

	public get_a(): number {
		const ret: number = bindings.RetryAttempts_get_a(this.ptr);
		return ret;
	}

	public set_a(val: number): void {
	 ...
	 */
	public static constructor_new(a_arg: number): RetryAttempts {
		const ret: number = bindings.RetryAttempts_new(a_arg);
	...
	public clone_ptr(): number {
		const ret: number = bindings.RetryAttempts_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): RetryAttempts {
		const ret: number = bindings.RetryAttempts_clone(this.ptr);
		const ret_hu_conv: RetryAttempts = new RetryAttempts(null, ret);
	 ...
	 */
	public eq(b: RetryAttempts): boolean {
		const ret: boolean = bindings.RetryAttempts_eq(this.ptr, b == null ? 0 : CommonBase.get_ptr_of(b) & ~1);
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.RetryAttempts_hash(this.ptr);
		return ret;
	}
